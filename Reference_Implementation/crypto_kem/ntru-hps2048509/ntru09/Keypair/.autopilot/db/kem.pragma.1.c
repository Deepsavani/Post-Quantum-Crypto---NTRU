...
{_ssdm_SpecArrayDimSize(pk, 699);_ssdm_SpecArrayDimSize(sk, 935);
...
{_ssdm_SpecArrayDimSize(c, 699);_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(pk, 699);
...
{_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(c, 699);_ssdm_SpecArrayDimSize(sk, 935);
  int i, fail;
  unsigned char rm[(2*(((509 -1)+4)/5))];
