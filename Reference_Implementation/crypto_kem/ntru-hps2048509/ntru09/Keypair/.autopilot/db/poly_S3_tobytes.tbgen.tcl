...
set C_modelArgList {
	{ msg int 8 regular {array 935 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ msg_address0 sc_out sc_lv 10 signal 0 } 
...
set Spec2ImplPortList { 
	msg { ap_memory {  { msg_address0 mem_address 1 10 }  { msg_ce0 mem_ce 1 1 }  { msg_we0 mem_we 1 1 }  { msg_d0 mem_din 1 8 } } }
