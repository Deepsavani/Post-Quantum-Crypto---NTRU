// ==============================================================
// File generated on Mon Aug 24 20:18:06 EDT 2020
...
char sk[935])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *pk_pc_buffer = new sc_bv<8>[699];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: pk
				{
					...
					// {
						// celement: pk(7, 0)
						// {
							sc_lv<8>* pk_lv0_0_698_1 = new sc_lv<8>[699];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: pk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 698; i_0 += 1)
							{
								...
								{
									pk_lv0_0_698_1[hls_map_index].range(7, 0) = sc_bv<8>(pk_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: pk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 698; i_0 += 1)
							{
								...
								// output_type_conversion : (pk_lv0_0_698_1[hls_map_index]).to_uint64()
								if (&(pk[0]) != NULL) // check the null address if the c port is array or others
								{
									pk[i_0] = (pk_lv0_0_698_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *sk_pc_buffer = new sc_bv<8>[935];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: sk
				{
					...
					// {
						// celement: sk(7, 0)
						// {
							sc_lv<8>* sk_lv0_0_934_1 = new sc_lv<8>[935];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: sk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 934; i_0 += 1)
							{
								...
								{
									sk_lv0_0_934_1[hls_map_index].range(7, 0) = sc_bv<8>(sk_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: sk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 934; i_0 += 1)
							{
								...
								// output_type_conversion : (sk_lv0_0_934_1[hls_map_index]).to_uint64()
								if (&(sk[0]) != NULL) // check the null address if the c port is array or others
								{
									sk[i_0] = (sk_lv0_0_934_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
...
// [call_c_dut] ---------->
		...
		sc_bv<8>* pk_tvout_wrapc_buffer = new sc_bv<8>[699];
		...
		sc_bv<8>* sk_tvout_wrapc_buffer = new sc_bv<8>[935];
