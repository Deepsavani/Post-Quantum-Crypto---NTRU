...
wire   [2:0] j_10_fu_91_p2;
reg   [2:0] j_10_reg_140;
...
wire   [63:0] tmp_100_cast_fu_114_p1;
wire   [63:0] tmp_239_fu_119_p1;
wire   [4:0] tmp_98_fu_97_p3;
wire   [5:0] tmp_99_cast_fu_105_p1;
wire   [5:0] tmp_100_fu_109_p2;
reg   [4:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_s_fu_85_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        state_addr_reg_145 <= tmp_100_cast_fu_114_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        state_address0 = tmp_100_cast_fu_114_p1;
    end else begin
        state_address0 = 'bx;
    end
end
...
assign j_10_fu_91_p2 = (j_reg_58 + 3'd1);

assign sbox_address0 = tmp_239_fu_119_p1;

assign state_d0 = sbox_q0;

assign tmp_100_cast_fu_114_p1 = tmp_100_fu_109_p2;

assign tmp_100_fu_109_p2 = (tmp_cast_reg_132 + tmp_99_cast_fu_105_p1);

assign tmp_239_fu_119_p1 = state_q0;

assign tmp_98_fu_97_p3 = {{j_reg_58}, {2'd0}};

assign tmp_99_cast_fu_105_p1 = tmp_98_fu_97_p3;
