...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.crypto_kem_keypair.autotvin_pk.dat"
         "c.crypto_kem_keypair.autotvin_sk.dat"
         "c.crypto_kem_keypair.autotvin_DRBG_ctx_V.dat"
         "c.crypto_kem_keypair.autotvin_DRBG_ctx_Key.dat"
         "c.crypto_kem_keypair.autotvin_DRBG_ctx_reseed_counter.dat"
         "c.crypto_kem_keypair.autotvout_pk.dat"
         "c.crypto_kem_keypair.autotvout_sk.dat"
         "c.crypto_kem_keypair.autotvout_DRBG_ctx_V.dat"
         "c.crypto_kem_keypair.autotvout_DRBG_ctx_Key.dat"
         "c.crypto_kem_keypair.autotvout_DRBG_ctx_reseed_counter.dat"
         "c.crypto_kem_keypair.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.crypto_kem_keypair.autotvout_pk.dat"
         "rtl.crypto_kem_keypair.autotvout_sk.dat"
         "rtl.crypto_kem_keypair.autotvout_DRBG_ctx_V.dat"
         "rtl.crypto_kem_keypair.autotvout_DRBG_ctx_Key.dat"
         "rtl.crypto_kem_keypair.autotvout_DRBG_ctx_reseed_counter.dat"
         "rtl.crypto_kem_keypair.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
