...
reg   [15:0] reg_137;
wire   [9:0] k_cast2_fu_141_p1;
reg   [9:0] k_cast2_reg_268;
wire    ap_CS_fsm_state2;
wire   [8:0] k_5_fu_151_p2;
reg   [8:0] k_5_reg_277;
reg   [8:0] r_coeffs_addr_reg_282;
wire   [0:0] exitcond1_fu_145_p2;
wire   [8:0] tmp_s_fu_162_p2;
reg   [8:0] tmp_s_reg_287;
wire    ap_CS_fsm_state3;
wire   [0:0] tmp_183_fu_172_p2;
wire   [8:0] i_23_fu_198_p2;
reg   [8:0] i_23_reg_305;
wire   [8:0] i_24_fu_214_p2;
reg   [8:0] i_24_reg_313;
wire    ap_CS_fsm_state6;
wire   [0:0] exitcond_fu_208_p2;
wire   [8:0] indvars_iv_next_fu_235_p2;
reg   [8:0] indvars_iv_next_reg_328;
reg   [8:0] indvars_iv_reg_84;
...
wire   [63:0] tmp_185_fu_182_p1;
wire   [63:0] tmp_187_fu_193_p1;
wire  signed [63:0] tmp_191_fu_225_p1;
wire   [63:0] tmp_192_fu_230_p1;
wire  signed [15:0] grp_fu_250_p3;
wire  signed [15:0] grp_fu_259_p3;
wire   [15:0] tmp_299_cast_fu_245_p1;
wire   [9:0] i_cast_fu_168_p1;
wire   [9:0] tmp_184_fu_177_p2;
wire   [8:0] tmp_186_fu_187_p2;
wire   [9:0] i_1_cast_fu_204_p1;
wire   [9:0] tmp_190_fu_220_p2;
wire   [10:0] tmp_254_fu_241_p1;
reg   [8:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_183_fu_172_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_118 <= 9'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_183_fu_172_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        k_cast2_reg_268[8 : 0] <= k_cast2_fu_141_p1[8 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        a_coeffs_address0 = tmp_191_fu_225_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        a_coeffs_address0 = tmp_185_fu_182_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        b_coeffs_address0 = tmp_192_fu_230_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        b_coeffs_address0 = tmp_187_fu_193_p1;
    end else begin
...
assign exitcond1_fu_145_p2 = ((indvars_iv_reg_84 == 9'd510) ? 1'b1 : 1'b0);

assign exitcond_fu_208_p2 = ((i_1_reg_118 == indvars_iv_reg_84) ? 1'b1 : 1'b0);

assign i_1_cast_fu_204_p1 = i_1_reg_118;

assign i_23_fu_198_p2 = (i_reg_107 + 9'd1);

assign i_24_fu_214_p2 = (i_1_reg_118 + 9'd1);

assign i_cast_fu_168_p1 = i_reg_107;

assign indvars_iv_next_fu_235_p2 = (9'd1 + indvars_iv_reg_84);

assign k_5_fu_151_p2 = (k_reg_96 + 9'd1);

assign k_cast2_fu_141_p1 = k_reg_96;

assign tmp_183_fu_172_p2 = ((i_reg_107 < tmp_s_reg_287) ? 1'b1 : 1'b0);

assign tmp_184_fu_177_p2 = (k_cast2_reg_268 + i_cast_fu_168_p1);

assign tmp_185_fu_182_p1 = tmp_184_fu_177_p2;

assign tmp_186_fu_187_p2 = ($signed(9'd509) - $signed(i_reg_107));

assign tmp_187_fu_193_p1 = tmp_186_fu_187_p2;

assign tmp_190_fu_220_p2 = (k_cast2_reg_268 - i_1_cast_fu_204_p1);

assign tmp_191_fu_225_p1 = $signed(tmp_190_fu_220_p2);

assign tmp_192_fu_230_p1 = i_1_reg_118;

assign tmp_254_fu_241_p1 = r_coeffs_q0[10:0];

assign tmp_299_cast_fu_245_p1 = tmp_254_fu_241_p1;

assign tmp_fu_157_p1 = k_reg_96;

assign tmp_s_fu_162_p2 = ($signed(9'd509) - $signed(k_reg_96));

always @ (posedge ap_clk) begin
    k_cast2_reg_268[9] <= 1'b0;
end
