// ==============================================================
// File generated on Mon Aug 24 20:17:53 EDT 2020
// Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
// SW Build 2405991 on Thu Dec  6 23:36:41 MST 2018
// IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
// Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
// ==============================================================
#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.c"
#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.c" 1
#1 "<built-in>" 1
#1 "<built-in>" 3
#149 "<built-in>" 3
#1 "<command line>" 1
#1 "<built-in>" 2
#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.c" 2
...
#5 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.h" 2
...
#2 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.c" 2
#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/sample.h" 1
...
#5 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/sample.h" 2

#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/poly.h" 1
...
#5 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/poly.h" 2
...
#7 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/sample.h" 2

void sample_fg(poly *f, poly *g, const unsigned char uniformbytes[((509 -1)+((30*(509 -1)+7)/8))]);
void sample_rm(poly *r, poly *m, const unsigned char uniformbytes[((509 -1)+((30*(509 -1)+7)/8))]);

void sample_iid(poly *r, const unsigned char uniformbytes[(509 -1)]);


void sample_fixed_type(poly *r, const unsigned char uniformbytes[((30*(509 -1)+7)/8)]);
#3 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.c" 2
...
void owcpa_samplemsg(unsigned char msg[(2*(((509 -1)+4)/5))],
                     const unsigned char seed[((509 -1)+((30*(509 -1)+7)/8))])
{
  poly r, m;
  ...
  poly_S3_tobytes(msg+(((509 -1)+4)/5), &m);
}
                   ...
                   const unsigned char seed[((509 -1)+((30*(509 -1)+7)/8))])
{
  ...
  poly_S3_tobytes(sk+(((509 -1)+4)/5), invf_mod3);


  poly_Z3_to_Zq(f);
  poly_Z3_to_Zq(g);
#88 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.c"
  for(i=0; i<509; i++)
    G->coeffs[i] = ((3 * g->coeffs[i]) & ((1 << 11)-1));
  ...
  poly_Sq_tobytes(sk+2*(((509 -1)+4)/5), invh);
               ...
               const unsigned char *pk)
{
  ...
  poly_S3_frombytes(m, rm+(((509 -1)+4)/5));
  poly_lift(liftm, m);
  for(i=0; i<509; i++)
    ct->coeffs[i] = ((ct->coeffs[i] + liftm->coeffs[i]) & ((1 << 11)-1));
              ...
              const unsigned char *secretkey)
{
  ...
  poly_S3_frombytes(finv3, secretkey+(((509 -1)+4)/5));
  poly_S3_mul(m, mf, finv3);
  poly_S3_tobytes(rm+(((509 -1)+4)/5), m);
  ...
  poly_lift(liftm, m);
  for(i=0; i<509; i++)
    b->coeffs[i] = ((c->coeffs[i] - liftm->coeffs[i]) & ((1 << 11)-1));


  poly_Sq_frombytes(invh, secretkey+2*(((509 -1)+4)/5));
  poly_Sq_mul(r, b, invh);
#184 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/owcpa.c"
