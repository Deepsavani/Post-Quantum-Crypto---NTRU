// ==============================================================
// File generated on Mon Aug 24 20:17:57 EDT 2020
// Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
// SW Build 2405991 on Thu Dec  6 23:36:41 MST 2018
// IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
// Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
// ==============================================================
#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/packq.c"
#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/packq.c" 1
#1 "<built-in>" 1
#1 "<built-in>" 3
#149 "<built-in>" 3
#1 "<command line>" 1
#1 "<built-in>" 2
#1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/packq.c" 2
...
#2 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048509/packq.c" 2
...
void poly_Sq_tobytes(unsigned char *r, const poly *a)
{
  ...
  for(j=0;j<(509 -1)-8*i;j++)
    t[j] = a->coeffs[8*i+j];
  for(; j<8; j++)
    t[j] = 0;

  switch((509 -1) - 8*((509 -1)/8))
  {
    case 6:
    r[11*i+ 8] = (t[5] >> 9) | ((t[6] & 0x3f) << 2);
    r[11*i+ 7] = (t[5] >> 1) & 0xff;
...
void poly_Rq_sum_zero_frombytes(poly *r, const unsigned char *a)
{
  ...
  for(i=0;i<(509 -1);i++)
  {
    r->coeffs[509 -1] += r->coeffs[i];
  }
  r->coeffs[509 -1] = ((-(r->coeffs[509 -1])) & ((1 << 11)-1));
}
