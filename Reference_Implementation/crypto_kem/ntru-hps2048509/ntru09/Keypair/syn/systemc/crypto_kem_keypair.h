...
struct crypto_kem_keypair : public sc_module {
    ...
    sc_signal< sc_lv<10> > grp_owcpa_keypair_fu_34_pk_address0;
    ...
    sc_signal< sc_lv<10> > grp_owcpa_keypair_fu_34_pk_address1;
    ...
    sc_signal< sc_lv<10> > grp_owcpa_keypair_fu_34_sk_address0;
    ...
    sc_signal< sc_lv<10> > grp_owcpa_keypair_fu_34_sk_address1;
    ...
    sc_signal< sc_lv<32> > grp_randombytes_fu_43_DRBG_ctx_reseed_counter_o;
    sc_signal< sc_logic > grp_randombytes_fu_43_DRBG_ctx_reseed_counter_o_ap_vld;
    ...
    sc_signal< sc_lv<10> > grp_randombytes_1_fu_59_x_address0;
    ...
    sc_signal< sc_lv<32> > grp_randombytes_1_fu_59_DRBG_ctx_reseed_counter_o;
    sc_signal< sc_logic > grp_randombytes_1_fu_59_DRBG_ctx_reseed_counter_o_ap_vld;
