...
poly_Rq_mul::poly_Rq_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_185_fu_182_p1 );
    sensitive << ( tmp_191_fu_225_p1 );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( tmp_187_fu_193_p1 );
    sensitive << ( tmp_192_fu_230_p1 );
    ...
    sensitive << ( tmp_299_cast_fu_245_p1 );
    ...
    SC_METHOD(thread_tmp_183_fu_172_p2);
    sensitive << ( tmp_s_reg_287 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( i_reg_107 );

    SC_METHOD(thread_tmp_184_fu_177_p2);
    sensitive << ( k_cast2_reg_268 );
    sensitive << ( i_cast_fu_168_p1 );

    SC_METHOD(thread_tmp_185_fu_182_p1);
    sensitive << ( tmp_184_fu_177_p2 );

    SC_METHOD(thread_tmp_186_fu_187_p2);
    sensitive << ( i_reg_107 );

    SC_METHOD(thread_tmp_187_fu_193_p1);
    sensitive << ( tmp_186_fu_187_p2 );

    SC_METHOD(thread_tmp_190_fu_220_p2);
    sensitive << ( k_cast2_reg_268 );
    sensitive << ( i_1_cast_fu_204_p1 );

    SC_METHOD(thread_tmp_191_fu_225_p1);
    sensitive << ( tmp_190_fu_220_p2 );

    SC_METHOD(thread_tmp_192_fu_230_p1);
    sensitive << ( i_1_reg_118 );

    SC_METHOD(thread_tmp_254_fu_241_p1);
    sensitive << ( r_coeffs_q0 );

    SC_METHOD(thread_tmp_299_cast_fu_245_p1);
    sensitive << ( tmp_254_fu_241_p1 );
    ...
    sc_trace(mVcdFile, tmp_183_fu_172_p2, "tmp_183_fu_172_p2");
    ...
    sc_trace(mVcdFile, tmp_185_fu_182_p1, "tmp_185_fu_182_p1");
    sc_trace(mVcdFile, tmp_187_fu_193_p1, "tmp_187_fu_193_p1");
    sc_trace(mVcdFile, tmp_191_fu_225_p1, "tmp_191_fu_225_p1");
    sc_trace(mVcdFile, tmp_192_fu_230_p1, "tmp_192_fu_230_p1");
    sc_trace(mVcdFile, grp_fu_250_p3, "grp_fu_250_p3");
    sc_trace(mVcdFile, grp_fu_259_p3, "grp_fu_259_p3");
    sc_trace(mVcdFile, tmp_299_cast_fu_245_p1, "tmp_299_cast_fu_245_p1");
    sc_trace(mVcdFile, i_cast_fu_168_p1, "i_cast_fu_168_p1");
    sc_trace(mVcdFile, tmp_184_fu_177_p2, "tmp_184_fu_177_p2");
    sc_trace(mVcdFile, tmp_186_fu_187_p2, "tmp_186_fu_187_p2");
    sc_trace(mVcdFile, i_1_cast_fu_204_p1, "i_1_cast_fu_204_p1");
    sc_trace(mVcdFile, tmp_190_fu_220_p2, "tmp_190_fu_220_p2");
    sc_trace(mVcdFile, tmp_254_fu_241_p1, "tmp_254_fu_241_p1");
...
void poly_Rq_mul::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_183_fu_172_p2.read()))) {
        i_1_reg_118 = ap_const_lv9_0;
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        ...
        i_reg_107 = ap_const_lv9_1;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        indvars_iv_reg_84 = ap_const_lv9_1;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        indvars_iv_reg_84 = indvars_iv_next_reg_328.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        k_reg_96 = ap_const_lv9_0;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        k_reg_96 = k_5_reg_277.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_183_fu_172_p2.read(), ap_const_lv1_1))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond1_fu_145_p2.read(), ap_const_lv1_0))) {
        r_coeffs_addr_reg_282 =  (sc_lv<9>) (tmp_fu_157_p1.read());
...
void poly_Rq_mul::thread_a_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        a_coeffs_address0 =  (sc_lv<9>) (tmp_191_fu_225_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        a_coeffs_address0 =  (sc_lv<9>) (tmp_185_fu_182_p1.read());
    } else {
...
void poly_Rq_mul::thread_b_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        b_coeffs_address0 =  (sc_lv<9>) (tmp_192_fu_230_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        b_coeffs_address0 =  (sc_lv<9>) (tmp_187_fu_193_p1.read());
    } else {
...
void poly_Rq_mul::thread_exitcond1_fu_145_p2() {
    exitcond1_fu_145_p2 = (!indvars_iv_reg_84.read().is_01() || !ap_const_lv9_1FE.is_01())? sc_lv<1>(): sc_lv<1>(indvars_iv_reg_84.read() == ap_const_lv9_1FE);
}
...
void poly_Rq_mul::thread_i_1_cast_fu_204_p1() {
    i_1_cast_fu_204_p1 = esl_zext<10,9>(i_1_reg_118.read());
}

void poly_Rq_mul::thread_i_23_fu_198_p2() {
    i_23_fu_198_p2 = (!i_reg_107.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_reg_107.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void poly_Rq_mul::thread_i_24_fu_214_p2() {
    i_24_fu_214_p2 = (!i_1_reg_118.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_1_reg_118.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void poly_Rq_mul::thread_i_cast_fu_168_p1() {
    i_cast_fu_168_p1 = esl_zext<10,9>(i_reg_107.read());
}

void poly_Rq_mul::thread_indvars_iv_next_fu_235_p2() {
    indvars_iv_next_fu_235_p2 = (!ap_const_lv9_1.is_01() || !indvars_iv_reg_84.read().is_01())? sc_lv<9>(): (sc_biguint<9>(ap_const_lv9_1) + sc_biguint<9>(indvars_iv_reg_84.read()));
}

void poly_Rq_mul::thread_k_5_fu_151_p2() {
    k_5_fu_151_p2 = (!k_reg_96.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(k_reg_96.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void poly_Rq_mul::thread_k_cast2_fu_141_p1() {
    k_cast2_fu_141_p1 = esl_zext<10,9>(k_reg_96.read());
}
...
void poly_Rq_mul::thread_r_coeffs_address0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) || 
        ...
        r_coeffs_address0 =  (sc_lv<9>) (tmp_fu_157_p1.read());
    } else {
...
void poly_Rq_mul::thread_r_coeffs_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        r_coeffs_d0 = tmp_299_cast_fu_245_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
...
void poly_Rq_mul::thread_tmp_183_fu_172_p2() {
    tmp_183_fu_172_p2 = (!i_reg_107.read().is_01() || !tmp_s_reg_287.read().is_01())? sc_lv<1>(): (sc_biguint<9>(i_reg_107.read()) < sc_biguint<9>(tmp_s_reg_287.read()));
}

void poly_Rq_mul::thread_tmp_184_fu_177_p2() {
    tmp_184_fu_177_p2 = (!k_cast2_reg_268.read().is_01() || !i_cast_fu_168_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(k_cast2_reg_268.read()) + sc_biguint<10>(i_cast_fu_168_p1.read()));
}

void poly_Rq_mul::thread_tmp_185_fu_182_p1() {
    tmp_185_fu_182_p1 = esl_zext<64,10>(tmp_184_fu_177_p2.read());
}

void poly_Rq_mul::thread_tmp_186_fu_187_p2() {
    tmp_186_fu_187_p2 = (!ap_const_lv9_1FD.is_01() || !i_reg_107.read().is_01())? sc_lv<9>(): (sc_bigint<9>(ap_const_lv9_1FD) - sc_biguint<9>(i_reg_107.read()));
}

void poly_Rq_mul::thread_tmp_187_fu_193_p1() {
    tmp_187_fu_193_p1 = esl_zext<64,9>(tmp_186_fu_187_p2.read());
}

void poly_Rq_mul::thread_tmp_190_fu_220_p2() {
    tmp_190_fu_220_p2 = (!k_cast2_reg_268.read().is_01() || !i_1_cast_fu_204_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(k_cast2_reg_268.read()) - sc_biguint<10>(i_1_cast_fu_204_p1.read()));
}

void poly_Rq_mul::thread_tmp_191_fu_225_p1() {
    tmp_191_fu_225_p1 = esl_sext<64,10>(tmp_190_fu_220_p2.read());
}

void poly_Rq_mul::thread_tmp_192_fu_230_p1() {
    tmp_192_fu_230_p1 = esl_zext<64,9>(i_1_reg_118.read());
}

void poly_Rq_mul::thread_tmp_254_fu_241_p1() {
    tmp_254_fu_241_p1 = r_coeffs_q0.read().range(11-1, 0);
}

void poly_Rq_mul::thread_tmp_299_cast_fu_245_p1() {
    tmp_299_cast_fu_245_p1 = esl_zext<16,11>(tmp_254_fu_241_p1.read());
}

void poly_Rq_mul::thread_tmp_fu_157_p1() {
    tmp_fu_157_p1 = esl_zext<64,9>(k_reg_96.read());
}

void poly_Rq_mul::thread_tmp_s_fu_162_p2() {
    tmp_s_fu_162_p2 = (!ap_const_lv9_1FD.is_01() || !k_reg_96.read().is_01())? sc_lv<9>(): (sc_bigint<9>(ap_const_lv9_1FD) - sc_biguint<9>(k_reg_96.read()));
}
...
void poly_Rq_mul::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_183_fu_172_p2.read()))) {
