...
architecture behav of poly_Rq_mul is 
    ...
    signal k_cast2_fu_141_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal k_cast2_reg_268 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal k_5_fu_151_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal k_5_reg_277 : STD_LOGIC_VECTOR (8 downto 0);
    signal r_coeffs_addr_reg_282 : STD_LOGIC_VECTOR (8 downto 0);
    signal exitcond1_fu_145_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_s_fu_162_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_s_reg_287 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_183_fu_172_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_23_fu_198_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_23_reg_305 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_24_fu_214_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_24_reg_313 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal exitcond_fu_208_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal indvars_iv_next_fu_235_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvars_iv_next_reg_328 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvars_iv_reg_84 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal k_reg_96 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_reg_107 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_185_fu_182_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_187_fu_193_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_191_fu_225_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_192_fu_230_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_250_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_259_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_299_cast_fu_245_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal i_cast_fu_168_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_184_fu_177_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_186_fu_187_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_1_cast_fu_204_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_190_fu_220_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_254_fu_241_p1 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_183_fu_172_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_183_fu_172_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                k_5_reg_277 <= k_5_fu_151_p2;
                    k_cast2_reg_268(8 downto 0) <= k_cast2_fu_141_p1(8 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_fu_145_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                r_coeffs_addr_reg_282 <= tmp_fu_157_p1(9 - 1 downto 0);
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, exitcond1_fu_145_p2, ap_CS_fsm_state3, tmp_183_fu_172_p2, ap_CS_fsm_state6, exitcond_fu_208_p2)
    begin
        case ap_CS_fsm is
    ...
    a_coeffs_address0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state6, tmp_185_fu_182_p1, tmp_191_fu_225_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            a_coeffs_address0 <= tmp_191_fu_225_p1(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            a_coeffs_address0 <= tmp_185_fu_182_p1(9 - 1 downto 0);
        else 
    ...
    b_coeffs_address0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state6, tmp_187_fu_193_p1, tmp_192_fu_230_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            b_coeffs_address0 <= tmp_192_fu_230_p1(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            b_coeffs_address0 <= tmp_187_fu_193_p1(9 - 1 downto 0);
        else 
    ...
    exitcond1_fu_145_p2 <= "1" when (indvars_iv_reg_84 = ap_const_lv9_1FE) else "0";
    exitcond_fu_208_p2 <= "1" when (i_1_reg_118 = indvars_iv_reg_84) else "0";
    i_1_cast_fu_204_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_118),10));
    i_23_fu_198_p2 <= std_logic_vector(unsigned(i_reg_107) + unsigned(ap_const_lv9_1));
    i_24_fu_214_p2 <= std_logic_vector(unsigned(i_1_reg_118) + unsigned(ap_const_lv9_1));
    i_cast_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_107),10));
    indvars_iv_next_fu_235_p2 <= std_logic_vector(unsigned(ap_const_lv9_1) + unsigned(indvars_iv_reg_84));
    k_5_fu_151_p2 <= std_logic_vector(unsigned(k_reg_96) + unsigned(ap_const_lv9_1));
    k_cast2_fu_141_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_reg_96),10));
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state8) or (ap_const_logic_1 = ap_CS_fsm_state5) or (ap_const_logic_1 = ap_CS_fsm_state9) or ((exitcond_fu_208_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6)) or ((exitcond_fu_208_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6)))) then 
            ...
            r_coeffs_address0 <= tmp_fu_157_p1(9 - 1 downto 0);
        else 
    ...
    r_coeffs_d0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state9, ap_CS_fsm_state5, ap_CS_fsm_state8, grp_fu_250_p3, grp_fu_259_p3, tmp_299_cast_fu_245_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            r_coeffs_d0 <= tmp_299_cast_fu_245_p1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
    ...
    tmp_183_fu_172_p2 <= "1" when (unsigned(i_reg_107) < unsigned(tmp_s_reg_287)) else "0";
    tmp_184_fu_177_p2 <= std_logic_vector(unsigned(k_cast2_reg_268) + unsigned(i_cast_fu_168_p1));
    tmp_185_fu_182_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_184_fu_177_p2),64));
    tmp_186_fu_187_p2 <= std_logic_vector(signed(ap_const_lv9_1FD) - signed(i_reg_107));
    tmp_187_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_186_fu_187_p2),64));
    tmp_190_fu_220_p2 <= std_logic_vector(unsigned(k_cast2_reg_268) - unsigned(i_1_cast_fu_204_p1));
        tmp_191_fu_225_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_190_fu_220_p2),64));

    tmp_192_fu_230_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_118),64));
    tmp_254_fu_241_p1 <= r_coeffs_q0(11 - 1 downto 0);
    tmp_299_cast_fu_245_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_254_fu_241_p1),16));
    tmp_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_reg_96),64));
    tmp_s_fu_162_p2 <= std_logic_vector(signed(ap_const_lv9_1FD) - signed(k_reg_96));
end behav;
