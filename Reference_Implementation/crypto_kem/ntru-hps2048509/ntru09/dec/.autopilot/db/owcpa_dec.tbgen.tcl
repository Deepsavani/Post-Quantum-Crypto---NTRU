...
set C_modelArgList {
	{ rm int 8 regular {array 204 { 0 3 } 0 1 }  }
	{ ciphertext int 8 regular {array 699 { 1 1 } 1 1 }  }
	{ secretkey int 8 regular {array 935 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ rm_address0 sc_out sc_lv 8 signal 0 } 
	...
	{ secretkey_address0 sc_out sc_lv 10 signal 2 } 
	{ secretkey_ce0 sc_out sc_logic 1 signal 2 } 
	{ secretkey_q0 sc_in sc_lv 8 signal 2 } 
	{ secretkey_address1 sc_out sc_lv 10 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rm_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rm", "role": "address0" }} , 
 	...
 	{ "name": "secretkey_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "secretkey", "role": "address0" }} , 
 	...
 	{ "name": "secretkey_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "secretkey", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "10", "13", "14", "15"],
		"CDFG" : "owcpa_dec",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			{"Name" : "rm", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_poly_S3_tobytes_fu_433", "Port" : "msg"}]},
			{"Name" : "ciphertext", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_poly_Sq_frombytes_fu_402", "Port" : "a"}]},
			{"Name" : "secretkey", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "grp_poly_S3_frombytes_fu_410", "Port" : "msg"},
					{"ID" : "5", "SubInstance" : "grp_poly_Sq_frombytes_1_fu_395", "Port" : "a"}]}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_Sq_frombytes_1_fu_395", "Parent" : "0",
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_Sq_frombytes_fu_402", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "r_coeffs", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "a", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_410", "Parent" : "0", "Child" : ["8", "9"],
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_410.grp_mod3_fu_199", "Parent" : "7",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_410.grp_mod3_fu_204", "Parent" : "7",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_mul_fu_420", "Parent" : "0", "Child" : ["11", "12"],
		"CDFG" : "poly_S3_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_mul_fu_420.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U15", "Parent" : "10"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_mul_fu_420.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U16", "Parent" : "10"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_to_S3_fu_427", "Parent" : "0",
		"CDFG" : "poly_Rq_to_S3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "r_coeffs", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "a_coeffs", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_tobytes_fu_433", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "msg_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "a_coeffs", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_mul_fu_443", "Parent" : "0", "Child" : ["16", "17"],
		"CDFG" : "poly_Rq_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "a_coeffs", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "b_coeffs", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_mul_fu_443.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U7", "Parent" : "15"},
	{"ID" : "17", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_mul_fu_443.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U8", "Parent" : "15"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "26592", "Max" : "4680888"}
	, {"Name" : "Interval", "Min" : "26592", "Max" : "4680888"}
]}
...
set Spec2ImplPortList { 
	rm { ap_memory {  { rm_address0 mem_address 1 8 }  { rm_ce0 mem_ce 1 1 }  { rm_we0 mem_we 1 1 }  { rm_d0 mem_din 1 8 } } }
	...
	secretkey { ap_memory {  { secretkey_address0 mem_address 1 10 }  { secretkey_ce0 mem_ce 1 1 }  { secretkey_q0 mem_dout 0 8 }  { secretkey_address1 MemPortADDR2 1 10 }  { secretkey_ce1 MemPortCE2 1 1 }  { secretkey_q1 MemPortDOUT2 0 8 } } }
}
