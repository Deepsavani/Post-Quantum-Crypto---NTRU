...
set C_modelArgList {
	{ r_coeffs int 16 regular {array 509 { 0 0 } 0 1 }  }
	{ msg int 8 regular {array 935 { 1 3 } 1 1 }  }
	{ msg_offset int 9 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "r_coeffs", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "msg_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ msg_address0 sc_out sc_lv 10 signal 1 } 
	{ msg_ce0 sc_out sc_logic 1 signal 1 } 
	{ msg_q0 sc_in sc_lv 8 signal 1 } 
	{ msg_offset sc_in sc_lv 9 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "msg_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "msg", "role": "address0" }} , 
 	...
 	{ "name": "msg_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "msg_offset", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mod3_fu_199", "Parent" : "0",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mod3_fu_204", "Parent" : "0",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "615", "Max" : "615"}
	, {"Name" : "Interval", "Min" : "615", "Max" : "615"}
]}
...
set Spec2ImplPortList { 
	r_coeffs { ap_memory {  { r_coeffs_address0 mem_address 1 9 }  { r_coeffs_ce0 mem_ce 1 1 }  { r_coeffs_we0 mem_we 1 1 }  { r_coeffs_d0 mem_din 1 16 }  { r_coeffs_address1 MemPortADDR2 1 9 }  { r_coeffs_ce1 MemPortCE2 1 1 }  { r_coeffs_we1 MemPortWE2 1 1 }  { r_coeffs_d1 MemPortDIN2 1 16 } } }
	msg { ap_memory {  { msg_address0 mem_address 1 10 }  { msg_ce0 mem_ce 1 1 }  { msg_q0 mem_dout 0 8 } } }
	msg_offset { ap_none {  { msg_offset in_data 0 9 } } }
}
