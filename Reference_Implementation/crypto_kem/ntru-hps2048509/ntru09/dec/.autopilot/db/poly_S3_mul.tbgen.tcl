...
set C_modelName {poly_S3_mul}
set C_modelType { void 0 }
set C_modelArgList {
	{ r_coeffs int 16 regular {array 509 { 2 2 } 1 1 }  }
	{ a_coeffs int 16 regular {array 509 { 1 3 } 1 1 }  }
	{ b_coeffs int 16 regular {array 509 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ r_coeffs_address1 sc_out sc_lv 9 signal 0 } 
	...
	{ a_coeffs_address0 sc_out sc_lv 9 signal 1 } 
	{ a_coeffs_ce0 sc_out sc_logic 1 signal 1 } 
	{ a_coeffs_q0 sc_in sc_lv 16 signal 1 } 
	{ b_coeffs_address0 sc_out sc_lv 9 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r_coeffs_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "r_coeffs", "role": "address1" }} , 
 	...
 	{ "name": "b_coeffs_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "b_coeffs", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U15", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U16", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4583", "Max" : "1556015"}
	, {"Name" : "Interval", "Min" : "4583", "Max" : "1556015"}
]}
...
set Spec2ImplPortList { 
	r_coeffs { ap_memory {  { r_coeffs_address0 mem_address 1 9 }  { r_coeffs_ce0 mem_ce 1 1 }  { r_coeffs_we0 mem_we 1 1 }  { r_coeffs_d0 mem_din 1 16 }  { r_coeffs_q0 mem_dout 0 16 }  { r_coeffs_address1 MemPortADDR2 1 9 }  { r_coeffs_ce1 MemPortCE2 1 1 }  { r_coeffs_we1 MemPortWE2 1 1 }  { r_coeffs_d1 MemPortDIN2 1 16 }  { r_coeffs_q1 MemPortDOUT2 0 16 } } }
	a_coeffs { ap_memory {  { a_coeffs_address0 mem_address 1 9 }  { a_coeffs_ce0 mem_ce 1 1 }  { a_coeffs_q0 mem_dout 0 16 } } }
	b_coeffs { ap_memory {  { b_coeffs_address0 mem_address 1 9 }  { b_coeffs_ce0 mem_ce 1 1 }  { b_coeffs_q0 mem_dout 0 16 } } }
}
