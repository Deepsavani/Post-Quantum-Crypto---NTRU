...
poly_Rq_mul::poly_Rq_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_187_fu_180_p1 );
    sensitive << ( tmp_193_fu_223_p1 );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( tmp_189_fu_191_p1 );
    sensitive << ( tmp_194_fu_228_p1 );
    ...
    sensitive << ( tmp_200_cast_fu_243_p1 );
    ...
    SC_METHOD(thread_tmp_185_fu_170_p2);
    sensitive << ( tmp_s_reg_285 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_186_fu_175_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_cast_fu_166_p1 );

    SC_METHOD(thread_tmp_187_fu_180_p1);
    sensitive << ( tmp_186_fu_175_p2 );

    SC_METHOD(thread_tmp_188_fu_185_p2);
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_189_fu_191_p1);
    sensitive << ( tmp_188_fu_185_p2 );

    SC_METHOD(thread_tmp_192_fu_218_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_1_cast_fu_202_p1 );

    SC_METHOD(thread_tmp_193_fu_223_p1);
    sensitive << ( tmp_192_fu_218_p2 );

    SC_METHOD(thread_tmp_194_fu_228_p1);
    sensitive << ( i_1_reg_116 );

    SC_METHOD(thread_tmp_198_fu_239_p1);
    sensitive << ( r_coeffs_q0 );

    SC_METHOD(thread_tmp_200_cast_fu_243_p1);
    ...
    sc_trace(mVcdFile, tmp_185_fu_170_p2, "tmp_185_fu_170_p2");
    ...
    sc_trace(mVcdFile, tmp_187_fu_180_p1, "tmp_187_fu_180_p1");
    sc_trace(mVcdFile, tmp_189_fu_191_p1, "tmp_189_fu_191_p1");
    sc_trace(mVcdFile, tmp_193_fu_223_p1, "tmp_193_fu_223_p1");
    sc_trace(mVcdFile, tmp_194_fu_228_p1, "tmp_194_fu_228_p1");
    sc_trace(mVcdFile, grp_fu_248_p3, "grp_fu_248_p3");
    sc_trace(mVcdFile, grp_fu_257_p3, "grp_fu_257_p3");
    sc_trace(mVcdFile, tmp_200_cast_fu_243_p1, "tmp_200_cast_fu_243_p1");
    sc_trace(mVcdFile, i_cast_fu_166_p1, "i_cast_fu_166_p1");
    sc_trace(mVcdFile, tmp_186_fu_175_p2, "tmp_186_fu_175_p2");
    sc_trace(mVcdFile, tmp_188_fu_185_p2, "tmp_188_fu_185_p2");
    sc_trace(mVcdFile, i_1_cast_fu_202_p1, "i_1_cast_fu_202_p1");
    sc_trace(mVcdFile, tmp_192_fu_218_p2, "tmp_192_fu_218_p2");
...
void poly_Rq_mul::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_185_fu_170_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_185_fu_170_p2.read(), ap_const_lv1_1))) {
...
void poly_Rq_mul::thread_a_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        a_coeffs_address0 =  (sc_lv<9>) (tmp_193_fu_223_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        a_coeffs_address0 =  (sc_lv<9>) (tmp_187_fu_180_p1.read());
    } else {
...
void poly_Rq_mul::thread_b_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        b_coeffs_address0 =  (sc_lv<9>) (tmp_194_fu_228_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        b_coeffs_address0 =  (sc_lv<9>) (tmp_189_fu_191_p1.read());
    } else {
...
void poly_Rq_mul::thread_i_10_fu_196_p2() {
    i_10_fu_196_p2 = (!i_reg_105.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_reg_105.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void poly_Rq_mul::thread_i_11_fu_212_p2() {
    i_11_fu_212_p2 = (!i_1_reg_116.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_1_reg_116.read()) + sc_biguint<9>(ap_const_lv9_1));
}
...
void poly_Rq_mul::thread_k_4_fu_149_p2() {
    k_4_fu_149_p2 = (!k_reg_94.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(k_reg_94.read()) + sc_biguint<9>(ap_const_lv9_1));
}
...
void poly_Rq_mul::thread_r_coeffs_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        r_coeffs_d0 = tmp_200_cast_fu_243_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
...
void poly_Rq_mul::thread_tmp_185_fu_170_p2() {
    tmp_185_fu_170_p2 = (!i_reg_105.read().is_01() || !tmp_s_reg_285.read().is_01())? sc_lv<1>(): (sc_biguint<9>(i_reg_105.read()) < sc_biguint<9>(tmp_s_reg_285.read()));
}

void poly_Rq_mul::thread_tmp_186_fu_175_p2() {
    tmp_186_fu_175_p2 = (!k_cast2_reg_266.read().is_01() || !i_cast_fu_166_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(k_cast2_reg_266.read()) + sc_biguint<10>(i_cast_fu_166_p1.read()));
}

void poly_Rq_mul::thread_tmp_187_fu_180_p1() {
    tmp_187_fu_180_p1 = esl_zext<64,10>(tmp_186_fu_175_p2.read());
}

void poly_Rq_mul::thread_tmp_188_fu_185_p2() {
    tmp_188_fu_185_p2 = (!ap_const_lv9_1FD.is_01() || !i_reg_105.read().is_01())? sc_lv<9>(): (sc_bigint<9>(ap_const_lv9_1FD) - sc_biguint<9>(i_reg_105.read()));
}

void poly_Rq_mul::thread_tmp_189_fu_191_p1() {
    tmp_189_fu_191_p1 = esl_zext<64,9>(tmp_188_fu_185_p2.read());
}

void poly_Rq_mul::thread_tmp_192_fu_218_p2() {
    tmp_192_fu_218_p2 = (!k_cast2_reg_266.read().is_01() || !i_1_cast_fu_202_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(k_cast2_reg_266.read()) - sc_biguint<10>(i_1_cast_fu_202_p1.read()));
}

void poly_Rq_mul::thread_tmp_193_fu_223_p1() {
    tmp_193_fu_223_p1 = esl_sext<64,10>(tmp_192_fu_218_p2.read());
}

void poly_Rq_mul::thread_tmp_194_fu_228_p1() {
    tmp_194_fu_228_p1 = esl_zext<64,9>(i_1_reg_116.read());
}
...
void poly_Rq_mul::thread_tmp_200_cast_fu_243_p1() {
    tmp_200_cast_fu_243_p1 = esl_zext<16,11>(tmp_198_fu_239_p1.read());
}
...
void poly_Rq_mul::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_185_fu_170_p2.read()))) {
