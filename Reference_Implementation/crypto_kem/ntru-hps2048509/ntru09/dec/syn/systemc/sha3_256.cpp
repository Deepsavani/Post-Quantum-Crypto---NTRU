...
sha3_256::sha3_256(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_248_i_fu_175_p1);
    sensitive << ( i_i_reg_103 );
    ...
    sc_trace(mVcdFile, tmp_248_i_fu_175_p1, "tmp_248_i_fu_175_p1");
...
void sha3_256::thread_output_r_address0() {
    output_r_address0 =  (sc_lv<8>) (i_cast1_reg_286.read());
}
...
void sha3_256::thread_s_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        s_address0 =  (sc_lv<5>) (tmp_248_i_fu_175_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
...
void sha3_256::thread_tmp_248_i_fu_175_p1() {
    tmp_248_i_fu_175_p1 = esl_zext<64,5>(i_i_reg_103.read());
}
