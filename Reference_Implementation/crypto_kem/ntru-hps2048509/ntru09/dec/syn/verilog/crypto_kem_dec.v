...
(* CORE_GENERATION_INFO="crypto_kem_dec,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=26,HLS_SYN_DSP=4,HLS_SYN_FF=14425,HLS_SYN_LUT=76979,HLS_VERSION=2018_3}" *)
...
wire   [5:0] i_31_fu_204_p2;
reg   [5:0] i_31_reg_309;
wire    ap_CS_fsm_state5;
wire   [0:0] exitcond1_fu_198_p2;
wire   [9:0] i_32_fu_236_p2;
reg   [9:0] i_32_reg_322;
...
wire   [5:0] i_33_fu_277_p2;
reg   [5:0] i_33_reg_340;
...
wire   [7:0] grp_sha3_256_fu_167_output_r_address0;
...
wire   [9:0] grp_owcpa_dec_fu_184_secretkey_address0;
wire    grp_owcpa_dec_fu_184_secretkey_ce0;
wire   [9:0] grp_owcpa_dec_fu_184_secretkey_address1;
...
wire   [63:0] tmp_220_fu_225_p1;
wire   [63:0] tmp_221_fu_242_p1;
wire   [63:0] cmp_0_sum_cast_fu_253_p1;
wire   [63:0] i_i_cast1_fu_265_p1;
wire   [7:0] tmp_259_i_fu_294_p2;
wire   [7:0] i_cast4_cast_fu_194_p1;
wire   [7:0] tmp_fu_210_p2;
wire  signed [9:0] tmp_cast5_fu_216_p1;
wire   [9:0] cmp_0_sum_fu_247_p2;
wire   [7:0] tmp_i_fu_283_p2;
wire   [7:0] tmp_i_65_fu_289_p2;
reg   [10:0] ap_NS_fsm;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        buf_address0 = tmp_220_fu_225_p1;
...
assign cmp_0_sum_fu_247_p2 = (i_1_reg_144 + 10'd32);

assign exitcond1_fu_198_p2 = ((i_reg_132 == 6'd32) ? 1'b1 : 1'b0);

assign exitcond_fu_230_p2 = ((i_1_reg_144 == 10'd699) ? 1'b1 : 1'b0);
...
assign i_31_fu_204_p2 = (i_reg_132 + 6'd1);

assign i_32_fu_236_p2 = (i_1_reg_144 + 10'd1);

assign i_33_fu_277_p2 = (i_i_reg_156 + 6'd1);
...
assign tmp_220_fu_225_p1 = i_reg_132;

assign tmp_221_fu_242_p1 = i_1_reg_144;

assign tmp_259_i_fu_294_p2 = (tmp_i_65_fu_289_p2 ^ k_q0);

assign tmp_cast5_fu_216_p1 = $signed(tmp_fu_210_p2);

assign tmp_fu_210_p2 = ($signed(i_cast4_cast_fu_194_p1) + $signed(8'd135));

assign tmp_i_65_fu_289_p2 = (tmp_i_fu_283_p2 & b_assign_reg_332);
