...
entity KeccakF1600_StatePer_KeccakF_RoundConstan_rom is 
    generic(
             DWIDTH     : integer := 64; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 24
...
architecture rtl of KeccakF1600_StatePer_KeccakF_RoundConstan_rom is 
...
entity KeccakF1600_StatePer_KeccakF_RoundConstan is
    generic (
...
architecture arch of KeccakF1600_StatePer_KeccakF_RoundConstan is
    component KeccakF1600_StatePer_KeccakF_RoundConstan_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    KeccakF1600_StatePer_KeccakF_RoundConstan_rom_U :  component KeccakF1600_StatePer_KeccakF_RoundConstan_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
