...
set C_modelArgList {
	{ array_r int 32 regular {array 508 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ array_r_address1 sc_out sc_lv 9 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "array_r_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "array_r", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	array_r { ap_memory {  { array_r_address0 mem_address 1 9 }  { array_r_ce0 mem_ce 1 1 }  { array_r_we0 mem_we 1 1 }  { array_r_d0 mem_din 1 32 }  { array_r_q0 mem_dout 0 32 }  { array_r_address1 MemPortADDR2 1 9 }  { array_r_ce1 MemPortCE2 1 1 }  { array_r_we1 MemPortWE2 1 1 }  { array_r_d1 MemPortDIN2 1 32 }  { array_r_q1 MemPortDOUT2 0 32 } } }
}
