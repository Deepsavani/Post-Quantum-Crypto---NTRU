...
set C_modelArgList {
	{ c int 8 regular {array 699 { 0 0 } 0 1 }  }
	{ rm int 8 regular {array 204 { 1 3 } 1 1 }  }
	{ pk int 8 regular {array 699 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ rm_address0 sc_out sc_lv 8 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "6", "7", "10"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "11870", "EstimateLatencyMax" : "1563302",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_221.grp_mod3_fu_199", "Parent" : "7",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_221.grp_mod3_fu_204", "Parent" : "7",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11870", "Max" : "1563302"}
	, {"Name" : "Interval", "Min" : "11870", "Max" : "1563302"}
]}
...
set Spec2ImplPortList { 
	...
	rm { ap_memory {  { rm_address0 mem_address 1 8 }  { rm_ce0 mem_ce 1 1 }  { rm_q0 mem_dout 0 8 } } }
