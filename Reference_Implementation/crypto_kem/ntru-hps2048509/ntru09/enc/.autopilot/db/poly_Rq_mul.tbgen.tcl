...
set C_modelArgList {
	{ r_coeffs int 16 regular {array 509 { 2 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3564", "Max" : "1554996"}
	, {"Name" : "Interval", "Min" : "3564", "Max" : "1554996"}
]}
...
set Spec2ImplPortList { 
	r_coeffs { ap_memory {  { r_coeffs_address0 mem_address 1 9 }  { r_coeffs_ce0 mem_ce 1 1 }  { r_coeffs_we0 mem_we 1 1 }  { r_coeffs_d0 mem_din 1 16 }  { r_coeffs_q0 mem_dout 0 16 } } }
