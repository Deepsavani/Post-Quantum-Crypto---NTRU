...
architecture behav of crypto_kem_enc is 
    ...
    "crypto_kem_enc,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=33,HLS_SYN_DSP=2,HLS_SYN_FF=9167,HLS_SYN_LUT=47760,HLS_VERSION=2018_3}";
    ...
    signal i_fu_197_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_reg_390 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal r_coeffs_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal m_coeffs_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_sha3_256_fu_142_input_r_address0 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_sample_fixed_type_fu_167_r_coeffs_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_owcpa_enc_fu_173_c_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_owcpa_enc_fu_173_c_address1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_owcpa_enc_fu_173_rm_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_owcpa_enc_fu_173_rm_ce0 : STD_LOGIC;
    signal grp_owcpa_enc_fu_173_pk_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_owcpa_enc_fu_173_pk_ce0 : STD_LOGIC;
    signal grp_owcpa_enc_fu_173_pk_address1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_poly_S3_tobytes_fu_182_msg_address0 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_poly_S3_tobytes_fu_182_msg_offset : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_poly_S3_tobytes_fu_182_a_coeffs_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_poly_S3_tobytes_fu_182_a_coeffs_address1 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal i_i_i_i_reg_131 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_357_i_i_i_i_fu_380_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_176_fu_212_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_fu_208_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_349_i_i_i_i_cast_fu_226_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_348_i_i_i_i_cast_fu_222_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal r_fu_236_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_178_fu_242_p4 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_74_fu_260_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_257_fu_256_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal fold1_i_i_i_i_cast_fu_270_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_351_i_i_i_i_cast_fu_276_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_350_i_i_i_i_cast_fu_252_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal r_4_fu_280_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_179_fu_286_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_177_fu_230_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_75_fu_300_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal fold2_i_i_i_i_cast_fu_310_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_353_i_i_i_i_cast_fu_316_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_352_i_i_i_i_cast_fu_296_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal t_fu_326_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_258_fu_331_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal c_15_cast_fu_339_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_354_i_i_i_i_fu_347_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal not_tmp_33_i_i_i_i_fu_356_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_355_i_i_i_i_cast_fu_362_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_356_i_i_i_i_fu_370_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_354_i_i_i_i_cast_fu_352_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_356_i_i_i_i_cast_fu_376_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_i_i_fu_191_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    tmp_i_i_i_reg_395(8 downto 0) <= tmp_i_i_i_fu_203_p1(8 downto 0);
            end if;
        end if;
    end process;
    tmp_i_i_i_reg_395(63 downto 9) <= "0000000000000000000000000000000000000000000000000000000";
    ...
    c_15_cast_fu_339_p3 <= 
        ap_const_lv3_7 when (tmp_258_fu_331_p3(0) = '1') else 
        ap_const_lv3_0;
    c_address0 <= grp_owcpa_enc_fu_173_c_address0;
    c_address1 <= grp_owcpa_enc_fu_173_c_address1;
    c_ce0 <= grp_owcpa_enc_fu_173_c_ce0;
    ...
    c_we0 <= grp_owcpa_enc_fu_173_c_we0;
    c_we1 <= grp_owcpa_enc_fu_173_c_we1;
    exitcond_i_i_i_fu_191_p2 <= "1" when (i_i_i_i_reg_131 = ap_const_lv9_1FC) else "0";
    fold1_i_i_i_i_cast_fu_270_p2 <= std_logic_vector(unsigned(tmp_74_fu_260_p4) + unsigned(tmp_257_fu_256_p1));
    fold2_i_i_i_i_cast_fu_310_p2 <= std_logic_vector(unsigned(fold1_i_i_i_i_cast_fu_270_p2) + unsigned(tmp_75_fu_300_p4));
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            ...
            grp_poly_S3_tobytes_fu_182_msg_offset <= "XXXXXXXXX";
        end if; 
    end process;
    ...
    i_fu_197_p2 <= std_logic_vector(unsigned(i_i_i_i_reg_131) + unsigned(ap_const_lv9_1));
    ...
    not_tmp_33_i_i_i_i_fu_356_p2 <= (tmp_258_fu_331_p3 xor ap_const_lv1_1);
    pk_address0 <= grp_owcpa_enc_fu_173_pk_address0;
    pk_address1 <= grp_owcpa_enc_fu_173_pk_address1;
    pk_ce0 <= grp_owcpa_enc_fu_173_pk_ce0;
    pk_ce1 <= grp_owcpa_enc_fu_173_pk_ce1;
    r_4_fu_280_p2 <= std_logic_vector(unsigned(tmp_351_i_i_i_i_cast_fu_276_p1) + unsigned(tmp_350_i_i_i_i_cast_fu_252_p1));
    r_5_fu_320_p2 <= std_logic_vector(unsigned(tmp_353_i_i_i_i_cast_fu_316_p1) + unsigned(tmp_352_i_i_i_i_cast_fu_296_p1));
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            r_coeffs_address0 <= tmp_i_i_i_reg_395(9 - 1 downto 0);
    ...
    r_coeffs_d0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state5, tmp_357_i_i_i_i_fu_380_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            r_coeffs_d0 <= tmp_357_i_i_i_i_fu_380_p2;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    r_fu_236_p2 <= std_logic_vector(unsigned(tmp_349_i_i_i_i_cast_fu_226_p1) + unsigned(tmp_348_i_i_i_i_cast_fu_222_p1));
    ...
    tmp_176_fu_212_p4 <= rm_seed_q0(7 downto 4);
    tmp_177_fu_230_p2 <= std_logic_vector(unsigned(tmp_176_fu_212_p4) + unsigned(tmp_fu_208_p1));
    tmp_178_fu_242_p4 <= r_fu_236_p2(4 downto 2);
    tmp_179_fu_286_p4 <= r_4_fu_280_p2(3 downto 2);
    tmp_257_fu_256_p1 <= rm_seed_q0(2 - 1 downto 0);
    tmp_258_fu_331_p3 <= t_fu_326_p2(2 downto 2);
    tmp_348_i_i_i_i_cast_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_176_fu_212_p4),5));
    tmp_349_i_i_i_i_cast_fu_226_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_208_p1),5));
    tmp_350_i_i_i_i_cast_fu_252_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_178_fu_242_p4),4));
    tmp_351_i_i_i_i_cast_fu_276_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(fold1_i_i_i_i_cast_fu_270_p2),4));
    tmp_352_i_i_i_i_cast_fu_296_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_179_fu_286_p4),3));
    tmp_353_i_i_i_i_cast_fu_316_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(fold2_i_i_i_i_cast_fu_310_p2),3));
    tmp_354_i_i_i_i_cast_fu_352_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_354_i_i_i_i_fu_347_p2),16));
    tmp_354_i_i_i_i_fu_347_p2 <= (r_5_reg_405 and c_15_cast_fu_339_p3);
    tmp_355_i_i_i_i_cast_fu_362_p3 <= 
        ap_const_lv3_7 when (not_tmp_33_i_i_i_i_fu_356_p2(0) = '1') else 
        ap_const_lv3_0;
        tmp_356_i_i_i_i_cast_fu_376_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_356_i_i_i_i_fu_370_p2),16));

    tmp_356_i_i_i_i_fu_370_p2 <= (tmp_355_i_i_i_i_cast_fu_362_p3 and t_fu_326_p2);
    tmp_357_i_i_i_i_fu_380_p2 <= (tmp_356_i_i_i_i_cast_fu_376_p1 xor tmp_354_i_i_i_i_cast_fu_352_p1);
    tmp_74_fu_260_p4 <= rm_seed_q0(5 downto 4);
    tmp_75_fu_300_p4 <= tmp_177_fu_230_p2(3 downto 2);
