...
const sc_lv<9> poly_Rq_mul::ap_const_lv9_1 = "1";
const sc_lv<9> poly_Rq_mul::ap_const_lv9_0 = "000000000";
...
const sc_lv<9> poly_Rq_mul::ap_const_lv9_1FE = "111111110";
const sc_lv<9> poly_Rq_mul::ap_const_lv9_1FD = "111111101";
const bool poly_Rq_mul::ap_const_boolean_1 = true;

poly_Rq_mul::poly_Rq_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52 = new crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1<1,1,16,16,16,16>("crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52");
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52->din0(reg_127);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52->din1(reg_131);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52->din2(reg_135);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52->dout(grp_fu_248_p3);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53 = new crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1<1,1,16,16,16,16>("crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53");
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53->din0(reg_127);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53->din1(reg_131);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53->din2(reg_135);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53->dout(grp_fu_257_p3);
    ...
    sensitive << ( tmp_208_fu_180_p1 );
    sensitive << ( tmp_215_fu_223_p1 );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( tmp_210_fu_191_p1 );
    sensitive << ( tmp_216_fu_228_p1 );
    ...
    SC_METHOD(thread_i_11_fu_196_p2);
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_i_12_fu_212_p2);
    sensitive << ( i_1_reg_116 );
    ...
    SC_METHOD(thread_k_1_fu_149_p2);
    sensitive << ( k_reg_94 );
    ...
    sensitive << ( tmp_335_cast_fu_243_p1 );
    ...
    SC_METHOD(thread_tmp_206_fu_170_p2);
    sensitive << ( tmp_s_reg_285 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_207_fu_175_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_cast_fu_166_p1 );

    SC_METHOD(thread_tmp_208_fu_180_p1);
    sensitive << ( tmp_207_fu_175_p2 );

    SC_METHOD(thread_tmp_209_fu_185_p2);
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_210_fu_191_p1);
    sensitive << ( tmp_209_fu_185_p2 );

    SC_METHOD(thread_tmp_213_fu_239_p1);
    sensitive << ( r_coeffs_q0 );

    SC_METHOD(thread_tmp_214_fu_218_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_1_cast_fu_202_p1 );

    SC_METHOD(thread_tmp_215_fu_223_p1);
    sensitive << ( tmp_214_fu_218_p2 );

    SC_METHOD(thread_tmp_216_fu_228_p1);
    sensitive << ( i_1_reg_116 );

    SC_METHOD(thread_tmp_335_cast_fu_243_p1);
    sensitive << ( tmp_213_fu_239_p1 );
    ...
    sc_trace(mVcdFile, k_1_fu_149_p2, "k_1_fu_149_p2");
    ...
    sc_trace(mVcdFile, tmp_206_fu_170_p2, "tmp_206_fu_170_p2");
    sc_trace(mVcdFile, i_11_fu_196_p2, "i_11_fu_196_p2");
    sc_trace(mVcdFile, i_11_reg_303, "i_11_reg_303");
    sc_trace(mVcdFile, i_12_fu_212_p2, "i_12_fu_212_p2");
    sc_trace(mVcdFile, i_12_reg_311, "i_12_reg_311");
    ...
    sc_trace(mVcdFile, tmp_208_fu_180_p1, "tmp_208_fu_180_p1");
    sc_trace(mVcdFile, tmp_210_fu_191_p1, "tmp_210_fu_191_p1");
    sc_trace(mVcdFile, tmp_215_fu_223_p1, "tmp_215_fu_223_p1");
    sc_trace(mVcdFile, tmp_216_fu_228_p1, "tmp_216_fu_228_p1");
    sc_trace(mVcdFile, grp_fu_248_p3, "grp_fu_248_p3");
    sc_trace(mVcdFile, grp_fu_257_p3, "grp_fu_257_p3");
    sc_trace(mVcdFile, tmp_335_cast_fu_243_p1, "tmp_335_cast_fu_243_p1");
    sc_trace(mVcdFile, i_cast_fu_166_p1, "i_cast_fu_166_p1");
    sc_trace(mVcdFile, tmp_207_fu_175_p2, "tmp_207_fu_175_p2");
    sc_trace(mVcdFile, tmp_209_fu_185_p2, "tmp_209_fu_185_p2");
    sc_trace(mVcdFile, i_1_cast_fu_202_p1, "i_1_cast_fu_202_p1");
    sc_trace(mVcdFile, tmp_214_fu_218_p2, "tmp_214_fu_218_p2");
    sc_trace(mVcdFile, tmp_213_fu_239_p1, "tmp_213_fu_239_p1");
...
poly_Rq_mul::~poly_Rq_mul() {
    ...
    delete crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52;
    delete crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53;
}
...
void poly_Rq_mul::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_206_fu_170_p2.read()))) {
        i_1_reg_116 = ap_const_lv9_0;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        i_1_reg_116 = i_12_reg_311.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_reg_105 = i_11_reg_303.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(exitcond1_fu_143_p2.read(), ap_const_lv1_0))) {
        i_reg_105 = ap_const_lv9_1;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        indvars_iv_reg_82 = ap_const_lv9_1;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        indvars_iv_reg_82 = indvars_iv_next_reg_326.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        k_reg_94 = ap_const_lv9_0;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        k_reg_94 = k_1_reg_275.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_206_fu_170_p2.read(), ap_const_lv1_1))) {
        i_11_reg_303 = i_11_fu_196_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        i_12_reg_311 = i_12_fu_212_p2.read();
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        k_1_reg_275 = k_1_fu_149_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond1_fu_143_p2.read(), ap_const_lv1_0))) {
        r_coeffs_addr_reg_280 =  (sc_lv<9>) (tmp_fu_155_p1.read());
...
void poly_Rq_mul::thread_a_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        a_coeffs_address0 =  (sc_lv<9>) (tmp_215_fu_223_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        a_coeffs_address0 =  (sc_lv<9>) (tmp_208_fu_180_p1.read());
    } else {
...
void poly_Rq_mul::thread_b_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        b_coeffs_address0 =  (sc_lv<9>) (tmp_216_fu_228_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        b_coeffs_address0 =  (sc_lv<9>) (tmp_210_fu_191_p1.read());
    } else {
...
void poly_Rq_mul::thread_exitcond1_fu_143_p2() {
    exitcond1_fu_143_p2 = (!indvars_iv_reg_82.read().is_01() || !ap_const_lv9_1FE.is_01())? sc_lv<1>(): sc_lv<1>(indvars_iv_reg_82.read() == ap_const_lv9_1FE);
}
...
void poly_Rq_mul::thread_i_11_fu_196_p2() {
    i_11_fu_196_p2 = (!i_reg_105.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_reg_105.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void poly_Rq_mul::thread_i_12_fu_212_p2() {
    i_12_fu_212_p2 = (!i_1_reg_116.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_1_reg_116.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void poly_Rq_mul::thread_i_1_cast_fu_202_p1() {
    i_1_cast_fu_202_p1 = esl_zext<10,9>(i_1_reg_116.read());
}

void poly_Rq_mul::thread_i_cast_fu_166_p1() {
    i_cast_fu_166_p1 = esl_zext<10,9>(i_reg_105.read());
}

void poly_Rq_mul::thread_indvars_iv_next_fu_233_p2() {
    indvars_iv_next_fu_233_p2 = (!ap_const_lv9_1.is_01() || !indvars_iv_reg_82.read().is_01())? sc_lv<9>(): (sc_biguint<9>(ap_const_lv9_1) + sc_biguint<9>(indvars_iv_reg_82.read()));
}

void poly_Rq_mul::thread_k_1_fu_149_p2() {
    k_1_fu_149_p2 = (!k_reg_94.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(k_reg_94.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void poly_Rq_mul::thread_k_cast2_fu_139_p1() {
    k_cast2_fu_139_p1 = esl_zext<10,9>(k_reg_94.read());
}
...
void poly_Rq_mul::thread_r_coeffs_address0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) || 
        ...
        r_coeffs_address0 =  (sc_lv<9>) (tmp_fu_155_p1.read());
    } else {
...
void poly_Rq_mul::thread_r_coeffs_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        r_coeffs_d0 = tmp_335_cast_fu_243_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
...
void poly_Rq_mul::thread_tmp_206_fu_170_p2() {
    tmp_206_fu_170_p2 = (!i_reg_105.read().is_01() || !tmp_s_reg_285.read().is_01())? sc_lv<1>(): (sc_biguint<9>(i_reg_105.read()) < sc_biguint<9>(tmp_s_reg_285.read()));
}

void poly_Rq_mul::thread_tmp_207_fu_175_p2() {
    tmp_207_fu_175_p2 = (!k_cast2_reg_266.read().is_01() || !i_cast_fu_166_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(k_cast2_reg_266.read()) + sc_biguint<10>(i_cast_fu_166_p1.read()));
}

void poly_Rq_mul::thread_tmp_208_fu_180_p1() {
    tmp_208_fu_180_p1 = esl_zext<64,10>(tmp_207_fu_175_p2.read());
}

void poly_Rq_mul::thread_tmp_209_fu_185_p2() {
    tmp_209_fu_185_p2 = (!ap_const_lv9_1FD.is_01() || !i_reg_105.read().is_01())? sc_lv<9>(): (sc_bigint<9>(ap_const_lv9_1FD) - sc_biguint<9>(i_reg_105.read()));
}

void poly_Rq_mul::thread_tmp_210_fu_191_p1() {
    tmp_210_fu_191_p1 = esl_zext<64,9>(tmp_209_fu_185_p2.read());
}

void poly_Rq_mul::thread_tmp_213_fu_239_p1() {
    tmp_213_fu_239_p1 = r_coeffs_q0.read().range(11-1, 0);
}

void poly_Rq_mul::thread_tmp_214_fu_218_p2() {
    tmp_214_fu_218_p2 = (!k_cast2_reg_266.read().is_01() || !i_1_cast_fu_202_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(k_cast2_reg_266.read()) - sc_biguint<10>(i_1_cast_fu_202_p1.read()));
}

void poly_Rq_mul::thread_tmp_215_fu_223_p1() {
    tmp_215_fu_223_p1 = esl_sext<64,10>(tmp_214_fu_218_p2.read());
}

void poly_Rq_mul::thread_tmp_216_fu_228_p1() {
    tmp_216_fu_228_p1 = esl_zext<64,9>(i_1_reg_116.read());
}

void poly_Rq_mul::thread_tmp_335_cast_fu_243_p1() {
    tmp_335_cast_fu_243_p1 = esl_zext<16,11>(tmp_213_fu_239_p1.read());
}

void poly_Rq_mul::thread_tmp_fu_155_p1() {
    tmp_fu_155_p1 = esl_zext<64,9>(k_reg_94.read());
}

void poly_Rq_mul::thread_tmp_s_fu_160_p2() {
    tmp_s_fu_160_p2 = (!ap_const_lv9_1FD.is_01() || !k_reg_94.read().is_01())? sc_lv<9>(): (sc_bigint<9>(ap_const_lv9_1FD) - sc_biguint<9>(k_reg_94.read()));
}
...
void poly_Rq_mul::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_206_fu_170_p2.read()))) {
