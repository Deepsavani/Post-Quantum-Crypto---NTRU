...
architecture behav of sha3_256 is 
    ...
    signal i_18_i_fu_169_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_18_i_reg_253 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal grp_keccak_absorb_fu_146_m_address0 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_404_i_fu_175_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                i_18_i_reg_253 <= i_18_i_fu_169_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    i_18_i_fu_169_p2 <= std_logic_vector(unsigned(i_i_reg_103) + unsigned(ap_const_lv5_1));
    ...
    s_address0_assign_proc : process(ap_CS_fsm_state5, grp_keccak_absorb_fu_146_s_address0, grp_KeccakF1600_StatePer_fu_156_state_address0, ap_CS_fsm_state4, ap_CS_fsm_state2, tmp_404_i_fu_175_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            s_address0 <= tmp_404_i_fu_175_p1(5 - 1 downto 0);
    ...
    tmp_404_i_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_reg_103),64));
