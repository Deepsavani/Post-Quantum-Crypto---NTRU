...
set C_modelArgList {
	...
	{ c int 8 regular {array 930 { 1 1 } 1 1 }  }
	{ sk int 8 regular {array 1234 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "k", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "k","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "c","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 929,"step" : 1}]}]}]} , 
 	{ "Name" : "sk", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "sk","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 1233,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "12", "21"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "42330", "EstimateLatencyMax" : "8280066",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_fu_167", "Parent" : "0", "Child" : ["4", "5", "6", "10"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3448", "EstimateLatencyMax" : "3448",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_fu_167.grp_keccak_absorb_1_fu_146", "Parent" : "3", "Child" : ["7", "8"],
		...
		"Port" : [
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_KeccakF1600_StatePer_fu_305", "Port" : "state"}]},
			{"Name" : "m", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_KeccakF1600_StatePer_fu_305", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_fu_167.grp_keccak_absorb_1_fu_146.t_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_fu_167.grp_keccak_absorb_1_fu_146.grp_KeccakF1600_StatePer_fu_305", "Parent" : "6", "Child" : ["9"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "9", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_fu_167.grp_keccak_absorb_1_fu_146.grp_KeccakF1600_StatePer_fu_305.KeccakF_RoundConstan_U", "Parent" : "8"},
	...
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146", "Parent" : "12", "Child" : ["16", "17"],
		...
		"Port" : [
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_KeccakF1600_StatePer_fu_268", "Port" : "state"}]},
			{"Name" : "m", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_KeccakF1600_StatePer_fu_268", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "16", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146.t_U", "Parent" : "15"},
	{"ID" : "17", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146.grp_KeccakF1600_StatePer_fu_268", "Parent" : "15", "Child" : ["18"],
		"CDFG" : "KeccakF1600_StatePer",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "18", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146.grp_KeccakF1600_StatePer_fu_268.KeccakF_RoundConstan_U", "Parent" : "17"},
	...
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184", "Parent" : "0", "Child" : ["22", "23", "24", "25", "26", "27", "28", "31", "34", "35", "38"],
		"CDFG" : "owcpa_dec",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "rm", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "38", "SubInstance" : "grp_poly_S3_tobytes_fu_438", "Port" : "msg"}]},
			{"Name" : "ciphertext", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "27", "SubInstance" : "grp_poly_Sq_frombytes_fu_400", "Port" : "a"}]},
			{"Name" : "secretkey", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "31", "SubInstance" : "grp_poly_S3_frombytes_fu_415", "Port" : "msg"},
					{"ID" : "26", "SubInstance" : "grp_poly_Sq_frombytes_1_fu_393", "Port" : "a"}]}]},
	...
	{"ID" : "26", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Sq_frombytes_1_fu_393", "Parent" : "21",
	...
	{"ID" : "27", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Sq_frombytes_fu_400", "Parent" : "21",
		...
		"Port" : [
			{"Name" : "r_coeffs", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "a", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "28", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_mul_fu_408", "Parent" : "21", "Child" : ["29", "30"],
		"CDFG" : "poly_S3_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "29", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_mul_fu_408.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U15", "Parent" : "28"},
	{"ID" : "30", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_mul_fu_408.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U16", "Parent" : "28"},
	{"ID" : "31", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_frombytes_fu_415", "Parent" : "21", "Child" : ["32", "33"],
	...
	{"ID" : "32", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_frombytes_fu_415.grp_mod3_fu_174", "Parent" : "31",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "33", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_frombytes_fu_415.grp_mod3_fu_179", "Parent" : "31",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "34", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_to_S3_fu_425", "Parent" : "21",
		"CDFG" : "poly_Rq_to_S3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "r_coeffs", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "a_coeffs", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "35", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_mul_fu_431", "Parent" : "21", "Child" : ["36", "37"],
		"CDFG" : "poly_Rq_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "a_coeffs", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "b_coeffs", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "36", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_mul_fu_431.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U7", "Parent" : "35"},
	{"ID" : "37", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_mul_fu_431.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U8", "Parent" : "35"},
	{"ID" : "38", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_tobytes_fu_438", "Parent" : "21",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "42330", "Max" : "8280066"}
	, {"Name" : "Interval", "Min" : "42331", "Max" : "8280067"}
]}
