...
{_ssdm_SpecArrayDimSize(pk, 930);_ssdm_SpecArrayDimSize(sk, 1234);
...
{_ssdm_SpecArrayDimSize(c, 930);_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(pk, 930);
...
{_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(c, 930);_ssdm_SpecArrayDimSize(sk, 1234);
  int i, fail;
  unsigned char rm[(2*(((677 -1)+4)/5))];
