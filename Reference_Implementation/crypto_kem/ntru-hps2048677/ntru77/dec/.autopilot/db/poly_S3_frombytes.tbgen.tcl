...
set C_modelArgList {
	{ r_coeffs int 16 regular {array 677 { 0 0 } 0 1 }  }
	{ msg int 8 regular {array 1234 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ msg_address0 sc_out sc_lv 11 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mod3_fu_174", "Parent" : "0",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mod3_fu_179", "Parent" : "0",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	...
	msg { ap_memory {  { msg_address0 mem_address 1 11 }  { msg_ce0 mem_ce 1 1 }  { msg_q0 mem_dout 0 8 } } }
