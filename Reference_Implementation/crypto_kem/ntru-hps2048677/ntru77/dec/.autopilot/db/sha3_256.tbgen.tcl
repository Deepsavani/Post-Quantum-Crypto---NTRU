...
set C_modelArgList {
	...
	{ input_r int 8 regular {array 962 { 1 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_1_fu_146.grp_KeccakF1600_StatePer_fu_305", "Parent" : "3", "Child" : ["6"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "6", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_1_fu_146.grp_KeccakF1600_StatePer_fu_305.KeccakF_RoundConstan_U", "Parent" : "5"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3448", "Max" : "3448"}
	, {"Name" : "Interval", "Min" : "3448", "Max" : "3448"}
]}
