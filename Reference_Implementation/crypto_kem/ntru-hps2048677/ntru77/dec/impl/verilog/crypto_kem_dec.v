...
(* CORE_GENERATION_INFO="crypto_kem_dec,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=26,HLS_SYN_DSP=4,HLS_SYN_FF=14433,HLS_SYN_LUT=77002,HLS_VERSION=2018_3}" *)
...
wire   [5:0] i_30_fu_204_p2;
reg   [5:0] i_30_reg_305;
wire    ap_CS_fsm_state5;
wire   [0:0] exitcond1_fu_198_p2;
wire   [9:0] i_31_fu_232_p2;
reg   [9:0] i_31_reg_318;
wire    ap_CS_fsm_state7;
wire   [0:0] exitcond_fu_226_p2;
wire   [7:0] b_assign_fu_254_p3;
reg   [7:0] b_assign_reg_328;
wire    ap_CS_fsm_state9;
wire    grp_sha3_256_fu_167_ap_ready;
wire    grp_sha3_256_fu_167_ap_done;
wire   [5:0] i_32_fu_273_p2;
reg   [5:0] i_32_reg_336;
...
wire   [63:0] tmp_213_fu_221_p1;
wire   [63:0] tmp_214_fu_238_p1;
wire   [63:0] cmp_0_sum_cast_fu_249_p1;
wire   [63:0] i_i_cast1_fu_261_p1;
wire   [7:0] tmp_248_i_fu_290_p2;
wire   [10:0] i_cast4_fu_194_p1;
wire   [10:0] tmp_fu_210_p2;
wire   [9:0] cmp_0_sum_fu_243_p2;
wire   [7:0] tmp_i_fu_279_p2;
wire   [7:0] tmp_i_63_fu_285_p2;
reg   [10:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_267_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10))) begin
        k_addr_reg_346 <= i_i_cast1_fu_261_p1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state10) & (exitcond_i_fu_267_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        buf_address0 = cmp_0_sum_cast_fu_249_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        buf_address0 = tmp_213_fu_221_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ...
        k_address0 = i_i_cast1_fu_261_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        rm_address0 = i_i_cast1_fu_261_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        rm_address0 = grp_owcpa_dec_fu_184_rm_address0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
assign b_assign_fu_254_p3 = ((fail_reg_297[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign c_address1 = grp_owcpa_dec_fu_184_ciphertext_address1;

assign cmp_0_sum_cast_fu_249_p1 = cmp_0_sum_fu_243_p2;

assign cmp_0_sum_fu_243_p2 = (i_1_reg_144 + 10'd32);

assign exitcond1_fu_198_p2 = ((i_reg_132 == 6'd32) ? 1'b1 : 1'b0);

assign exitcond_fu_226_p2 = ((i_1_reg_144 == 10'd930) ? 1'b1 : 1'b0);

assign exitcond_i_fu_267_p2 = ((i_i_reg_156 == 6'd32) ? 1'b1 : 1'b0);
...
assign i_30_fu_204_p2 = (i_reg_132 + 6'd1);

assign i_31_fu_232_p2 = (i_1_reg_144 + 10'd1);

assign i_32_fu_273_p2 = (i_i_reg_156 + 6'd1);

assign i_cast4_fu_194_p1 = i_reg_132;

assign i_i_cast1_fu_261_p1 = i_i_reg_156;

assign sk_address1 = grp_owcpa_dec_fu_184_secretkey_address1;

assign tmp_213_fu_221_p1 = i_reg_132;

assign tmp_214_fu_238_p1 = i_1_reg_144;

assign tmp_248_i_fu_290_p2 = (tmp_i_63_fu_285_p2 ^ k_q0);

assign tmp_fu_210_p2 = ($signed(i_cast4_fu_194_p1) + $signed(11'd1202));

assign tmp_i_63_fu_285_p2 = (tmp_i_fu_279_p2 & b_assign_reg_328);

assign tmp_i_fu_279_p2 = (rm_q0 ^ k_q0);

assign tmp_s_fu_216_p1 = tmp_fu_210_p2;
