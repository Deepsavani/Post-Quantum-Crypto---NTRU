...
architecture behav of crypto_kem_dec is 
    ...
    "crypto_kem_dec,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=26,HLS_SYN_DSP=4,HLS_SYN_FF=14433,HLS_SYN_LUT=77002,HLS_VERSION=2018_3}";
    ...
    signal i_30_fu_204_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_30_reg_305 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal exitcond1_fu_198_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_31_fu_232_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_31_reg_318 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal exitcond_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal b_assign_fu_254_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal b_assign_reg_328 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal grp_sha3_256_fu_167_ap_ready : STD_LOGIC;
    signal grp_sha3_256_fu_167_ap_done : STD_LOGIC;
    signal i_32_fu_273_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_32_reg_336 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state9) and (grp_sha3_256_fu_167_ap_done = ap_const_logic_1))) then
                b_assign_reg_328 <= b_assign_fu_254_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    buf_address0_assign_proc : process(ap_CS_fsm_state9, grp_sha3_256_fu_167_input_r_address0, ap_CS_fsm_state6, ap_CS_fsm_state8, tmp_213_fu_221_p1, cmp_0_sum_cast_fu_249_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            buf_address0 <= cmp_0_sum_cast_fu_249_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            buf_address0 <= tmp_213_fu_221_p1(10 - 1 downto 0);
    ...
    c_address0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state7, grp_owcpa_dec_fu_184_ciphertext_address0, tmp_214_fu_238_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            c_address0 <= tmp_214_fu_238_p1(10 - 1 downto 0);
    ...
    cmp_0_sum_fu_243_p2 <= std_logic_vector(unsigned(i_1_reg_144) + unsigned(ap_const_lv10_20));
    exitcond1_fu_198_p2 <= "1" when (i_reg_132 = ap_const_lv6_20) else "0";
    exitcond_fu_226_p2 <= "1" when (i_1_reg_144 = ap_const_lv10_3A2) else "0";
    ...
    i_30_fu_204_p2 <= std_logic_vector(unsigned(i_reg_132) + unsigned(ap_const_lv6_1));
    i_31_fu_232_p2 <= std_logic_vector(unsigned(i_1_reg_144) + unsigned(ap_const_lv10_1));
    i_32_fu_273_p2 <= std_logic_vector(unsigned(i_i_reg_156) + unsigned(ap_const_lv6_1));
    ...
    k_d0_assign_proc : process(grp_sha3_256_1_fu_175_output_r_d0, ap_CS_fsm_state4, ap_CS_fsm_state11, tmp_248_i_fu_290_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            k_d0 <= tmp_248_i_fu_290_p2;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    tmp_213_fu_221_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_132),64));
    tmp_214_fu_238_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_144),64));
    tmp_248_i_fu_290_p2 <= (tmp_i_63_fu_285_p2 xor k_q0);
    tmp_fu_210_p2 <= std_logic_vector(unsigned(i_cast4_fu_194_p1) + unsigned(ap_const_lv11_4B2));
    tmp_i_63_fu_285_p2 <= (tmp_i_fu_279_p2 and b_assign_reg_328);
