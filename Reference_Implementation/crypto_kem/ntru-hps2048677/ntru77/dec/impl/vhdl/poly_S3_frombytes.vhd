...
architecture behav of poly_S3_frombytes is 
    ...
    signal tmp_172_fu_200_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_172_reg_394 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_7_fu_214_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_7_reg_403 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal exitcond1_fu_208_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_153_fu_242_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_153_reg_413 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_reg_427 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_120_reg_432 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_118_reg_437 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_119_reg_442 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_161_cast_cast_fu_352_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_171_cast_fu_380_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_156_cast_fu_302_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_166_cast_cast_fu_356_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_cast_fu_229_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum2_cast_fu_253_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_154_fu_338_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_158_fu_347_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_162_fu_365_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_166_fu_375_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_170_fu_389_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_155_fu_262_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_258_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_155_fu_262_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_167_fu_278_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_167_fu_278_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_159_fu_306_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_159_fu_306_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_163_fu_322_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_163_fu_322_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_157_fu_342_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_161_fu_360_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_165_fu_370_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_169_fu_384_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_159_fu_306_p00 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_163_fu_322_p00 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                tmp_118_reg_437 <= tmp_159_fu_306_p2(13 downto 9);
                tmp_119_reg_442 <= tmp_163_fu_322_p2(12 downto 9);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                tmp_120_reg_432 <= tmp_167_fu_278_p2(15 downto 14);
                tmp_reg_427 <= tmp_155_fu_262_p2(15 downto 9);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    grp_mod3_fu_174_a_assign_proc : process(reg_184, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state9, tmp_161_cast_cast_fu_352_p1, tmp_171_cast_fu_380_p1)
    begin
    ...
    grp_mod3_fu_179_a_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state5, tmp_156_cast_fu_302_p1, tmp_166_cast_cast_fu_356_p1)
    begin
    ...
    i_7_fu_214_p2 <= std_logic_vector(unsigned(i_reg_163) + unsigned(ap_const_lv8_1));
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
            if ((exitcond1_fu_208_p2 = ap_const_lv1_1)) then 
                msg_address0 <= sum2_cast_fu_253_p1(11 - 1 downto 0);
            elsif ((exitcond1_fu_208_p2 = ap_const_lv1_0)) then 
                msg_address0 <= sum_cast_fu_229_p1(11 - 1 downto 0);
            else 
    ...
    r_coeffs_address0_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, tmp_154_fu_338_p1, tmp_162_fu_365_p1, tmp_170_fu_389_p1, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            r_coeffs_address0 <= ap_const_lv64_2A4(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            r_coeffs_address0 <= tmp_170_fu_389_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            r_coeffs_address0 <= tmp_162_fu_365_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            r_coeffs_address0 <= tmp_154_fu_338_p1(10 - 1 downto 0);
        else 
    ...
    r_coeffs_address1_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, tmp_158_fu_347_p1, tmp_166_fu_375_p1, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            r_coeffs_address1 <= ap_const_lv64_2A3(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            r_coeffs_address1 <= tmp_166_fu_375_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            r_coeffs_address1 <= tmp_158_fu_347_p1(10 - 1 downto 0);
        else 
    ...
    sum2_fu_248_p2 <= std_logic_vector(unsigned(tmp_172_reg_394) + unsigned(ap_const_lv9_87));
    sum_cast_fu_229_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_fu_224_p2),64));
    sum_fu_224_p2 <= std_logic_vector(unsigned(tmp_cast_fu_220_p1) + unsigned(tmp_172_reg_394));
    tmp_153_fu_242_p2 <= std_logic_vector(unsigned(p_shl_fu_234_p3) + unsigned(i_cast3_fu_204_p1));
    tmp_154_fu_338_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_153_reg_413),64));
    tmp_155_fu_262_p0 <= tmp_s_fu_258_p1(8 - 1 downto 0);
    tmp_155_fu_262_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_155_fu_262_p0) * unsigned(ap_const_lv16_AB), 16));
    tmp_156_cast_fu_302_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_reg_427),8));
    tmp_157_fu_342_p2 <= std_logic_vector(unsigned(tmp_153_reg_413) + unsigned(ap_const_lv10_1));
    tmp_158_fu_347_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_157_fu_342_p2),64));
    tmp_159_fu_306_p0 <= tmp_159_fu_306_p00(8 - 1 downto 0);
    tmp_159_fu_306_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(reg_184),14));
    tmp_159_fu_306_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_159_fu_306_p0) * unsigned(ap_const_lv14_39), 14));
    tmp_161_cast_cast_fu_352_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_118_reg_437),8));
    tmp_161_fu_360_p2 <= std_logic_vector(unsigned(tmp_153_reg_413) + unsigned(ap_const_lv10_2));
    tmp_162_fu_365_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_161_fu_360_p2),64));
    tmp_163_fu_322_p0 <= tmp_163_fu_322_p00(8 - 1 downto 0);
    tmp_163_fu_322_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(reg_184),13));
    tmp_163_fu_322_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_163_fu_322_p0) * unsigned(ap_const_lv13_13), 13));
    tmp_165_fu_370_p2 <= std_logic_vector(unsigned(tmp_153_reg_413) + unsigned(ap_const_lv10_3));
    tmp_166_cast_cast_fu_356_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_119_reg_442),8));
    tmp_166_fu_375_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_165_fu_370_p2),64));
    tmp_167_fu_278_p0 <= tmp_s_fu_258_p1(8 - 1 downto 0);
    tmp_167_fu_278_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_167_fu_278_p0) * unsigned(ap_const_lv16_CB), 16));
    tmp_169_fu_384_p2 <= std_logic_vector(unsigned(tmp_153_reg_413) + unsigned(ap_const_lv10_4));
    tmp_170_fu_389_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_169_fu_384_p2),64));
    tmp_171_cast_fu_380_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_120_reg_432),8));
    tmp_172_fu_200_p1 <= msg_offset(9 - 1 downto 0);
