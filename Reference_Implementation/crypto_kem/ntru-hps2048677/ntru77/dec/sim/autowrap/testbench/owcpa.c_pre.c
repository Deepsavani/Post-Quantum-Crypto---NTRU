# 1 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.c"
# 1 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.c" 2
# 1 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.h" 1



# 1 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/params.h" 1
# 5 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.h" 2
...
# 2 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.c" 2
# 1 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/sample.h" 1
...
# 5 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/sample.h" 2
...
# 7 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/sample.h" 2

void sample_fg(poly *f, poly *g, const unsigned char uniformbytes[((677 -1)+((30*(677 -1)+7)/8))]);
void sample_rm(poly *r, poly *m, const unsigned char uniformbytes[((677 -1)+((30*(677 -1)+7)/8))]);

void sample_iid(poly *r, const unsigned char uniformbytes[(677 -1)]);


void sample_fixed_type(poly *r, const unsigned char uniformbytes[((30*(677 -1)+7)/8)]);
# 3 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.c" 2
...
void owcpa_samplemsg(unsigned char msg[(2*(((677 -1)+4)/5))],
                     const unsigned char seed[((677 -1)+((30*(677 -1)+7)/8))])
{
  poly r, m;
  ...
  poly_S3_tobytes(msg+(((677 -1)+4)/5), &m);
}
                   ...
                   const unsigned char seed[((677 -1)+((30*(677 -1)+7)/8))])
{
  ...
  poly_S3_tobytes(sk+(((677 -1)+4)/5), invf_mod3);


  poly_Z3_to_Zq(f);
  poly_Z3_to_Zq(g);
# 88 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.c"
  for(i=0; i<677; i++)
  ...
  poly_Sq_tobytes(sk+2*(((677 -1)+4)/5), invh);
               ...
               const unsigned char *pk)
{
  ...
  poly_S3_frombytes(m, rm+(((677 -1)+4)/5));
  poly_lift(liftm, m);
  for(i=0; i<677; i++)
              ...
              const unsigned char *secretkey)
{
  ...
  poly_S3_frombytes(finv3, secretkey+(((677 -1)+4)/5));
  poly_S3_mul(m, mf, finv3);
  poly_S3_tobytes(rm+(((677 -1)+4)/5), m);
  ...
  poly_Sq_frombytes(invh, secretkey+2*(((677 -1)+4)/5));
  poly_Sq_mul(r, b, invh);
# 184 "C:/Users/deeps/OneDrive/Desktop/NTRU/NTRU/Reference_Implementation/crypto_kem/ntru-hps2048677/owcpa.c"
