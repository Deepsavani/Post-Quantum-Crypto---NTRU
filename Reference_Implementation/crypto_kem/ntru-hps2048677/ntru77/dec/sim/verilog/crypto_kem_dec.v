...
(* CORE_GENERATION_INFO="crypto_kem_dec,hls_ip_2019_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-fbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=26,HLS_SYN_DSP=4,HLS_SYN_FF=14433,HLS_SYN_LUT=77002,HLS_VERSION=2019_1}" *)
...
wire   [9:0] i_26_fu_232_p2;
reg   [9:0] i_26_reg_318;
wire    ap_CS_fsm_state7;
wire   [0:0] icmp_ln52_fu_226_p2;
wire   [7:0] select_ln23_fu_254_p3;
reg   [7:0] select_ln23_reg_328;
wire    ap_CS_fsm_state9;
wire    grp_sha3_256_fu_167_ap_ready;
wire    grp_sha3_256_fu_167_ap_done;
wire   [5:0] i_27_fu_273_p2;
reg   [5:0] i_27_reg_336;
wire    ap_CS_fsm_state10;
wire   [0:0] icmp_ln24_fu_267_p2;
reg   [4:0] k_addr_reg_346;
reg   [8:0] rm_address0;
reg    rm_ce0;
reg    rm_we0;
reg   [7:0] rm_d0;
...
wire   [9:0] grp_sha3_256_fu_167_input_r_address0;
...
wire   [9:0] grp_owcpa_dec_fu_184_ciphertext_address0;
wire    grp_owcpa_dec_fu_184_ciphertext_ce0;
wire   [9:0] grp_owcpa_dec_fu_184_ciphertext_address1;
...
reg   [5:0] i_0_i_reg_156;
wire    ap_CS_fsm_state11;
reg    grp_sha3_256_fu_167_ap_start_reg;
reg    grp_sha3_256_1_fu_175_ap_start_reg;
wire    ap_CS_fsm_state3;
reg    grp_owcpa_dec_fu_184_ap_start_reg;
wire   [63:0] zext_ln51_fu_216_p1;
wire   [63:0] zext_ln51_1_fu_221_p1;
wire   [63:0] zext_ln53_fu_238_p1;
wire   [63:0] zext_ln53_1_fu_249_p1;
wire   [63:0] zext_ln24_fu_261_p1;
wire   [7:0] xor_ln25_1_fu_290_p2;
wire   [10:0] zext_ln50_fu_194_p1;
wire   [10:0] add_ln51_fu_210_p2;
wire   [9:0] add_ln53_fu_243_p2;
wire   [7:0] xor_ln25_fu_279_p2;
wire   [7:0] and_ln25_fu_285_p2;
reg   [10:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln52_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln50_fu_198_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        i_1_reg_144 <= 10'd0;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        i_1_reg_144 <= i_26_reg_318;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        i_26_reg_318 <= i_26_fu_232_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        i_27_reg_336 <= i_27_fu_273_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        i_reg_305 <= i_fu_204_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln24_fu_267_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10))) begin
        k_addr_reg_346 <= zext_ln24_fu_261_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state9) & (grp_sha3_256_fu_167_ap_done == 1'b1))) begin
        select_ln23_reg_328 <= select_ln23_fu_254_p3;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state10) & (icmp_ln24_fu_267_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        buf_address0 = zext_ln53_1_fu_249_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        buf_address0 = zext_ln51_1_fu_221_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        c_address0 = zext_ln53_fu_238_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ...
        k_address0 = zext_ln24_fu_261_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        rm_address0 = zext_ln24_fu_261_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        rm_address0 = grp_owcpa_dec_fu_184_rm_address0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        sk_address0 = zext_ln51_fu_216_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
assign add_ln51_fu_210_p2 = ($signed(zext_ln50_fu_194_p1) + $signed(11'd1202));

assign add_ln53_fu_243_p2 = (i_1_reg_144 + 10'd32);

assign and_ln25_fu_285_p2 = (xor_ln25_fu_279_p2 & select_ln23_reg_328);
...
assign i_26_fu_232_p2 = (i_1_reg_144 + 10'd1);

assign i_27_fu_273_p2 = (i_0_i_reg_156 + 6'd1);

assign i_fu_204_p2 = (i_0_reg_132 + 6'd1);

assign icmp_ln24_fu_267_p2 = ((i_0_i_reg_156 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln50_fu_198_p2 = ((i_0_reg_132 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln52_fu_226_p2 = ((i_1_reg_144 == 10'd930) ? 1'b1 : 1'b0);

assign select_ln23_fu_254_p3 = ((fail_reg_297[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign sk_address1 = grp_owcpa_dec_fu_184_secretkey_address1;

assign xor_ln25_1_fu_290_p2 = (k_q0 ^ and_ln25_fu_285_p2);

assign xor_ln25_fu_279_p2 = (rm_q0 ^ k_q0);

assign zext_ln24_fu_261_p1 = i_0_i_reg_156;

assign zext_ln50_fu_194_p1 = i_0_reg_132;

assign zext_ln51_1_fu_221_p1 = i_0_reg_132;

assign zext_ln51_fu_216_p1 = add_ln51_fu_210_p2;

assign zext_ln53_1_fu_249_p1 = add_ln53_fu_243_p2;

assign zext_ln53_fu_238_p1 = i_1_reg_144;
