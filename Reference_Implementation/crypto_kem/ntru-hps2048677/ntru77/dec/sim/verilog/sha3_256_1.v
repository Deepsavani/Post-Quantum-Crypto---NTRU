...
wire   [8:0] grp_keccak_absorb_fu_146_m_address0;
...
wire   [63:0] zext_ln47_1_fu_214_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        h_assign_address0 = zext_ln47_1_fu_214_p1;
    end else begin
...
assign i_1_fu_194_p2 = (i_0_i_i_reg_124 + 4'd1);
...
assign zext_ln47_1_fu_214_p1 = add_ln47_fu_209_p2;

assign zext_ln47_fu_205_p1 = i_0_i_i_reg_124;

assign zext_ln48_fu_229_p1 = u_assign_1_fu_219_p4;
