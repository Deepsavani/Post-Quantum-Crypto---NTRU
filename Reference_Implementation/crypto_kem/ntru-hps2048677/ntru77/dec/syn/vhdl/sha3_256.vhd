...
architecture behav of sha3_256 is 
    ...
    signal grp_keccak_absorb_1_fu_146_m_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_248_i_fu_175_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    s_address0_assign_proc : process(ap_CS_fsm_state5, grp_keccak_absorb_1_fu_146_s_address0, grp_KeccakF1600_StatePer_fu_156_state_address0, ap_CS_fsm_state4, ap_CS_fsm_state2, tmp_248_i_fu_175_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            s_address0 <= tmp_248_i_fu_175_p1(5 - 1 downto 0);
    ...
    tmp_248_i_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_reg_103),64));
