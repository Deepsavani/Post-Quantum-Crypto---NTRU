...
set ID 67
set hasByteEnable 0
set MemName crypto_kem_enc_r_coeffs
...
set ID 69
set hasByteEnable 0
set MemName crypto_kem_enc_rm_seed
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 8
set AddrRange 3211
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename k \
    op interface \
    ports { k_address0 { O 5 vector } k_ce0 { O 1 bit } k_we0 { O 1 bit } k_d0 { O 8 vector } } \
} "
} else {
