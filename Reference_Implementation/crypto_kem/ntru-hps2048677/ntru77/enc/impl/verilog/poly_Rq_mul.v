...
wire   [63:0] tmp_195_fu_180_p1;
wire   [63:0] tmp_197_fu_191_p1;
wire  signed [63:0] tmp_202_fu_223_p1;
wire   [63:0] tmp_203_fu_228_p1;
wire  signed [15:0] grp_fu_248_p3;
wire  signed [15:0] grp_fu_257_p3;
wire   [15:0] tmp_326_cast_fu_243_p1;
wire   [10:0] i_cast_fu_166_p1;
wire   [10:0] tmp_194_fu_175_p2;
wire   [9:0] tmp_196_fu_185_p2;
wire   [10:0] i_1_cast_fu_202_p1;
wire   [10:0] tmp_201_fu_218_p2;
wire   [10:0] tmp_200_fu_239_p1;
reg   [8:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_193_fu_170_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_116 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_193_fu_170_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        a_coeffs_address0 = tmp_202_fu_223_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        a_coeffs_address0 = tmp_195_fu_180_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        b_coeffs_address0 = tmp_203_fu_228_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        b_coeffs_address0 = tmp_197_fu_191_p1;
    end else begin
...
assign exitcond1_fu_143_p2 = ((indvars_iv_reg_82 == 10'd678) ? 1'b1 : 1'b0);
...
assign tmp_193_fu_170_p2 = ((i_reg_105 < tmp_s_reg_285) ? 1'b1 : 1'b0);

assign tmp_194_fu_175_p2 = (k_cast2_reg_266 + i_cast_fu_166_p1);

assign tmp_195_fu_180_p1 = tmp_194_fu_175_p2;

assign tmp_196_fu_185_p2 = ($signed(10'd677) - $signed(i_reg_105));

assign tmp_197_fu_191_p1 = tmp_196_fu_185_p2;

assign tmp_200_fu_239_p1 = r_coeffs_q0[10:0];

assign tmp_201_fu_218_p2 = (k_cast2_reg_266 - i_1_cast_fu_202_p1);

assign tmp_202_fu_223_p1 = $signed(tmp_201_fu_218_p2);

assign tmp_203_fu_228_p1 = i_1_reg_116;

assign tmp_326_cast_fu_243_p1 = tmp_200_fu_239_p1;

assign tmp_fu_155_p1 = k_reg_94;

assign tmp_s_fu_160_p2 = ($signed(10'd677) - $signed(k_reg_94));
