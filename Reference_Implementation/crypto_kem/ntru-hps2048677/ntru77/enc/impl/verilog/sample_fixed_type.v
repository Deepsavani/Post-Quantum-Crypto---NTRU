...
wire   [9:0] tmp_5_fu_477_p3;
reg   [9:0] tmp_5_reg_851;
wire    ap_CS_fsm_state4;
reg   [1:0] tmp_2_reg_858;
reg   [3:0] tmp_9_reg_883;
wire    ap_CS_fsm_state6;
reg   [5:0] tmp_12_reg_908;
...
wire   [63:0] tmp_21_fu_792_p1;
reg   [63:0] tmp_21_reg_962;
...
wire   [63:0] tmp_11_fu_645_p1;
wire   [63:0] sum12_cast_fu_665_p1;
wire   [63:0] sum13_cast_fu_675_p1;
wire   [63:0] sum14_cast_fu_685_p1;
wire   [63:0] tmp_16_fu_727_p1;
wire   [63:0] tmp_17_fu_744_p1;
wire   [63:0] tmp_19_fu_762_p1;
wire   [31:0] tmp_4_fu_462_p6;
wire   [31:0] tmp_3_fu_544_p7;
wire   [31:0] tmp_s_fu_624_p7;
wire   [31:0] tmp_14_fu_715_p2;
wire   [31:0] tmp_18_fu_749_p2;
wire   [31:0] tmp_20_fu_773_p2;
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_756_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state13))) begin
        ...
        s_addr_5_reg_944[7 : 0] <= tmp_19_fu_762_p1[7 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_732_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state11))) begin
        s_addr_4_reg_936[6 : 0] <= tmp_17_fu_744_p1[6 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        tmp_12_reg_908 <= {{u_q1[7:2]}};
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_780_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state16))) begin
        tmp_21_reg_962[9 : 0] <= tmp_21_fu_792_p1[9 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        tmp_5_reg_851[9 : 2] <= tmp_5_fu_477_p3[9 : 2];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state17)) begin
        r_coeffs_address0 = tmp_21_reg_962;
...
assign tmp_10_fu_458_p1 = u_q1[5:0];

assign tmp_11_fu_645_p1 = tmp_1_fu_640_p2;

assign tmp_13_fu_690_p4 = {{{reg_374}, {tmp_12_reg_908}}, {2'd0}};

assign tmp_14_fu_715_p2 = (tmp9_fu_703_p5 + tmp_73_cast_fu_699_p1);

assign tmp_15_fu_722_p2 = (tmp_5_reg_851 | 10'd3);

assign tmp_16_fu_727_p1 = tmp_15_fu_722_p2;

assign tmp_17_fu_744_p1 = i_1_reg_336;

assign tmp_18_fu_749_p2 = (s_q0 | 32'd1);

assign tmp_19_fu_762_p1 = i_2_reg_347;

assign tmp_1_fu_640_p2 = (tmp_5_reg_851 | 10'd2);

assign tmp_20_fu_773_p2 = (s_q0 | 32'd2);

assign tmp_21_fu_792_p1 = i_3_reg_358;

assign tmp_24_fu_540_p1 = u_q1[3:0];

assign tmp_25_fu_620_p1 = u_q1[1:0];

assign tmp_26_fu_797_p1 = s_q0[1:0];

assign tmp_3_fu_544_p7 = {{{{{{tmp_24_fu_540_p1}, {u_q0}}, {reg_378}}, {reg_374}}, {tmp_2_reg_858}}, {2'd0}};

assign tmp_4_fu_462_p6 = {{{{{tmp_10_fu_458_p1}, {u_q0}}, {reg_378}}, {reg_374}}, {2'd0}};

assign tmp_5_fu_477_p3 = {{i_reg_324}, {2'd0}};

assign tmp_6_fu_485_p1 = tmp_5_fu_477_p3;

assign tmp_73_cast_fu_699_p1 = tmp_13_fu_690_p4;

assign tmp_7_fu_560_p2 = (tmp_5_reg_851 | 10'd1);

assign tmp_8_fu_565_p1 = tmp_7_fu_560_p2;

assign tmp_92_cast_fu_801_p1 = tmp_26_fu_797_p1;

assign tmp_fu_410_p2 = (p_shl_cast_fu_406_p1 - i_cast1_fu_382_p1);

assign tmp_s_fu_624_p7 = {{{{{{tmp_25_fu_620_p1}, {u_q0}}, {reg_378}}, {reg_374}}, {tmp_9_reg_883}}, {2'd0}};

always @ (posedge ap_clk) begin
    tmp_5_reg_851[1:0] <= 2'b00;
    s_addr_4_reg_936[9:7] <= 3'b000;
    s_addr_5_reg_944[9:8] <= 2'b00;
    tmp_21_reg_962[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end
