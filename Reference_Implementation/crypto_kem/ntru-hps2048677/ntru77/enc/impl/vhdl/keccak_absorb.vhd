...
architecture behav of keccak_absorb is 
    ...
    signal i_18_fu_287_p2 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_3_fu_309_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_3_reg_542 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_344_cast_fu_323_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_344_cast_reg_547 : STD_LOGIC_VECTOR (8 downto 0);
    signal exitcond4_fu_303_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal indvars_iv_next_fu_327_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvars_iv_next_reg_552 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_5_fu_343_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_5_reg_560 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal tmp_i_fu_337_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal s_addr_7_reg_570 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_20_fu_421_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal i_21_fu_444_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_21_reg_607 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_212_fu_450_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_212_reg_612 : STD_LOGIC_VECTOR (7 downto 0);
    signal exitcond_fu_438_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_6_fu_468_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_6_reg_620 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state12 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state12 : signal is "none";
    signal tmp_i2_fu_462_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal s_addr_8_reg_630 : STD_LOGIC_VECTOR (4 downto 0);
    signal r_3_fu_510_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal i_19_reg_163 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal i_2_cast6_fu_410_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_i1_cast_fu_479_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_213_fu_397_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_214_fu_516_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_211_fu_315_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_i_cast8_fu_333_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp1_fu_349_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal sum_i_fu_355_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_209_fu_369_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_346_i_fu_373_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_i_43_fu_365_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_346_i_cast_fu_381_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_347_i_fu_385_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_i2_cast3_fu_458_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_i1_fu_474_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_215_fu_488_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_348_i_fu_492_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_i1_fu_484_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_348_i_cast_fu_500_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_349_i_fu_504_p2 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    i_19_reg_163_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_fu_281_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                ...
                i_19_reg_163 <= indvars_iv_next_reg_552;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond4_fu_303_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                indvars_iv_next_reg_552 <= indvars_iv_next_fu_327_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_i_fu_337_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                s_addr_7_reg_570 <= i_1_cast_reg_534(5 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_i2_fu_462_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state12))) then
                s_addr_8_reg_630 <= i_4_cast5_reg_599(5 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_438_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state11))) then
                    tmp_212_reg_612(7 downto 3) <= tmp_212_fu_450_p3(7 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    i_18_fu_287_p2 <= std_logic_vector(unsigned(i_reg_152) + unsigned(ap_const_lv5_1));
    i_1_cast_fu_299_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_187),64));
    i_20_fu_421_p2 <= std_logic_vector(unsigned(i_2_reg_222) + unsigned(ap_const_lv8_1));
    i_21_fu_444_p2 <= std_logic_vector(unsigned(i_4_reg_233) + unsigned(ap_const_lv5_1));
    i_2_cast6_fu_410_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_2_reg_222),64));
    i_3_fu_309_p2 <= std_logic_vector(unsigned(i_1_reg_187) + unsigned(ap_const_lv5_1));
    i_4_cast5_fu_434_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_4_reg_233),64));
    i_5_fu_343_p2 <= std_logic_vector(unsigned(i_i_reg_210) + unsigned(ap_const_lv4_1));
    i_6_fu_468_p2 <= std_logic_vector(unsigned(i_i2_reg_256) + unsigned(ap_const_lv4_1));
    ...
    i_i_cast8_fu_333_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_reg_210),9));
    indvars_iv_next_fu_327_p2 <= std_logic_vector(unsigned(i_19_reg_163) + unsigned(ap_const_lv9_178));
    ...
    r_3_fu_510_p2 <= (tmp_349_i_fu_504_p2 or r_i1_reg_244);
    r_fu_391_p2 <= (tmp_347_i_fu_385_p2 or r_i_reg_198);

    s_address0_assign_proc : process(ap_CS_fsm_state2, i_1_cast_reg_534, ap_CS_fsm_state5, s_addr_7_reg_570, ap_CS_fsm_state8, i_4_cast5_reg_599, ap_CS_fsm_state12, s_addr_8_reg_630, grp_KeccakF1600_StatePer_fu_268_state_address0, ap_CS_fsm_state7, ap_CS_fsm_state14, i_cast_fu_276_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            s_address0 <= s_addr_8_reg_630;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
            s_address0 <= i_4_cast5_reg_599(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            s_address0 <= s_addr_7_reg_570;
    ...
    s_d0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state8, grp_KeccakF1600_StatePer_fu_268_state_d0, ap_CS_fsm_state7, ap_CS_fsm_state14, tmp_213_fu_397_p2, tmp_214_fu_516_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            s_d0 <= tmp_214_fu_516_p2;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            s_d0 <= tmp_213_fu_397_p2;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    sum_i1_cast_fu_479_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_i1_fu_474_p2),64));
    sum_i1_fu_474_p2 <= std_logic_vector(unsigned(tmp_212_reg_612) + unsigned(i_i2_cast3_fu_458_p1));
    sum_i_cast_fu_360_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_i_fu_355_p2),64));
    sum_i_fu_355_p2 <= std_logic_vector(unsigned(tmp_344_cast_reg_547) + unsigned(tmp1_fu_349_p2));

    t_address0_assign_proc : process(ap_CS_fsm_state9, exitcond3_fu_415_p2, ap_CS_fsm_state10, i_2_cast6_fu_410_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            ...
            t_address0 <= i_2_cast6_fu_410_p1(8 - 1 downto 0);
        else 
            t_address0 <= "XXXXXXXX";
        end if; 
    end process;
    ...
    t_address1_assign_proc : process(ap_CS_fsm_state12, ap_CS_fsm_state10, sum_i1_cast_fu_479_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
            t_address1 <= sum_i1_cast_fu_479_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
    ...
    tmp1_fu_349_p2 <= std_logic_vector(unsigned(i_i_cast8_fu_333_p1) + unsigned(p_01_rec_reg_175));
    tmp_209_fu_369_p1 <= i_i_reg_210(3 - 1 downto 0);
    tmp_211_fu_315_p3 <= (i_1_reg_187 & ap_const_lv3_0);
    tmp_212_fu_450_p3 <= (i_4_reg_233 & ap_const_lv3_0);
    tmp_213_fu_397_p2 <= (s_q0 xor r_i_reg_198);
    tmp_214_fu_516_p2 <= (s_q0 xor r_i1_reg_244);
    tmp_215_fu_488_p1 <= i_i2_reg_256(3 - 1 downto 0);
    tmp_344_cast_fu_323_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_211_fu_315_p3),9));
    tmp_346_i_cast_fu_381_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_346_i_fu_373_p3),64));
    tmp_346_i_fu_373_p3 <= (tmp_209_fu_369_p1 & ap_const_lv3_0);
    tmp_347_i_fu_385_p2 <= std_logic_vector(shift_left(unsigned(tmp_i_43_fu_365_p1),to_integer(unsigned('0' & tmp_346_i_cast_fu_381_p1(31-1 downto 0)))));
    tmp_348_i_cast_fu_500_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_348_i_fu_492_p3),64));
    tmp_348_i_fu_492_p3 <= (tmp_215_fu_488_p1 & ap_const_lv3_0);
    tmp_349_i_fu_504_p2 <= std_logic_vector(shift_left(unsigned(tmp_i1_fu_484_p1),to_integer(unsigned('0' & tmp_348_i_cast_fu_500_p1(31-1 downto 0)))));
    tmp_fu_281_p2 <= "1" when (i_reg_152 = ap_const_lv5_19) else "0";
    tmp_i1_fu_484_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_q1),64));
    tmp_i2_fu_462_p2 <= "1" when (i_i2_reg_256 = ap_const_lv4_8) else "0";
    tmp_i_43_fu_365_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(m_q0),64));
    tmp_i_fu_337_p2 <= "1" when (i_i_reg_210 = ap_const_lv4_8) else "0";
    tmp_s_fu_293_p2 <= "1" when (unsigned(i_19_reg_163) < unsigned(ap_const_lv9_88)) else "0";
end behav;
