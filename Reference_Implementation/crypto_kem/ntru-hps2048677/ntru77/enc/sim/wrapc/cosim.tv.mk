# ==============================================================
# File generated on Tue Aug 25 12:00:55 EDT 2020
...
$(ObjDir)/PQCgenKAT_kem.c_pre.c.tb.o : PQCgenKAT_kem.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) PQCgenKAT_kem.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/crypto_sort.c_pre.c.tb.o : crypto_sort.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) crypto_sort.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
...
$(ObjDir)/kem.c_pre.c.tb.o : kem.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) kem.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/owcpa.c_pre.c.tb.o : owcpa.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) owcpa.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/pack3.c_pre.c.tb.o : pack3.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) pack3.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/packq.c_pre.c.tb.o : packq.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) packq.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
...
$(ObjDir)/verify.c_pre.c.tb.o : verify.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) verify.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
