...
sha3_256::sha3_256(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    s_U->d1(s_d1);
    s_U->q1(s_q1);
    h_assign_U = new sha3_256_h_assign("h_assign_U");
    ...
    SC_METHOD(thread_i_18_i_fu_169_p2);
    sensitive << ( i_i_reg_103 );
    ...
    sensitive << ( tmp_5_i_i_cast_fu_205_p1 );

    SC_METHOD(thread_tmp_1_fu_229_p1);
    sensitive << ( u_assign_1_fu_219_p4 );

    SC_METHOD(thread_tmp_404_i_fu_175_p1);
    sensitive << ( i_i_reg_103 );

    SC_METHOD(thread_tmp_5_i_i_cast_fu_205_p1);
    sensitive << ( i_i_i_reg_124 );
    ...
    sc_trace(mVcdFile, i_18_i_fu_169_p2, "i_18_i_fu_169_p2");
    sc_trace(mVcdFile, i_18_i_reg_253, "i_18_i_reg_253");
    ...
    sc_trace(mVcdFile, tmp_404_i_fu_175_p1, "tmp_404_i_fu_175_p1");
    sc_trace(mVcdFile, sum_i_i_cast_fu_214_p1, "sum_i_i_cast_fu_214_p1");
    sc_trace(mVcdFile, tmp_5_i_i_cast_fu_205_p1, "tmp_5_i_i_cast_fu_205_p1");
...
void sha3_256::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read()) && 
        ...
        i_i_reg_103 = i_18_i_reg_253.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_18_i_reg_253 = i_18_i_fu_169_p2.read();
    }
...
void sha3_256::thread_grp_keccak_absorb_fu_146_ap_start() {
...
void sha3_256::thread_i_18_i_fu_169_p2() {
    i_18_i_fu_169_p2 = (!i_i_reg_103.read().is_01() || !ap_const_lv5_1.is_01())? sc_lv<5>(): (sc_biguint<5>(i_i_reg_103.read()) + sc_biguint<5>(ap_const_lv5_1));
}

void sha3_256::thread_i_1_fu_244_p2() {
    i_1_fu_244_p2 = (!i_reg_135.read().is_01() || !ap_const_lv6_1.is_01())? sc_lv<6>(): (sc_biguint<6>(i_reg_135.read()) + sc_biguint<6>(ap_const_lv6_1));
}

void sha3_256::thread_i_2_fu_194_p2() {
...
void sha3_256::thread_s_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        s_address0 =  (sc_lv<5>) (tmp_404_i_fu_175_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
...
void sha3_256::thread_sum_i_i_fu_209_p2() {
    sum_i_i_fu_209_p2 = (!tmp_i_reg_263.read().is_01() || !tmp_5_i_i_cast_fu_205_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_i_reg_263.read()) + sc_biguint<8>(tmp_5_i_i_cast_fu_205_p1.read()));
}

void sha3_256::thread_tmp_1_fu_229_p1() {
    tmp_1_fu_229_p1 = esl_zext<64,56>(u_assign_1_fu_219_p4.read());
}

void sha3_256::thread_tmp_404_i_fu_175_p1() {
    tmp_404_i_fu_175_p1 = esl_zext<64,5>(i_i_reg_103.read());
}

void sha3_256::thread_tmp_5_i_i_cast_fu_205_p1() {
    tmp_5_i_i_cast_fu_205_p1 = esl_zext<8,4>(i_i_i_reg_124.read());
}
...
void sha3_256::thread_u_assign_1_fu_219_p4() {
