...
architecture behav of crypto_kem_enc is 
    ...
    "crypto_kem_enc,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=33,HLS_SYN_DSP=2,HLS_SYN_FF=9199,HLS_SYN_LUT=47392,HLS_VERSION=2018_3}";
    ...
    signal tmp_345_i_i_i_i_fu_380_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_167_fu_212_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_fu_208_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_337_i_i_i_i_cast_fu_226_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_336_i_i_i_i_cast_fu_222_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal r_fu_236_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_169_fu_242_p4 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_67_fu_260_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_244_fu_256_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal fold1_i_i_i_i_cast_fu_270_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_339_i_i_i_i_cast_fu_276_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_338_i_i_i_i_cast_fu_252_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal r_4_fu_280_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_170_fu_286_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_168_fu_230_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_68_fu_300_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal fold2_i_i_i_i_cast_fu_310_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_341_i_i_i_i_cast_fu_316_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_340_i_i_i_i_cast_fu_296_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal t_fu_326_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_245_fu_331_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal c_13_cast_fu_339_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_342_i_i_i_i_fu_347_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal not_tmp_33_i_i_i_i_fu_356_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_343_i_i_i_i_cast_fu_362_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_344_i_i_i_i_fu_370_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_342_i_i_i_i_cast_fu_352_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_344_i_i_i_i_cast_fu_376_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    c_13_cast_fu_339_p3 <= 
        ap_const_lv3_7 when (tmp_245_fu_331_p3(0) = '1') else 
        ap_const_lv3_0;
    c_address0 <= grp_owcpa_enc_fu_173_c_address0;
    c_address1 <= grp_owcpa_enc_fu_173_c_address1;
    c_ce0 <= grp_owcpa_enc_fu_173_c_ce0;
    ...
    c_we0 <= grp_owcpa_enc_fu_173_c_we0;
    c_we1 <= grp_owcpa_enc_fu_173_c_we1;
    exitcond_i_i_i_fu_191_p2 <= "1" when (i_i_i_i_reg_131 = ap_const_lv10_2A4) else "0";
    fold1_i_i_i_i_cast_fu_270_p2 <= std_logic_vector(unsigned(tmp_67_fu_260_p4) + unsigned(tmp_244_fu_256_p1));
    fold2_i_i_i_i_cast_fu_310_p2 <= std_logic_vector(unsigned(fold1_i_i_i_i_cast_fu_270_p2) + unsigned(tmp_68_fu_300_p4));
    ...
    not_tmp_33_i_i_i_i_fu_356_p2 <= (tmp_245_fu_331_p3 xor ap_const_lv1_1);
    pk_address0 <= grp_owcpa_enc_fu_173_pk_address0;
    pk_address1 <= grp_owcpa_enc_fu_173_pk_address1;
    pk_ce0 <= grp_owcpa_enc_fu_173_pk_ce0;
    pk_ce1 <= grp_owcpa_enc_fu_173_pk_ce1;
    r_4_fu_280_p2 <= std_logic_vector(unsigned(tmp_339_i_i_i_i_cast_fu_276_p1) + unsigned(tmp_338_i_i_i_i_cast_fu_252_p1));
    r_5_fu_320_p2 <= std_logic_vector(unsigned(tmp_341_i_i_i_i_cast_fu_316_p1) + unsigned(tmp_340_i_i_i_i_cast_fu_296_p1));
    ...
    r_coeffs_d0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state5, tmp_345_i_i_i_i_fu_380_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    r_fu_236_p2 <= std_logic_vector(unsigned(tmp_337_i_i_i_i_cast_fu_226_p1) + unsigned(tmp_336_i_i_i_i_cast_fu_222_p1));
    ...
    tmp_167_fu_212_p4 <= rm_seed_q0(7 downto 4);
    tmp_168_fu_230_p2 <= std_logic_vector(unsigned(tmp_167_fu_212_p4) + unsigned(tmp_fu_208_p1));
    tmp_169_fu_242_p4 <= r_fu_236_p2(4 downto 2);
    tmp_170_fu_286_p4 <= r_4_fu_280_p2(3 downto 2);
    tmp_244_fu_256_p1 <= rm_seed_q0(2 - 1 downto 0);
    tmp_245_fu_331_p3 <= t_fu_326_p2(2 downto 2);
    tmp_336_i_i_i_i_cast_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_167_fu_212_p4),5));
    tmp_337_i_i_i_i_cast_fu_226_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_208_p1),5));
    tmp_338_i_i_i_i_cast_fu_252_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_169_fu_242_p4),4));
    tmp_339_i_i_i_i_cast_fu_276_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(fold1_i_i_i_i_cast_fu_270_p2),4));
    tmp_340_i_i_i_i_cast_fu_296_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_170_fu_286_p4),3));
    tmp_341_i_i_i_i_cast_fu_316_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(fold2_i_i_i_i_cast_fu_310_p2),3));
    tmp_342_i_i_i_i_cast_fu_352_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_342_i_i_i_i_fu_347_p2),16));
    tmp_342_i_i_i_i_fu_347_p2 <= (r_5_reg_405 and c_13_cast_fu_339_p3);
    tmp_343_i_i_i_i_cast_fu_362_p3 <= 
        ap_const_lv3_7 when (not_tmp_33_i_i_i_i_fu_356_p2(0) = '1') else 
        ap_const_lv3_0;
        tmp_344_i_i_i_i_cast_fu_376_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_344_i_i_i_i_fu_370_p2),16));

    tmp_344_i_i_i_i_fu_370_p2 <= (tmp_343_i_i_i_i_cast_fu_362_p3 and t_fu_326_p2);
    tmp_345_i_i_i_i_fu_380_p2 <= (tmp_344_i_i_i_i_cast_fu_376_p1 xor tmp_342_i_i_i_i_cast_fu_352_p1);
    tmp_67_fu_260_p4 <= rm_seed_q0(5 downto 4);
    tmp_68_fu_300_p4 <= tmp_168_fu_230_p2(3 downto 2);
