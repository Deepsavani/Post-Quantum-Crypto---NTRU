...
architecture behav of randombytes_1 is 
    ...
    constant ap_const_lv12_4B2 : STD_LOGIC_VECTOR (11 downto 0) := "010010110010";
...
begin
    ...
    sum2_fu_363_p2 <= std_logic_vector(unsigned(tmp_104_cast_fu_358_p2) + unsigned(ap_const_lv12_4B2));
        sum_cast_fu_349_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sum_fu_343_p2),64));

    sum_fu_343_p2 <= std_logic_vector(unsigned(tmp_102_cast_fu_338_p2) + unsigned(ap_const_lv12_4B2));
