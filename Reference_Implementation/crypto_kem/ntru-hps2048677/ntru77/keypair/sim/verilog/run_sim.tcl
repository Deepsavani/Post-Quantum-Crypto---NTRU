...
if {[file isfile crypto_kem_keypair.autotvin.dat]} {
	file delete -force crypto_kem_keypair.autotvin.dat
}

if {[file isfile crypto_kem_keypair.autotvout.dat]} {
	file delete -force crypto_kem_keypair.autotvout.dat
}
