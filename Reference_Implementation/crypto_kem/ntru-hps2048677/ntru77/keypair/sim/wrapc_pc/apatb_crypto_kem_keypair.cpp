// ==============================================================
// File generated on Tue Aug 25 12:31:51 EDT 2020
...
char sk[1234])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *pk_pc_buffer = new sc_bv<8>[930];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: pk
				{
					...
					// {
						// celement: pk(7, 0)
						// {
							sc_lv<8>* pk_lv0_0_929_1 = new sc_lv<8>[930];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						{
							// carray: (0) => (929) @ (1)
							for (int i_0 = 0; i_0 <= 929; i_0 += 1)
							{
								if (&(pk[0]) != NULL) // check the null address if the c port is array or others
								{
									pk_lv0_0_929_1[hls_map_index].range(7, 0) = sc_bv<8>(pk_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: pk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 929; i_0 += 1)
							{
								...
								// output_type_conversion : (pk_lv0_0_929_1[hls_map_index]).to_uint64()
								if (&(pk[0]) != NULL) // check the null address if the c port is array or others
								{
									pk[i_0] = (pk_lv0_0_929_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *sk_pc_buffer = new sc_bv<8>[1234];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: sk
				{
					...
					// {
						// celement: sk(7, 0)
						// {
							sc_lv<8>* sk_lv0_0_1233_1 = new sc_lv<8>[1234];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						{
							// carray: (0) => (1233) @ (1)
							for (int i_0 = 0; i_0 <= 1233; i_0 += 1)
							{
								if (&(sk[0]) != NULL) // check the null address if the c port is array or others
								{
									sk_lv0_0_1233_1[hls_map_index].range(7, 0) = sc_bv<8>(sk_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: sk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 1233; i_0 += 1)
							{
								...
								// output_type_conversion : (sk_lv0_0_1233_1[hls_map_index]).to_uint64()
								if (&(sk[0]) != NULL) // check the null address if the c port is array or others
								{
									sk[i_0] = (sk_lv0_0_1233_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<8>* pk_tvin_wrapc_buffer = new sc_bv<8>[930];
		...
		tcl_file.set_num(930, &tcl_file.pk_depth);
		...
		sc_bv<8>* sk_tvin_wrapc_buffer = new sc_bv<8>[1234];
		...
		tcl_file.set_num(1234, &tcl_file.sk_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<8>* pk_tvout_wrapc_buffer = new sc_bv<8>[930];
		...
		sc_bv<8>* sk_tvout_wrapc_buffer = new sc_bv<8>[1234];
