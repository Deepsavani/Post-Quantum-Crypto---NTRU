...
poly_Rq_mul::poly_Rq_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_205_fu_182_p1 );
    sensitive << ( tmp_211_fu_225_p1 );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( tmp_207_fu_193_p1 );
    sensitive << ( tmp_212_fu_230_p1 );
    ...
    sensitive << ( tmp_295_cast_fu_245_p1 );
    ...
    SC_METHOD(thread_tmp_203_fu_172_p2);
    sensitive << ( tmp_s_reg_287 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( i_reg_107 );

    SC_METHOD(thread_tmp_204_fu_177_p2);
    sensitive << ( k_cast2_reg_268 );
    sensitive << ( i_cast_fu_168_p1 );

    SC_METHOD(thread_tmp_205_fu_182_p1);
    sensitive << ( tmp_204_fu_177_p2 );

    SC_METHOD(thread_tmp_206_fu_187_p2);
    sensitive << ( i_reg_107 );

    SC_METHOD(thread_tmp_207_fu_193_p1);
    sensitive << ( tmp_206_fu_187_p2 );

    SC_METHOD(thread_tmp_210_fu_220_p2);
    sensitive << ( k_cast2_reg_268 );
    sensitive << ( i_1_cast_fu_204_p1 );

    SC_METHOD(thread_tmp_211_fu_225_p1);
    sensitive << ( tmp_210_fu_220_p2 );

    SC_METHOD(thread_tmp_212_fu_230_p1);
    sensitive << ( i_1_reg_118 );

    SC_METHOD(thread_tmp_270_fu_241_p1);
    sensitive << ( r_coeffs_q0 );

    SC_METHOD(thread_tmp_295_cast_fu_245_p1);
    sensitive << ( tmp_270_fu_241_p1 );
    ...
    sc_trace(mVcdFile, tmp_203_fu_172_p2, "tmp_203_fu_172_p2");
    ...
    sc_trace(mVcdFile, tmp_205_fu_182_p1, "tmp_205_fu_182_p1");
    sc_trace(mVcdFile, tmp_207_fu_193_p1, "tmp_207_fu_193_p1");
    sc_trace(mVcdFile, tmp_211_fu_225_p1, "tmp_211_fu_225_p1");
    sc_trace(mVcdFile, tmp_212_fu_230_p1, "tmp_212_fu_230_p1");
    sc_trace(mVcdFile, grp_fu_250_p3, "grp_fu_250_p3");
    sc_trace(mVcdFile, grp_fu_259_p3, "grp_fu_259_p3");
    sc_trace(mVcdFile, tmp_295_cast_fu_245_p1, "tmp_295_cast_fu_245_p1");
    sc_trace(mVcdFile, i_cast_fu_168_p1, "i_cast_fu_168_p1");
    sc_trace(mVcdFile, tmp_204_fu_177_p2, "tmp_204_fu_177_p2");
    sc_trace(mVcdFile, tmp_206_fu_187_p2, "tmp_206_fu_187_p2");
    sc_trace(mVcdFile, i_1_cast_fu_204_p1, "i_1_cast_fu_204_p1");
    sc_trace(mVcdFile, tmp_210_fu_220_p2, "tmp_210_fu_220_p2");
    sc_trace(mVcdFile, tmp_270_fu_241_p1, "tmp_270_fu_241_p1");
...
void poly_Rq_mul::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_203_fu_172_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_203_fu_172_p2.read(), ap_const_lv1_1))) {
...
void poly_Rq_mul::thread_a_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        a_coeffs_address0 =  (sc_lv<10>) (tmp_211_fu_225_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        a_coeffs_address0 =  (sc_lv<10>) (tmp_205_fu_182_p1.read());
    } else {
...
void poly_Rq_mul::thread_b_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        b_coeffs_address0 =  (sc_lv<10>) (tmp_212_fu_230_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        b_coeffs_address0 =  (sc_lv<10>) (tmp_207_fu_193_p1.read());
    } else {
...
void poly_Rq_mul::thread_exitcond1_fu_145_p2() {
    exitcond1_fu_145_p2 = (!indvars_iv_reg_84.read().is_01() || !ap_const_lv10_2A6.is_01())? sc_lv<1>(): sc_lv<1>(indvars_iv_reg_84.read() == ap_const_lv10_2A6);
}
...
void poly_Rq_mul::thread_r_coeffs_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        r_coeffs_d0 = tmp_295_cast_fu_245_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
...
void poly_Rq_mul::thread_tmp_203_fu_172_p2() {
    tmp_203_fu_172_p2 = (!i_reg_107.read().is_01() || !tmp_s_reg_287.read().is_01())? sc_lv<1>(): (sc_biguint<10>(i_reg_107.read()) < sc_biguint<10>(tmp_s_reg_287.read()));
}

void poly_Rq_mul::thread_tmp_204_fu_177_p2() {
    tmp_204_fu_177_p2 = (!k_cast2_reg_268.read().is_01() || !i_cast_fu_168_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(k_cast2_reg_268.read()) + sc_biguint<11>(i_cast_fu_168_p1.read()));
}

void poly_Rq_mul::thread_tmp_205_fu_182_p1() {
    tmp_205_fu_182_p1 = esl_zext<64,11>(tmp_204_fu_177_p2.read());
}

void poly_Rq_mul::thread_tmp_206_fu_187_p2() {
    tmp_206_fu_187_p2 = (!ap_const_lv10_2A5.is_01() || !i_reg_107.read().is_01())? sc_lv<10>(): (sc_bigint<10>(ap_const_lv10_2A5) - sc_biguint<10>(i_reg_107.read()));
}

void poly_Rq_mul::thread_tmp_207_fu_193_p1() {
    tmp_207_fu_193_p1 = esl_zext<64,10>(tmp_206_fu_187_p2.read());
}

void poly_Rq_mul::thread_tmp_210_fu_220_p2() {
    tmp_210_fu_220_p2 = (!k_cast2_reg_268.read().is_01() || !i_1_cast_fu_204_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(k_cast2_reg_268.read()) - sc_biguint<11>(i_1_cast_fu_204_p1.read()));
}

void poly_Rq_mul::thread_tmp_211_fu_225_p1() {
    tmp_211_fu_225_p1 = esl_sext<64,11>(tmp_210_fu_220_p2.read());
}

void poly_Rq_mul::thread_tmp_212_fu_230_p1() {
    tmp_212_fu_230_p1 = esl_zext<64,10>(i_1_reg_118.read());
}

void poly_Rq_mul::thread_tmp_270_fu_241_p1() {
    tmp_270_fu_241_p1 = r_coeffs_q0.read().range(11-1, 0);
}

void poly_Rq_mul::thread_tmp_295_cast_fu_245_p1() {
    tmp_295_cast_fu_245_p1 = esl_zext<16,11>(tmp_270_fu_241_p1.read());
}
...
void poly_Rq_mul::thread_tmp_s_fu_162_p2() {
    tmp_s_fu_162_p2 = (!ap_const_lv10_2A5.is_01() || !k_reg_96.read().is_01())? sc_lv<10>(): (sc_bigint<10>(ap_const_lv10_2A5) - sc_biguint<10>(k_reg_96.read()));
}
...
void poly_Rq_mul::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_203_fu_172_p2.read()))) {
