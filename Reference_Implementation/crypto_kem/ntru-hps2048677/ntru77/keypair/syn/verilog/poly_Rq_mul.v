...
wire   [63:0] tmp_205_fu_182_p1;
wire   [63:0] tmp_207_fu_193_p1;
wire  signed [63:0] tmp_211_fu_225_p1;
wire   [63:0] tmp_212_fu_230_p1;
wire  signed [15:0] grp_fu_250_p3;
wire  signed [15:0] grp_fu_259_p3;
wire   [15:0] tmp_295_cast_fu_245_p1;
wire   [10:0] i_cast_fu_168_p1;
wire   [10:0] tmp_204_fu_177_p2;
wire   [9:0] tmp_206_fu_187_p2;
wire   [10:0] i_1_cast_fu_204_p1;
wire   [10:0] tmp_210_fu_220_p2;
wire   [10:0] tmp_270_fu_241_p1;
reg   [8:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_203_fu_172_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_118 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_203_fu_172_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        a_coeffs_address0 = tmp_211_fu_225_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        a_coeffs_address0 = tmp_205_fu_182_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        b_coeffs_address0 = tmp_212_fu_230_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        b_coeffs_address0 = tmp_207_fu_193_p1;
    end else begin
...
assign exitcond1_fu_145_p2 = ((indvars_iv_reg_84 == 10'd678) ? 1'b1 : 1'b0);
...
assign tmp_203_fu_172_p2 = ((i_reg_107 < tmp_s_reg_287) ? 1'b1 : 1'b0);

assign tmp_204_fu_177_p2 = (k_cast2_reg_268 + i_cast_fu_168_p1);

assign tmp_205_fu_182_p1 = tmp_204_fu_177_p2;

assign tmp_206_fu_187_p2 = ($signed(10'd677) - $signed(i_reg_107));

assign tmp_207_fu_193_p1 = tmp_206_fu_187_p2;

assign tmp_210_fu_220_p2 = (k_cast2_reg_268 - i_1_cast_fu_204_p1);

assign tmp_211_fu_225_p1 = $signed(tmp_210_fu_220_p2);

assign tmp_212_fu_230_p1 = i_1_reg_118;

assign tmp_270_fu_241_p1 = r_coeffs_q0[10:0];

assign tmp_295_cast_fu_245_p1 = tmp_270_fu_241_p1;

assign tmp_fu_157_p1 = k_reg_96;

assign tmp_s_fu_162_p2 = ($signed(10'd677) - $signed(k_reg_96));
