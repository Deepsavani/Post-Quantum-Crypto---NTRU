...
architecture behav of crypto_kem_keypair is 
    ...
    "crypto_kem_keypair,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=46,HLS_SYN_DSP=8,HLS_SYN_FF=5556,HLS_SYN_LUT=23585,HLS_VERSION=2018_3}";
