...
set C_modelArgList {
	...
	{ c int 8 regular {array 1230 { 1 1 } 1 1 }  }
	{ sk int 8 regular {array 1590 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "k", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "k","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "c","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 1229,"step" : 1}]}]}]} , 
 	{ "Name" : "sk", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "sk","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 1589,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "12", "21"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "51394", "EstimateLatencyMax" : "12169354",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_fu_167", "Parent" : "0", "Child" : ["4", "5", "6", "10"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "4256", "EstimateLatencyMax" : "4256",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_fu_167.grp_keccak_absorb_1_fu_146", "Parent" : "3", "Child" : ["7", "8"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3950", "EstimateLatencyMax" : "3950",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146", "Parent" : "12", "Child" : ["16", "17"],
		...
		"Port" : [
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_KeccakF1600_StatePer_fu_305", "Port" : "state"}]},
			{"Name" : "m", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_KeccakF1600_StatePer_fu_305", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "16", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146.t_U", "Parent" : "15"},
	{"ID" : "17", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146.grp_KeccakF1600_StatePer_fu_305", "Parent" : "15", "Child" : ["18"],
		"CDFG" : "KeccakF1600_StatePer",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "18", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_sha3_256_1_fu_175.grp_keccak_absorb_fu_146.grp_KeccakF1600_StatePer_fu_305.KeccakF_RoundConstan_U", "Parent" : "17"},
	...
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184", "Parent" : "0", "Child" : ["22", "23", "24", "25", "26", "29", "32", "33", "36", "37"],
		"CDFG" : "owcpa_dec",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "42883", "EstimateLatencyMax" : "12160843",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state11", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_S3_mul_fu_441"},
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_S3_frombytes_fu_448"},
			{"State" : "ap_ST_fsm_state9", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_S3_frombytes_fu_448"},
			{"State" : "ap_ST_fsm_state7", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_Rq_to_S3_fu_459"},
			{"State" : "ap_ST_fsm_state5", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_Rq_mul_fu_465"},
			{"State" : "ap_ST_fsm_state25", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_Rq_mul_fu_465"},
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_Rq_sum_zero_fro_fu_472"},
			{"State" : "ap_ST_fsm_state13", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_S3_tobytes_fu_480"},
			{"State" : "ap_ST_fsm_state33", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_poly_S3_tobytes_fu_480"}],
		"Port" : [
			{"Name" : "rm", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "37", "SubInstance" : "grp_poly_S3_tobytes_fu_480", "Port" : "msg"}]},
			{"Name" : "ciphertext", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "36", "SubInstance" : "grp_poly_Rq_sum_zero_fro_fu_472", "Port" : "a"}]},
			{"Name" : "secretkey", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "29", "SubInstance" : "grp_poly_S3_frombytes_fu_448", "Port" : "msg"}]}]},
	...
	{"ID" : "26", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_mul_fu_441", "Parent" : "21", "Child" : ["27", "28"],
		"CDFG" : "poly_S3_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "7391", "EstimateLatencyMax" : "4046711",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "27", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_mul_fu_441.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U15", "Parent" : "26"},
	{"ID" : "28", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_mul_fu_441.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U16", "Parent" : "26"},
	{"ID" : "29", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_frombytes_fu_448", "Parent" : "21", "Child" : ["30", "31"],
	...
	{"ID" : "30", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_frombytes_fu_448.grp_mod3_fu_153", "Parent" : "29",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "31", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_frombytes_fu_448.grp_mod3_fu_158", "Parent" : "29",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "32", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_to_S3_fu_459", "Parent" : "21",
		"CDFG" : "poly_Rq_to_S3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "r_coeffs", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "a_coeffs", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "33", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_mul_fu_465", "Parent" : "21", "Child" : ["34", "35"],
		"CDFG" : "poly_Rq_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "a_coeffs", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "b_coeffs", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "34", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_mul_fu_465.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U7", "Parent" : "33"},
	{"ID" : "35", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_mul_fu_465.crypto_kem_dec_mac_muladd_16s_16s_16ns_16_1_1_U8", "Parent" : "33"},
	{"ID" : "36", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_Rq_sum_zero_fro_fu_472", "Parent" : "21",
	...
	{"ID" : "37", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_owcpa_dec_fu_184.grp_poly_S3_tobytes_fu_480", "Parent" : "21",
...
set ArgLastReadFirstWriteLatency {
	crypto_kem_dec {
		...
		sk {Type I LastRead 18 FirstWrite -1}
	...
	owcpa_dec {
		...
		secretkey {Type I LastRead 18 FirstWrite -1}}
	poly_S3_mul {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "51394", "Max" : "12169354"}
	, {"Name" : "Interval", "Min" : "51395", "Max" : "12169355"}
]}
