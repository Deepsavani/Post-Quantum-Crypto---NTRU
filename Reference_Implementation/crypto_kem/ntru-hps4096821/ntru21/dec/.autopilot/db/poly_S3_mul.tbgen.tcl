...
set C_modelArgList {
	{ r_coeffs int 16 regular {array 821 { 2 2 } 1 1 }  }
	{ a_coeffs int 16 regular {array 821 { 1 3 } 1 1 }  }
	{ b_coeffs int 16 regular {array 821 { 1 3 } 1 1 }  }
}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7391", "Max" : "4046711"}
	, {"Name" : "Interval", "Min" : "7391", "Max" : "4046711"}
]}
...
set Spec2ImplPortList { 
	r_coeffs { ap_memory {  { r_coeffs_address0 mem_address 1 10 }  { r_coeffs_ce0 mem_ce 1 1 }  { r_coeffs_we0 mem_we 1 1 }  { r_coeffs_d0 mem_din 1 16 }  { r_coeffs_q0 mem_dout 0 16 }  { r_coeffs_address1 MemPortADDR2 1 10 }  { r_coeffs_ce1 MemPortCE2 1 1 }  { r_coeffs_we1 MemPortWE2 1 1 }  { r_coeffs_d1 MemPortDIN2 1 16 }  { r_coeffs_q1 MemPortDOUT2 0 16 } } }
