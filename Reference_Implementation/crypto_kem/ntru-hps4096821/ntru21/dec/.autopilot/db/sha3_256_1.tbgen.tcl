...
set C_modelName {sha3_256.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r int 8 regular {array 32 { 0 3 } 0 1 }  }
	{ input_r int 8 regular {array 328 { 1 3 } 1 1 }  }
}
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_fu_146", "Parent" : "0", "Child" : ["4", "5"],
		...
		"Port" : [
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_KeccakF1600_StatePer_fu_305", "Port" : "state"}]},
			{"Name" : "m", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_KeccakF1600_StatePer_fu_305", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_fu_146.t_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_fu_146.grp_KeccakF1600_StatePer_fu_305", "Parent" : "3", "Child" : ["6"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "6", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_fu_146.grp_KeccakF1600_StatePer_fu_305.KeccakF_RoundConstan_U", "Parent" : "5"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1660", "Max" : "1660"}
	, {"Name" : "Interval", "Min" : "1660", "Max" : "1660"}
]}
