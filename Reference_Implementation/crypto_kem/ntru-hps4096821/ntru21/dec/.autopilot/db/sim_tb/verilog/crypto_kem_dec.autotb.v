// ==============================================================
// File generated on Tue Aug 25 18:37:03 EDT 2020
...
`define AUTOTB_DUT      crypto_kem_dec
`define AUTOTB_DUT_INST AESL_inst_crypto_kem_dec
`define AUTOTB_TOP      apatb_crypto_kem_dec_top
`define AUTOTB_LAT_RESULT_FILE "crypto_kem_dec.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "crypto_kem_dec.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_crypto_kem_dec_top
...
`define AUTOTB_TVIN_k  "./c.crypto_kem_dec.autotvin_k.dat"
`define AUTOTB_TVIN_c  "./c.crypto_kem_dec.autotvin_c.dat"
`define AUTOTB_TVIN_sk  "./c.crypto_kem_dec.autotvin_sk.dat"
`define AUTOTB_TVIN_k_out_wrapc  "./rtl.crypto_kem_dec.autotvin_k.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.crypto_kem_dec.autotvin_c.dat"
`define AUTOTB_TVIN_sk_out_wrapc  "./rtl.crypto_kem_dec.autotvin_sk.dat"
`define AUTOTB_TVOUT_k  "./c.crypto_kem_dec.autotvout_k.dat"
`define AUTOTB_TVOUT_ap_return  "./c.crypto_kem_dec.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_k_out_wrapc  "./impl_rtl.crypto_kem_dec.autotvout_k.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.crypto_kem_dec.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 12169354;
parameter LENGTH_k = 32;
parameter LENGTH_c = 1230;
parameter LENGTH_sk = 1590;
...
assign arrayk_done = interface_done;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.crypto_kem_dec.autotvout_k.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_dec.autotvout_k.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_dec.autotvout_k.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_dec.autotvout_k.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_dec.autotvout_k.dat with impl_rtl.crypto_kem_dec.autotvout_k.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_kem_dec.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_dec.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_dec.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_dec.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_dec.autotvout_ap_return.dat with impl_rtl.crypto_kem_dec.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
