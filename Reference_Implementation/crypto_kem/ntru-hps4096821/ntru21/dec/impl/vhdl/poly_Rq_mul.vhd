...
architecture behav of poly_Rq_mul is 
    ...
    signal tmp_61_fu_170_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_12_fu_196_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_12_reg_303 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_13_fu_212_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_13_reg_311 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_63_fu_180_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_65_fu_191_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_69_fu_223_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_70_fu_228_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_248_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_257_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_73_cast_fu_243_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal i_cast_fu_166_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_62_fu_175_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_64_fu_185_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_1_cast_fu_202_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_68_fu_218_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_78_fu_239_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_61_fu_170_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                i_1_reg_116 <= ap_const_lv10_0;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
                i_1_reg_116 <= i_13_reg_311;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_61_fu_170_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                i_12_reg_303 <= i_12_fu_196_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, exitcond1_fu_143_p2, ap_CS_fsm_state3, tmp_61_fu_170_p2, ap_CS_fsm_state6, exitcond_fu_206_p2)
    begin
        case ap_CS_fsm is
    ...
    a_coeffs_address0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state6, tmp_63_fu_180_p1, tmp_69_fu_223_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            a_coeffs_address0 <= tmp_69_fu_223_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            a_coeffs_address0 <= tmp_63_fu_180_p1(10 - 1 downto 0);
        else 
    ...
    b_coeffs_address0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state6, tmp_65_fu_191_p1, tmp_70_fu_228_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            b_coeffs_address0 <= tmp_70_fu_228_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            b_coeffs_address0 <= tmp_65_fu_191_p1(10 - 1 downto 0);
        else 
    ...
    i_12_fu_196_p2 <= std_logic_vector(unsigned(i_reg_105) + unsigned(ap_const_lv10_1));
    i_13_fu_212_p2 <= std_logic_vector(unsigned(i_1_reg_116) + unsigned(ap_const_lv10_1));
    ...
    r_coeffs_d0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state9, ap_CS_fsm_state5, ap_CS_fsm_state8, grp_fu_248_p3, grp_fu_257_p3, tmp_73_cast_fu_243_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            r_coeffs_d0 <= tmp_73_cast_fu_243_p1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
    ...
    tmp_61_fu_170_p2 <= "1" when (unsigned(i_reg_105) < unsigned(tmp_s_reg_285)) else "0";
    tmp_62_fu_175_p2 <= std_logic_vector(unsigned(k_cast2_reg_266) + unsigned(i_cast_fu_166_p1));
    tmp_63_fu_180_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_62_fu_175_p2),64));
    tmp_64_fu_185_p2 <= std_logic_vector(signed(ap_const_lv10_335) - signed(i_reg_105));
    tmp_65_fu_191_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_64_fu_185_p2),64));
    tmp_68_fu_218_p2 <= std_logic_vector(unsigned(k_cast2_reg_266) - unsigned(i_1_cast_fu_202_p1));
        tmp_69_fu_223_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_68_fu_218_p2),64));

    tmp_70_fu_228_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_116),64));
    tmp_73_cast_fu_243_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_78_fu_239_p1),16));
    tmp_78_fu_239_p1 <= r_coeffs_q0(12 - 1 downto 0);
