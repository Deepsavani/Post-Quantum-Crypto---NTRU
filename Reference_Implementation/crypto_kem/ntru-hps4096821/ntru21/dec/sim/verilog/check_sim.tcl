...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.crypto_kem_dec.autotvin_k.dat"
         "c.crypto_kem_dec.autotvin_c.dat"
         "c.crypto_kem_dec.autotvin_sk.dat"
         "c.crypto_kem_dec.autotvout_k.dat"
         "c.crypto_kem_dec.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.crypto_kem_dec.autotvout_k.dat"
         "rtl.crypto_kem_dec.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
