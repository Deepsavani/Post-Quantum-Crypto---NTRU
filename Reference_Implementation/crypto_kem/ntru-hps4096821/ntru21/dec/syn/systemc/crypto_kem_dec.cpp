...
const sc_lv<11> crypto_kem_dec::ap_const_lv11_0 = "00000000000";
...
const sc_lv<10> crypto_kem_dec::ap_const_lv10_216 = "1000010110";
const sc_lv<11> crypto_kem_dec::ap_const_lv11_4CE = "10011001110";
const sc_lv<11> crypto_kem_dec::ap_const_lv11_1 = "1";
const sc_lv<11> crypto_kem_dec::ap_const_lv11_20 = "100000";
...
crypto_kem_dec::crypto_kem_dec(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( exitcond_i_fu_271_p2 );
    ...
    SC_METHOD(thread_b_assign_fu_258_p3);
    sensitive << ( fail_reg_301 );
    ...
    sensitive << ( tmp_94_fu_225_p1 );
    sensitive << ( cmp_0_sum_cast_fu_253_p1 );
    ...
    SC_METHOD(thread_cmp_0_sum_cast_fu_253_p1);
    sensitive << ( cmp_0_sum_fu_247_p2 );

    SC_METHOD(thread_cmp_0_sum_fu_247_p2);
    ...
    SC_METHOD(thread_exitcond_i_fu_271_p2);
    sensitive << ( ap_CS_fsm_state10 );
    ...
    SC_METHOD(thread_i_33_fu_204_p2);
    sensitive << ( i_reg_132 );

    SC_METHOD(thread_i_34_fu_236_p2);
    sensitive << ( i_1_reg_144 );

    SC_METHOD(thread_i_35_fu_277_p2);
    sensitive << ( i_i_reg_156 );

    SC_METHOD(thread_i_cast4_cast_fu_194_p1);
    sensitive << ( i_reg_132 );

    SC_METHOD(thread_i_i_cast1_fu_265_p1);
    sensitive << ( i_i_reg_156 );

    SC_METHOD(thread_k_address0);
    sensitive << ( ap_CS_fsm_state10 );
    sensitive << ( k_addr_reg_350 );
    sensitive << ( grp_sha3_256_1_fu_175_output_r_address0 );
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ap_CS_fsm_state11 );
    sensitive << ( i_i_cast1_fu_265_p1 );
    ...
    SC_METHOD(thread_tmp_150_i_fu_294_p2);
    sensitive << ( k_q0 );
    sensitive << ( tmp_i_66_fu_289_p2 );

    SC_METHOD(thread_tmp_94_fu_225_p1);
    sensitive << ( i_reg_132 );

    SC_METHOD(thread_tmp_95_fu_242_p1);
    sensitive << ( i_1_reg_144 );

    SC_METHOD(thread_tmp_cast5_fu_216_p1);
    sensitive << ( tmp_fu_210_p2 );

    SC_METHOD(thread_tmp_fu_210_p2);
    sensitive << ( i_cast4_cast_fu_194_p1 );

    SC_METHOD(thread_tmp_i_66_fu_289_p2);
    sensitive << ( b_assign_reg_332 );
    sensitive << ( tmp_i_fu_283_p2 );

    SC_METHOD(thread_tmp_i_fu_283_p2);
    sensitive << ( k_q0 );
    sensitive << ( rm_q0 );

    SC_METHOD(thread_tmp_s_fu_220_p1);
    sensitive << ( tmp_cast5_fu_216_p1 );
    ...
    sc_trace(mVcdFile, fail_reg_301, "fail_reg_301");
    ...
    sc_trace(mVcdFile, i_33_fu_204_p2, "i_33_fu_204_p2");
    sc_trace(mVcdFile, i_33_reg_309, "i_33_reg_309");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, exitcond1_fu_198_p2, "exitcond1_fu_198_p2");
    sc_trace(mVcdFile, i_34_fu_236_p2, "i_34_fu_236_p2");
    sc_trace(mVcdFile, i_34_reg_322, "i_34_reg_322");
    sc_trace(mVcdFile, ap_CS_fsm_state7, "ap_CS_fsm_state7");
    sc_trace(mVcdFile, exitcond_fu_230_p2, "exitcond_fu_230_p2");
    sc_trace(mVcdFile, b_assign_fu_258_p3, "b_assign_fu_258_p3");
    sc_trace(mVcdFile, b_assign_reg_332, "b_assign_reg_332");
    ...
    sc_trace(mVcdFile, i_35_fu_277_p2, "i_35_fu_277_p2");
    sc_trace(mVcdFile, i_35_reg_340, "i_35_reg_340");
    sc_trace(mVcdFile, ap_CS_fsm_state10, "ap_CS_fsm_state10");
    sc_trace(mVcdFile, exitcond_i_fu_271_p2, "exitcond_i_fu_271_p2");
    sc_trace(mVcdFile, k_addr_reg_350, "k_addr_reg_350");
    ...
    sc_trace(mVcdFile, tmp_94_fu_225_p1, "tmp_94_fu_225_p1");
    sc_trace(mVcdFile, tmp_95_fu_242_p1, "tmp_95_fu_242_p1");
    sc_trace(mVcdFile, cmp_0_sum_cast_fu_253_p1, "cmp_0_sum_cast_fu_253_p1");
    sc_trace(mVcdFile, i_i_cast1_fu_265_p1, "i_i_cast1_fu_265_p1");
    sc_trace(mVcdFile, tmp_150_i_fu_294_p2, "tmp_150_i_fu_294_p2");
    sc_trace(mVcdFile, i_cast4_cast_fu_194_p1, "i_cast4_cast_fu_194_p1");
    sc_trace(mVcdFile, tmp_fu_210_p2, "tmp_fu_210_p2");
    sc_trace(mVcdFile, tmp_cast5_fu_216_p1, "tmp_cast5_fu_216_p1");
    sc_trace(mVcdFile, cmp_0_sum_fu_247_p2, "cmp_0_sum_fu_247_p2");
    sc_trace(mVcdFile, tmp_i_fu_283_p2, "tmp_i_fu_283_p2");
    sc_trace(mVcdFile, tmp_i_66_fu_289_p2, "tmp_i_66_fu_289_p2");
...
void crypto_kem_dec::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read()) && esl_seteq<1,1,1>(grp_sha3_256_fu_167_ap_done.read(), ap_const_logic_1))) {
        b_assign_reg_332 = b_assign_fu_258_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(grp_owcpa_dec_fu_184_ap_done.read(), ap_const_logic_1))) {
        fail_reg_301 = grp_owcpa_dec_fu_184_ap_return.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_33_reg_309 = i_33_fu_204_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        i_34_reg_322 = i_34_fu_236_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        i_35_reg_340 = i_35_fu_277_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_271_p2.read()))) {
        k_addr_reg_350 =  (sc_lv<5>) (i_i_cast1_fu_265_p1.read());
    }
}
...
void crypto_kem_dec::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && 
         esl_seteq<1,1,1>(exitcond_i_fu_271_p2.read(), ap_const_lv1_1))) {
...
void crypto_kem_dec::thread_b_assign_fu_258_p3() {
    b_assign_fu_258_p3 = (!fail_reg_301.read()[0].is_01())? sc_lv<8>(): ((fail_reg_301.read()[0].to_bool())? ap_const_lv8_FF: ap_const_lv8_0);
}

void crypto_kem_dec::thread_buf_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        buf_address0 =  (sc_lv<11>) (cmp_0_sum_cast_fu_253_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        buf_address0 =  (sc_lv<11>) (tmp_94_fu_225_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        buf_address0 = grp_sha3_256_fu_167_input_r_address0.read();
    } else {
        buf_address0 =  (sc_lv<11>) ("XXXXXXXXXXX");
    }
}
...
void crypto_kem_dec::thread_c_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        c_address0 =  (sc_lv<11>) (tmp_95_fu_242_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        c_address0 = grp_owcpa_dec_fu_184_ciphertext_address0.read();
    } else {
        c_address0 =  (sc_lv<11>) ("XXXXXXXXXXX");
    }
}
...
void crypto_kem_dec::thread_cmp_0_sum_cast_fu_253_p1() {
    cmp_0_sum_cast_fu_253_p1 = esl_zext<64,11>(cmp_0_sum_fu_247_p2.read());
}

void crypto_kem_dec::thread_cmp_0_sum_fu_247_p2() {
    cmp_0_sum_fu_247_p2 = (!i_1_reg_144.read().is_01() || !ap_const_lv11_20.is_01())? sc_lv<11>(): (sc_biguint<11>(i_1_reg_144.read()) + sc_biguint<11>(ap_const_lv11_20));
}
...
void crypto_kem_dec::thread_exitcond_fu_230_p2() {
    exitcond_fu_230_p2 = (!i_1_reg_144.read().is_01() || !ap_const_lv11_4CE.is_01())? sc_lv<1>(): sc_lv<1>(i_1_reg_144.read() == ap_const_lv11_4CE);
}

void crypto_kem_dec::thread_exitcond_i_fu_271_p2() {
    exitcond_i_fu_271_p2 = (!i_i_reg_156.read().is_01() || !ap_const_lv6_20.is_01())? sc_lv<1>(): sc_lv<1>(i_i_reg_156.read() == ap_const_lv6_20);
}
...
void crypto_kem_dec::thread_i_33_fu_204_p2() {
    i_33_fu_204_p2 = (!i_reg_132.read().is_01() || !ap_const_lv6_1.is_01())? sc_lv<6>(): (sc_biguint<6>(i_reg_132.read()) + sc_biguint<6>(ap_const_lv6_1));
}

void crypto_kem_dec::thread_i_34_fu_236_p2() {
    i_34_fu_236_p2 = (!i_1_reg_144.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(i_1_reg_144.read()) + sc_biguint<11>(ap_const_lv11_1));
}

void crypto_kem_dec::thread_i_35_fu_277_p2() {
    i_35_fu_277_p2 = (!i_i_reg_156.read().is_01() || !ap_const_lv6_1.is_01())? sc_lv<6>(): (sc_biguint<6>(i_i_reg_156.read()) + sc_biguint<6>(ap_const_lv6_1));
}

void crypto_kem_dec::thread_i_cast4_cast_fu_194_p1() {
    i_cast4_cast_fu_194_p1 = esl_zext<10,6>(i_reg_132.read());
}

void crypto_kem_dec::thread_i_i_cast1_fu_265_p1() {
    i_i_cast1_fu_265_p1 = esl_zext<64,6>(i_i_reg_156.read());
}

void crypto_kem_dec::thread_k_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read())) {
        k_address0 = k_addr_reg_350.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        k_address0 =  (sc_lv<5>) (i_i_cast1_fu_265_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
...
void crypto_kem_dec::thread_rm_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        rm_address0 =  (sc_lv<9>) (i_i_cast1_fu_265_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void crypto_kem_dec::thread_sk_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        sk_address0 =  (sc_lv<11>) (tmp_s_fu_220_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void crypto_kem_dec::thread_tmp_150_i_fu_294_p2() {
    tmp_150_i_fu_294_p2 = (k_q0.read() ^ tmp_i_66_fu_289_p2.read());
}

void crypto_kem_dec::thread_tmp_94_fu_225_p1() {
    tmp_94_fu_225_p1 = esl_zext<64,6>(i_reg_132.read());
}

void crypto_kem_dec::thread_tmp_95_fu_242_p1() {
    tmp_95_fu_242_p1 = esl_zext<64,11>(i_1_reg_144.read());
}

void crypto_kem_dec::thread_tmp_cast5_fu_216_p1() {
    tmp_cast5_fu_216_p1 = esl_sext<11,10>(tmp_fu_210_p2.read());
}

void crypto_kem_dec::thread_tmp_fu_210_p2() {
    tmp_fu_210_p2 = (!i_cast4_cast_fu_194_p1.read().is_01() || !ap_const_lv10_216.is_01())? sc_lv<10>(): (sc_biguint<10>(i_cast4_cast_fu_194_p1.read()) + sc_bigint<10>(ap_const_lv10_216));
}

void crypto_kem_dec::thread_tmp_i_66_fu_289_p2() {
    tmp_i_66_fu_289_p2 = (tmp_i_fu_283_p2.read() & b_assign_reg_332.read());
}

void crypto_kem_dec::thread_tmp_i_fu_283_p2() {
    tmp_i_fu_283_p2 = (k_q0.read() ^ rm_q0.read());
}

void crypto_kem_dec::thread_tmp_s_fu_220_p1() {
    tmp_s_fu_220_p1 = esl_zext<64,11>(tmp_cast5_fu_216_p1.read());
}
...
void crypto_kem_dec::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 32 : 
            ...
            break;
        case 64 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read()) && esl_seteq<1,1,1>(exitcond_fu_230_p2.read(), ap_const_lv1_1))) {
        ...
        case 256 : 
            ...
            break;
        case 512 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && esl_seteq<1,1,1>(exitcond_i_fu_271_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
