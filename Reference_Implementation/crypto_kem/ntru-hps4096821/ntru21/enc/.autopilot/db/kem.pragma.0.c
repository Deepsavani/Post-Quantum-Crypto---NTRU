...
{_ssdm_SpecArrayDimSize(pk, 1230);_ssdm_SpecArrayDimSize(sk, 1590);
...
{_ssdm_SpecArrayDimSize(c, 1230);_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(pk, 1230);
...
{_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(c, 1230);_ssdm_SpecArrayDimSize(sk, 1590);
  int i, fail;
  unsigned char rm[(2*(((821 -1)+4)/5))];
