...
set C_modelArgList {
	...
	{ rm int 8 regular {array 328 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "7", "10"],
		...
		"Port" : [
			...
			{"Name" : "rm", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_poly_S3_frombytes_fu_250", "Port" : "msg"}]},
			{"Name" : "pk", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_poly_Rq_sum_zero_fro_fu_268", "Port" : "a"}]}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_250", "Parent" : "0", "Child" : ["5", "6"],
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_250.grp_mod3_fu_153", "Parent" : "4",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_S3_frombytes_fu_250.grp_mod3_fu_158", "Parent" : "4",
		"CDFG" : "mod3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_mul_fu_261", "Parent" : "0", "Child" : ["8", "9"],
		"CDFG" : "poly_Rq_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_mul_fu_261.crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52", "Parent" : "7"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_mul_fu_261.crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U53", "Parent" : "7"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_poly_Rq_sum_zero_fro_fu_268", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "17412", "Max" : "4056732"}
	, {"Name" : "Interval", "Min" : "17412", "Max" : "4056732"}
]}
