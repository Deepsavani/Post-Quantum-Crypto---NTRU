// ==============================================================
// File generated on Tue Aug 25 19:07:55 EDT 2020
...
`define AUTOTB_TVIN_c  "./c.crypto_kem_enc.autotvin_c.dat"
`define AUTOTB_TVIN_k  "./c.crypto_kem_enc.autotvin_k.dat"
`define AUTOTB_TVIN_pk  "./c.crypto_kem_enc.autotvin_pk.dat"
`define AUTOTB_TVIN_DRBG_ctx_V  "./c.crypto_kem_enc.autotvin_DRBG_ctx_V.dat"
`define AUTOTB_TVIN_DRBG_ctx_Key  "./c.crypto_kem_enc.autotvin_DRBG_ctx_Key.dat"
`define AUTOTB_TVIN_DRBG_ctx_reseed_counter  "./c.crypto_kem_enc.autotvin_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.crypto_kem_enc.autotvin_c.dat"
`define AUTOTB_TVIN_k_out_wrapc  "./rtl.crypto_kem_enc.autotvin_k.dat"
`define AUTOTB_TVIN_pk_out_wrapc  "./rtl.crypto_kem_enc.autotvin_pk.dat"
`define AUTOTB_TVIN_DRBG_ctx_V_out_wrapc  "./rtl.crypto_kem_enc.autotvin_DRBG_ctx_V.dat"
`define AUTOTB_TVIN_DRBG_ctx_Key_out_wrapc  "./rtl.crypto_kem_enc.autotvin_DRBG_ctx_Key.dat"
`define AUTOTB_TVIN_DRBG_ctx_reseed_counter_out_wrapc  "./rtl.crypto_kem_enc.autotvin_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVOUT_c  "./c.crypto_kem_enc.autotvout_c.dat"
`define AUTOTB_TVOUT_k  "./c.crypto_kem_enc.autotvout_k.dat"
`define AUTOTB_TVOUT_DRBG_ctx_V  "./c.crypto_kem_enc.autotvout_DRBG_ctx_V.dat"
`define AUTOTB_TVOUT_DRBG_ctx_Key  "./c.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat"
`define AUTOTB_TVOUT_DRBG_ctx_reseed_counter  "./c.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVOUT_ap_return  "./c.crypto_kem_enc.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_c_out_wrapc  "./impl_rtl.crypto_kem_enc.autotvout_c.dat"
`define AUTOTB_TVOUT_k_out_wrapc  "./impl_rtl.crypto_kem_enc.autotvout_k.dat"
`define AUTOTB_TVOUT_DRBG_ctx_V_out_wrapc  "./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_V.dat"
`define AUTOTB_TVOUT_DRBG_ctx_Key_out_wrapc  "./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat"
`define AUTOTB_TVOUT_DRBG_ctx_reseed_counter_out_wrapc  "./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.crypto_kem_enc.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_c = 1230;
parameter LENGTH_k = 32;
parameter LENGTH_pk = 1230;
...
wire    [10 : 0]    arrayc_address0, arrayc_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.crypto_kem_enc.autotvout_c.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_enc.autotvout_c.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_enc.autotvout_c.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_enc.autotvout_c.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_enc.autotvout_c.dat with impl_rtl.crypto_kem_enc.autotvout_c.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_kem_enc.autotvout_k.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_enc.autotvout_k.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_enc.autotvout_k.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_enc.autotvout_k.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_enc.autotvout_k.dat with impl_rtl.crypto_kem_enc.autotvout_k.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_kem_enc.autotvout_DRBG_ctx_V.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_enc.autotvout_DRBG_ctx_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_V.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_enc.autotvout_DRBG_ctx_V.dat with impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat with impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_Key.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat with impl_rtl.crypto_kem_enc.autotvout_DRBG_ctx_reseed_counter.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_kem_enc.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_kem_enc.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_kem_enc.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_kem_enc.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.crypto_kem_enc.autotvout_ap_return.dat with impl_rtl.crypto_kem_enc.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
