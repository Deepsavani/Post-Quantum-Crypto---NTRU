...
wire   [9:0] tmp_5_fu_475_p3;
reg   [9:0] tmp_5_reg_849;
wire    ap_CS_fsm_state4;
reg   [1:0] tmp_2_reg_856;
reg   [3:0] tmp_9_reg_881;
wire    ap_CS_fsm_state6;
reg   [5:0] tmp_12_reg_906;
...
wire   [63:0] tmp_21_fu_790_p1;
reg   [63:0] tmp_21_reg_960;
...
wire   [63:0] tmp_11_fu_643_p1;
wire   [63:0] sum12_cast_fu_663_p1;
wire   [63:0] sum13_cast_fu_673_p1;
wire   [63:0] sum14_cast_fu_683_p1;
wire   [63:0] tmp_16_fu_725_p1;
wire   [63:0] tmp_17_fu_742_p1;
wire   [63:0] tmp_19_fu_760_p1;
wire   [31:0] tmp_4_fu_460_p6;
wire   [31:0] tmp_3_fu_542_p7;
wire   [31:0] tmp_s_fu_622_p7;
wire   [31:0] tmp_14_fu_713_p2;
wire   [31:0] tmp_18_fu_747_p2;
wire   [31:0] tmp_20_fu_771_p2;
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_754_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state13))) begin
        ...
        s_addr_5_reg_942[8 : 0] <= tmp_19_fu_760_p1[8 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_730_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state11))) begin
        s_addr_4_reg_934[7 : 0] <= tmp_17_fu_742_p1[7 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        tmp_12_reg_906 <= {{u_q1[7:2]}};
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_778_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state16))) begin
        tmp_21_reg_960[9 : 0] <= tmp_21_fu_790_p1[9 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        tmp_5_reg_849[9 : 2] <= tmp_5_fu_475_p3[9 : 2];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state17)) begin
        r_coeffs_address0 = tmp_21_reg_960;
...
assign tmp_10_fu_456_p1 = u_q1[5:0];

assign tmp_11_fu_643_p1 = tmp_1_fu_638_p2;

assign tmp_13_fu_688_p4 = {{{reg_372}, {tmp_12_reg_906}}, {2'd0}};

assign tmp_14_fu_713_p2 = (tmp9_fu_701_p5 + tmp_73_cast_fu_697_p1);

assign tmp_15_fu_720_p2 = (tmp_5_reg_849 | 10'd3);

assign tmp_16_fu_725_p1 = tmp_15_fu_720_p2;

assign tmp_17_fu_742_p1 = i_1_reg_334;

assign tmp_18_fu_747_p2 = (s_q0 | 32'd1);

assign tmp_19_fu_760_p1 = i_2_reg_345;

assign tmp_1_fu_638_p2 = (tmp_5_reg_849 | 10'd2);

assign tmp_20_fu_771_p2 = (s_q0 | 32'd2);

assign tmp_21_fu_790_p1 = i_3_reg_356;

assign tmp_24_fu_538_p1 = u_q1[3:0];

assign tmp_25_fu_618_p1 = u_q1[1:0];

assign tmp_26_fu_795_p1 = s_q0[1:0];

assign tmp_3_fu_542_p7 = {{{{{{tmp_24_fu_538_p1}, {u_q0}}, {reg_376}}, {reg_372}}, {tmp_2_reg_856}}, {2'd0}};

assign tmp_4_fu_460_p6 = {{{{{tmp_10_fu_456_p1}, {u_q0}}, {reg_376}}, {reg_372}}, {2'd0}};

assign tmp_5_fu_475_p3 = {{i_reg_322}, {2'd0}};

assign tmp_6_fu_483_p1 = tmp_5_fu_475_p3;

assign tmp_73_cast_fu_697_p1 = tmp_13_fu_688_p4;

assign tmp_7_fu_558_p2 = (tmp_5_reg_849 | 10'd1);

assign tmp_8_fu_563_p1 = tmp_7_fu_558_p2;

assign tmp_92_cast_fu_799_p1 = tmp_26_fu_795_p1;

assign tmp_fu_408_p2 = (p_shl_cast_fu_404_p1 - i_cast1_fu_380_p1);

assign tmp_s_fu_622_p7 = {{{{{{tmp_25_fu_618_p1}, {u_q0}}, {reg_376}}, {reg_372}}, {tmp_9_reg_881}}, {2'd0}};

always @ (posedge ap_clk) begin
    tmp_5_reg_849[1:0] <= 2'b00;
    s_addr_4_reg_934[9:8] <= 2'b00;
    s_addr_5_reg_942[9] <= 1'b0;
    tmp_21_reg_960[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end
