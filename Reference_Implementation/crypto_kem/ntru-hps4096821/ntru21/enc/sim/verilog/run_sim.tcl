...
if {[file isfile crypto_kem_enc.autotvin.dat]} {
	file delete -force crypto_kem_enc.autotvin.dat
}

if {[file isfile crypto_kem_enc.autotvout.dat]} {
	file delete -force crypto_kem_enc.autotvout.dat
}
