...
char pk[1230])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *c_pc_buffer = new sc_bv<8>[1230];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: c
				{
					...
					// {
						// celement: c(7, 0)
						// {
							sc_lv<8>* c_lv0_0_1229_1 = new sc_lv<8>[1230];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: c(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 1229; i_0 += 1)
							{
								...
								{
									c_lv0_0_1229_1[hls_map_index].range(7, 0) = sc_bv<8>(c_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: c(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 1229; i_0 += 1)
							{
								...
								// output_type_conversion : (c_lv0_0_1229_1[hls_map_index]).to_uint64()
								if (&(c[0]) != NULL) // check the null address if the c port is array or others
								{
									c[i_0] = (c_lv0_0_1229_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<8>* c_tvin_wrapc_buffer = new sc_bv<8>[1230];
		...
		tcl_file.set_num(1230, &tcl_file.c_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<8>* c_tvout_wrapc_buffer = new sc_bv<8>[1230];
