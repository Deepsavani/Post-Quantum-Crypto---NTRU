...
set C_modelArgMapList {[ 
	{ "Name" : "x", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "DRBG_ctx_reseed_coun", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "DRBG_ctx.reseed_counter","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ DRBG_ctx_reseed_coun_i sc_in sc_lv 32 signal 3 } 
	{ DRBG_ctx_reseed_coun_o sc_out sc_lv 32 signal 3 } 
	{ DRBG_ctx_reseed_coun_o_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "DRBG_ctx_reseed_coun_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "DRBG_ctx_reseed_coun", "role": "i" }} , 
 	{ "name": "DRBG_ctx_reseed_coun_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "DRBG_ctx_reseed_coun", "role": "o" }} , 
 	{ "name": "DRBG_ctx_reseed_coun_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "DRBG_ctx_reseed_coun", "role": "o_ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	DRBG_ctx_reseed_coun { ap_ovld {  { DRBG_ctx_reseed_coun_i in_data 0 32 }  { DRBG_ctx_reseed_coun_o out_data 1 32 }  { DRBG_ctx_reseed_coun_o_ap_vld out_vld 1 1 } } }
}
