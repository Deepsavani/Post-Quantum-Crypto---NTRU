#pragma line 1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c"
#pragma line 1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c" 1
#pragma line 1 "<built-in>" 1
#pragma line 1 "<built-in>" 3
#pragma line 149 "<built-in>" 3
#pragma line 1 "<command line>" 1
#pragma line 1 "<built-in>" 2
#pragma line 1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c" 2
#pragma line 1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.h" 1
#pragma empty_line
#pragma empty_line
#pragma empty_line
...
#pragma line 5 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.h" 2
#pragma line 1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/params.h" 1
#pragma line 6 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.h" 2
#pragma empty_line
#pragma empty_line
...
#pragma line 2 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c" 2
#pragma line 1 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/fips202.h" 1
#pragma line 11 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/fips202.h"
...
#pragma line 3 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c" 2
...
#pragma line 5 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/verify.h" 2
#pragma empty_line
#pragma empty_line
...
#pragma line 4 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c" 2
#pragma empty_line
uint16_t mod3(uint16_t a)
{
  uint16_t r;
...
void poly_Z3_to_Zq(poly *r)
{
  int i;
  for(i=0; i<821; i++)
    r->coeffs[i] = r->coeffs[i] | ((-(r->coeffs[i]>>1)) & ((1 << 12)-1));
}
#pragma empty_line
#pragma empty_line
void poly_trinary_Zq_to_Z3(poly *r)
{
  int i;
  for(i=0; i<821; i++)
    r->coeffs[i] = 3 & (r->coeffs[i] ^ (r->coeffs[i]>>(12 -1)));
}
#pragma empty_line
void poly_Rq_mul(poly *r, const poly *a, const poly *b)
{
...
#pragma empty_line
  for(k=0; k<821; k++)
  {
    r->coeffs[k] = 0;
    for(i=1; i<821 -k; i++)
      r->coeffs[k] += a->coeffs[k+i] * b->coeffs[821 -i];
    for(i=0; i<k+1; i++)
      r->coeffs[k] += a->coeffs[k-i] * b->coeffs[i];
    r->coeffs[k] = ((r->coeffs[k]) & ((1 << 12)-1));
  }
}
#pragma empty_line
void poly_Sq_mul(poly *r, const poly *a, const poly *b)
{
  ...
  poly_Rq_mul(r, a, b);
  for(i=0; i<821; i++)
    r->coeffs[i] = ((r->coeffs[i] - r->coeffs[821 -1]) & ((1 << 12)-1));
}
#pragma empty_line
void poly_S3_mul(poly *r, const poly *a, const poly *b)
{
...
#pragma empty_line
  ...
  for(k=0; k<821; k++)
    r->coeffs[k] = mod3(r->coeffs[k] + 2*r->coeffs[821 -1]);
}
#pragma empty_line
void poly_Rq_mul_x_minus_1(poly *r, const poly *a)
{
  int i;
  uint16_t last_coeff = a->coeffs[821 -1];
#pragma empty_line
  for (i = 821 - 1; i > 0; i--) {
    r->coeffs[i] = ((a->coeffs[i-1] + ((1 << 12) - a->coeffs[i])) & ((1 << 12)-1));
  }
  r->coeffs[0] = ((last_coeff + ((1 << 12) - a->coeffs[0])) & ((1 << 12)-1));
}
#pragma empty_line
#pragma empty_line
void poly_lift(poly *r, const poly *a)
...
#pragma line 150 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c"
void poly_Rq_to_S3(poly *r, const poly *a)
{
#pragma empty_line
#pragma empty_line
...
#pragma empty_line
  for(i=0; i<821; i++)
  {
    r->coeffs[i] = ((a->coeffs[i] >> (12 -1)) ^ 3) << 12;
    r->coeffs[i] += a->coeffs[i];
  }
#pragma empty_line
  r->coeffs[821 -1] = mod3(r->coeffs[821 -1]);
  for(i=0; i<821; i++)
    r->coeffs[i] = mod3(r->coeffs[i] + 2*r->coeffs[821 -1]);
}
#pragma line 176 "/home/dss545/KEM/NTRU/Reference_Implementation/crypto_kem/ntru-hps4096821/poly.c"
...
#pragma empty_line
  ...
  a->coeffs[821 -1] = (!s * a->coeffs[821 -1]);
}
#pragma empty_line
...
#pragma empty_line
  for(i=1; i<821; i++)
    a->coeffs[821 -i] = (s * a->coeffs[821 -i-1]) | (!s * a->coeffs[821 -i]);
...
#pragma empty_line
    ...
    degg ^= t;
#pragma empty_line
    for(i=0; i<821; i++) { f.coeffs[i] ^= g.coeffs[i] * sign*(!done); };
    for(i=0; i<821; i++) { b.coeffs[i] ^= (*c).coeffs[i] * sign*(!done); };
#pragma empty_line
    poly_divx(&f, !done);
    poly_mulx(c, !done);
    degf -= !done;
...
#pragma empty_line
  for (i = 0; i < 10; i++) {
    for (j = 0; j < 821; j++) {
      temp_r->coeffs[j] = r->coeffs[(j + (1 << i)) % 821];
    }
    cmov((unsigned char *)&(r->coeffs),
         (unsigned char *)&(temp_r->coeffs), sizeof(uint16_t) * 821, k & 1);
    k >>= 1;
  }
}
#pragma empty_line
...
#pragma empty_line
  for(i=0; i<821; i++)
    b.coeffs[i] = (((1 << 12) - a->coeffs[i]) & ((1 << 12)-1));
#pragma empty_line
  for(i=0; i<821; i++)
...
#pragma empty_line
    ...
    degg ^= t;
#pragma empty_line
    for(i=0; i<821; i++) { f.coeffs[i] = mod3(f.coeffs[i] + sign*(!done) * g.coeffs[i]); };
    for(i=0; i<821; i++) { b.coeffs[i] = mod3(b.coeffs[i] + sign*(!done) * c.coeffs[i]); };
#pragma empty_line
    poly_divx(&f, !done);
    poly_mulx(&c, !done);
    degf -= !done;
