...
crypto_kem_keypair::crypto_kem_keypair(sc_module_name name) : sc_module(name), mVcdFile(0) {
    DRBG_ctx_V_U = new crypto_kem_keypair_DRBG_ctx_V("DRBG_ctx_V_U");
    DRBG_ctx_V_U->clk(ap_clk);
    DRBG_ctx_V_U->reset(ap_rst);
    DRBG_ctx_V_U->address0(DRBG_ctx_V_address0);
    DRBG_ctx_V_U->ce0(DRBG_ctx_V_ce0);
    DRBG_ctx_V_U->we0(DRBG_ctx_V_we0);
    DRBG_ctx_V_U->d0(DRBG_ctx_V_d0);
    DRBG_ctx_V_U->q0(DRBG_ctx_V_q0);
    DRBG_ctx_V_U->address1(DRBG_ctx_V_address1);
    DRBG_ctx_V_U->ce1(DRBG_ctx_V_ce1);
    DRBG_ctx_V_U->q1(DRBG_ctx_V_q1);
    DRBG_ctx_Key_U = new crypto_kem_keypair_DRBG_ctx_Key("DRBG_ctx_Key_U");
    DRBG_ctx_Key_U->clk(ap_clk);
    DRBG_ctx_Key_U->reset(ap_rst);
    DRBG_ctx_Key_U->address0(DRBG_ctx_Key_address0);
    DRBG_ctx_Key_U->ce0(DRBG_ctx_Key_ce0);
    DRBG_ctx_Key_U->we0(DRBG_ctx_Key_we0);
    DRBG_ctx_Key_U->d0(DRBG_ctx_Key_d0);
    DRBG_ctx_Key_U->q0(DRBG_ctx_Key_q0);
    DRBG_ctx_Key_U->address1(DRBG_ctx_Key_address1);
    DRBG_ctx_Key_U->ce1(DRBG_ctx_Key_ce1);
    DRBG_ctx_Key_U->q1(DRBG_ctx_Key_q1);
    ...
    seed_U->q0(seed_q0);
    seed_U->address1(grp_owcpa_keypair_fu_34_seed_address1);
    seed_U->ce1(seed_ce1);
    seed_U->q1(seed_q1);
    ...
    grp_owcpa_keypair_fu_34->seed_address1(grp_owcpa_keypair_fu_34_seed_address1);
    grp_owcpa_keypair_fu_34->seed_ce1(grp_owcpa_keypair_fu_34_seed_ce1);
    grp_owcpa_keypair_fu_34->seed_q1(seed_q1);
    ...
    grp_randombytes_fu_43->DRBG_ctx_reseed_coun_i(DRBG_ctx_reseed_coun);
    grp_randombytes_fu_43->DRBG_ctx_reseed_coun_o(grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o);
    grp_randombytes_fu_43->DRBG_ctx_reseed_coun_o_ap_vld(grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o_ap_vld);
    ...
    grp_randombytes_1_fu_59->DRBG_ctx_reseed_coun_i(DRBG_ctx_reseed_coun);
    grp_randombytes_1_fu_59->DRBG_ctx_reseed_coun_o(grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o);
    grp_randombytes_1_fu_59->DRBG_ctx_reseed_coun_o_ap_vld(grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o_ap_vld);
    ...
    sensitive << ( grp_owcpa_keypair_fu_34_seed_ce1 );
    sensitive << ( ap_CS_fsm_state4 );
    ...
    ap_CS_fsm = "000001";
    DRBG_ctx_reseed_coun = "00000000000000000000000000000000";
    ...
    sc_trace(mVcdFile, DRBG_ctx_V_address0, "DRBG_ctx_V_address0");
    sc_trace(mVcdFile, DRBG_ctx_V_ce0, "DRBG_ctx_V_ce0");
    sc_trace(mVcdFile, DRBG_ctx_V_we0, "DRBG_ctx_V_we0");
    sc_trace(mVcdFile, DRBG_ctx_V_d0, "DRBG_ctx_V_d0");
    sc_trace(mVcdFile, DRBG_ctx_V_q0, "DRBG_ctx_V_q0");
    sc_trace(mVcdFile, DRBG_ctx_V_address1, "DRBG_ctx_V_address1");
    sc_trace(mVcdFile, DRBG_ctx_V_ce1, "DRBG_ctx_V_ce1");
    sc_trace(mVcdFile, DRBG_ctx_V_q1, "DRBG_ctx_V_q1");
    sc_trace(mVcdFile, DRBG_ctx_Key_address0, "DRBG_ctx_Key_address0");
    sc_trace(mVcdFile, DRBG_ctx_Key_ce0, "DRBG_ctx_Key_ce0");
    sc_trace(mVcdFile, DRBG_ctx_Key_we0, "DRBG_ctx_Key_we0");
    sc_trace(mVcdFile, DRBG_ctx_Key_d0, "DRBG_ctx_Key_d0");
    sc_trace(mVcdFile, DRBG_ctx_Key_q0, "DRBG_ctx_Key_q0");
    sc_trace(mVcdFile, DRBG_ctx_Key_address1, "DRBG_ctx_Key_address1");
    sc_trace(mVcdFile, DRBG_ctx_Key_ce1, "DRBG_ctx_Key_ce1");
    sc_trace(mVcdFile, DRBG_ctx_Key_q1, "DRBG_ctx_Key_q1");
    sc_trace(mVcdFile, DRBG_ctx_reseed_coun, "DRBG_ctx_reseed_coun");
    ...
    sc_trace(mVcdFile, seed_ce1, "seed_ce1");
    sc_trace(mVcdFile, seed_q1, "seed_q1");
    ...
    sc_trace(mVcdFile, grp_owcpa_keypair_fu_34_seed_address1, "grp_owcpa_keypair_fu_34_seed_address1");
    sc_trace(mVcdFile, grp_owcpa_keypair_fu_34_seed_ce1, "grp_owcpa_keypair_fu_34_seed_ce1");
    ...
    sc_trace(mVcdFile, grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o, "grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o");
    sc_trace(mVcdFile, grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o_ap_vld, "grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o_ap_vld");
    ...
    sc_trace(mVcdFile, grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o, "grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o");
    sc_trace(mVcdFile, grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o_ap_vld, "grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o_ap_vld");
...
void crypto_kem_keypair::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o_ap_vld.read()))) {
        DRBG_ctx_reseed_coun = grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o_ap_vld.read()))) {
        DRBG_ctx_reseed_coun = grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o.read();
    }
...
void crypto_kem_keypair::thread_seed_ce1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        seed_ce1 = grp_owcpa_keypair_fu_34_seed_ce1.read();
    } else {
