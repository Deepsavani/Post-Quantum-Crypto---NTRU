...
architecture behav of crypto_kem_keypair is 
    ...
    "crypto_kem_keypair,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=44,HLS_SYN_DSP=8,HLS_SYN_FF=5441,HLS_SYN_LUT=22024,HLS_VERSION=2018_3}";
    ...
    signal DRBG_ctx_V_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal DRBG_ctx_V_ce0 : STD_LOGIC;
    signal DRBG_ctx_V_we0 : STD_LOGIC;
    signal DRBG_ctx_V_d0 : STD_LOGIC_VECTOR (7 downto 0);
    signal DRBG_ctx_V_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal DRBG_ctx_V_address1 : STD_LOGIC_VECTOR (3 downto 0);
    signal DRBG_ctx_V_ce1 : STD_LOGIC;
    signal DRBG_ctx_V_q1 : STD_LOGIC_VECTOR (7 downto 0);
    signal DRBG_ctx_Key_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal DRBG_ctx_Key_ce0 : STD_LOGIC;
    signal DRBG_ctx_Key_we0 : STD_LOGIC;
    signal DRBG_ctx_Key_d0 : STD_LOGIC_VECTOR (7 downto 0);
    signal DRBG_ctx_Key_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal DRBG_ctx_Key_address1 : STD_LOGIC_VECTOR (4 downto 0);
    signal DRBG_ctx_Key_ce1 : STD_LOGIC;
    signal DRBG_ctx_Key_q1 : STD_LOGIC_VECTOR (7 downto 0);
    signal DRBG_ctx_reseed_coun : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal seed_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal seed_ce0 : STD_LOGIC;
    signal seed_we0 : STD_LOGIC;
    signal seed_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal seed_ce1 : STD_LOGIC;
    signal seed_q1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_owcpa_keypair_fu_34_seed_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_owcpa_keypair_fu_34_seed_ce0 : STD_LOGIC;
    signal grp_owcpa_keypair_fu_34_seed_address1 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_owcpa_keypair_fu_34_seed_ce1 : STD_LOGIC;
    ...
    signal grp_randombytes_fu_43_x_address0 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o_ap_vld : STD_LOGIC;
    ...
    signal grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o_ap_vld : STD_LOGIC;
    ...
    component crypto_kem_keypair_DRBG_ctx_V IS
    generic (
        DataWidth : INTEGER;
    ...
    component crypto_kem_keypair_DRBG_ctx_Key IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    DRBG_ctx_V_U : component crypto_kem_keypair_DRBG_ctx_V
    generic map (
        DataWidth => 8,
        AddressRange => 16,
        AddressWidth => 4)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => DRBG_ctx_V_address0,
        ce0 => DRBG_ctx_V_ce0,
        we0 => DRBG_ctx_V_we0,
        d0 => DRBG_ctx_V_d0,
        q0 => DRBG_ctx_V_q0,
        address1 => DRBG_ctx_V_address1,
        ce1 => DRBG_ctx_V_ce1,
        q1 => DRBG_ctx_V_q1);

    DRBG_ctx_Key_U : component crypto_kem_keypair_DRBG_ctx_Key
    generic map (
        DataWidth => 8,
        AddressRange => 32,
        AddressWidth => 5)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => DRBG_ctx_Key_address0,
        ce0 => DRBG_ctx_Key_ce0,
        we0 => DRBG_ctx_Key_we0,
        d0 => DRBG_ctx_Key_d0,
        q0 => DRBG_ctx_Key_q0,
        address1 => DRBG_ctx_Key_address1,
        ce1 => DRBG_ctx_Key_ce1,
        q1 => DRBG_ctx_Key_q1);
    ...
    port map (
        ...
        DRBG_ctx_reseed_coun_i => DRBG_ctx_reseed_coun,
        DRBG_ctx_reseed_coun_o => grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o,
        DRBG_ctx_reseed_coun_o_ap_vld => grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o_ap_vld);
    ...
    port map (
        ...
        DRBG_ctx_Key_q1 => DRBG_ctx_Key_q1,
        DRBG_ctx_reseed_coun_i => DRBG_ctx_reseed_coun,
        DRBG_ctx_reseed_coun_o => grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o,
        DRBG_ctx_reseed_coun_o_ap_vld => grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o_ap_vld);
    ...
    DRBG_ctx_reseed_coun_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state6) and (grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o_ap_vld = ap_const_logic_1))) then 
                DRBG_ctx_reseed_coun <= grp_randombytes_1_fu_59_DRBG_ctx_reseed_coun_o;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o_ap_vld = ap_const_logic_1))) then 
                DRBG_ctx_reseed_coun <= grp_randombytes_fu_43_DRBG_ctx_reseed_coun_o;
            end if; 
        end if;
    end process;
    ...
    seed_ce1_assign_proc : process(grp_owcpa_keypair_fu_34_seed_ce1, ap_CS_fsm_state4)
    begin
