...
set C_modelArgList {
	{ msg int 8 regular {array 280 { 0 3 } 0 1 }  }
...
set Spec2ImplPortList { 
	msg { ap_memory {  { msg_address0 mem_address 1 9 }  { msg_ce0 mem_ce 1 1 }  { msg_we0 mem_we 1 1 }  { msg_d0 mem_din 1 8 } } }
