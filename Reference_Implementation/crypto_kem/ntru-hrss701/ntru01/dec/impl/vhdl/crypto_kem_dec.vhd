...
architecture behav of crypto_kem_dec is 
    ...
    "crypto_kem_dec,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200tfbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.122000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=27,HLS_SYN_DSP=9,HLS_SYN_FF=14813,HLS_SYN_LUT=77752,HLS_VERSION=2018_3}";
    ...
    constant ap_const_lv11_58A : STD_LOGIC_VECTOR (10 downto 0) := "10110001010";
    ...
    signal fail_reg_297 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal grp_owcpa_dec_fu_184_ap_ready : STD_LOGIC;
    signal grp_owcpa_dec_fu_184_ap_done : STD_LOGIC;
    signal i_33_fu_204_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_33_reg_305 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal exitcond1_fu_198_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_34_fu_232_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_34_reg_318 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal exitcond_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal b_assign_1_fu_254_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal b_assign_1_reg_328 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal grp_sha3_256_fu_167_ap_ready : STD_LOGIC;
    signal grp_sha3_256_fu_167_ap_done : STD_LOGIC;
    signal i_35_fu_273_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_35_reg_336 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state10 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state10 : signal is "none";
    signal exitcond_i_fu_267_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal k_addr_reg_346 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal grp_sha3_256_fu_167_output_r_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_sha3_256_fu_167_input_r_address0 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal grp_sha3_256_1_fu_175_input_r_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_owcpa_dec_fu_184_rm_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_owcpa_dec_fu_184_ciphertext_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_owcpa_dec_fu_184_ciphertext_ce0 : STD_LOGIC;
    signal grp_owcpa_dec_fu_184_ciphertext_address1 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_owcpa_dec_fu_184_ciphertext_ce1 : STD_LOGIC;
    signal grp_owcpa_dec_fu_184_secretkey_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_owcpa_dec_fu_184_secretkey_ce0 : STD_LOGIC;
    signal grp_owcpa_dec_fu_184_secretkey_address1 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_258_fu_221_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_259_fu_238_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal cmp_0_sum_cast_fu_249_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_i_cast1_fu_261_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_290_i_fu_290_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_cast4_fu_194_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_fu_210_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal cmp_0_sum_fu_243_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_i_fu_279_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_i_63_fu_285_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((exitcond_fu_226_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state9) and (grp_sha3_256_fu_167_ap_done = ap_const_logic_1))) then
                b_assign_1_reg_328 <= b_assign_1_fu_254_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_owcpa_dec_fu_184_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                fail_reg_297 <= grp_owcpa_dec_fu_184_ap_return;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_267_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state10))) then
                k_addr_reg_346 <= i_i_cast1_fu_261_p1(5 - 1 downto 0);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, grp_owcpa_dec_fu_184_ap_done, ap_CS_fsm_state5, exitcond1_fu_198_p2, ap_CS_fsm_state7, exitcond_fu_226_p2, ap_CS_fsm_state9, grp_sha3_256_fu_167_ap_done, ap_CS_fsm_state10, exitcond_i_fu_267_p2, grp_sha3_256_1_fu_175_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state10 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state10) and (exitcond_i_fu_267_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state10, exitcond_i_fu_267_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state10) and (exitcond_i_fu_267_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state10, exitcond_i_fu_267_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state10) and (exitcond_i_fu_267_p2 = ap_const_lv1_1))) then 
    ...
    b_assign_1_fu_254_p3 <= 
        ap_const_lv8_FF when (fail_reg_297(0) = '1') else 
        ap_const_lv8_0;

    buf_address0_assign_proc : process(ap_CS_fsm_state9, grp_sha3_256_fu_167_input_r_address0, ap_CS_fsm_state6, ap_CS_fsm_state8, tmp_258_fu_221_p1, cmp_0_sum_cast_fu_249_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            buf_address0 <= cmp_0_sum_cast_fu_249_p1(11 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            buf_address0 <= tmp_258_fu_221_p1(11 - 1 downto 0);
    ...
    c_address0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state7, grp_owcpa_dec_fu_184_ciphertext_address0, tmp_259_fu_238_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            c_address0 <= tmp_259_fu_238_p1(11 - 1 downto 0);
    ...
    cmp_0_sum_cast_fu_249_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(cmp_0_sum_fu_243_p2),64));
    cmp_0_sum_fu_243_p2 <= std_logic_vector(unsigned(i_1_reg_144) + unsigned(ap_const_lv11_20));
    exitcond1_fu_198_p2 <= "1" when (i_reg_132 = ap_const_lv6_20) else "0";
    exitcond_fu_226_p2 <= "1" when (i_1_reg_144 = ap_const_lv11_472) else "0";
    exitcond_i_fu_267_p2 <= "1" when (i_i_reg_156 = ap_const_lv6_20) else "0";
    ...
    i_33_fu_204_p2 <= std_logic_vector(unsigned(i_reg_132) + unsigned(ap_const_lv6_1));
    i_34_fu_232_p2 <= std_logic_vector(unsigned(i_1_reg_144) + unsigned(ap_const_lv11_1));
    i_35_fu_273_p2 <= std_logic_vector(unsigned(i_i_reg_156) + unsigned(ap_const_lv6_1));
    i_cast4_fu_194_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_132),11));
    i_i_cast1_fu_261_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_reg_156),64));

    k_address0_assign_proc : process(ap_CS_fsm_state10, k_addr_reg_346, grp_sha3_256_1_fu_175_output_r_address0, ap_CS_fsm_state4, ap_CS_fsm_state11, i_i_cast1_fu_261_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            k_address0 <= k_addr_reg_346;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            k_address0 <= i_i_cast1_fu_261_p1(5 - 1 downto 0);
    ...
    k_d0_assign_proc : process(grp_sha3_256_1_fu_175_output_r_d0, ap_CS_fsm_state4, ap_CS_fsm_state11, tmp_290_i_fu_290_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            k_d0 <= tmp_290_i_fu_290_p2;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    rm_address0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state9, ap_CS_fsm_state10, grp_sha3_256_fu_167_output_r_address0, grp_sha3_256_1_fu_175_input_r_address0, grp_owcpa_dec_fu_184_rm_address0, ap_CS_fsm_state4, i_i_cast1_fu_261_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            rm_address0 <= i_i_cast1_fu_261_p1(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            rm_address0 <= grp_owcpa_dec_fu_184_rm_address0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    sk_address0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state5, grp_owcpa_dec_fu_184_secretkey_address0, tmp_s_fu_216_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            sk_address0 <= tmp_s_fu_216_p1(11 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    tmp_258_fu_221_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_132),64));
    tmp_259_fu_238_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_144),64));
    tmp_290_i_fu_290_p2 <= (tmp_i_63_fu_285_p2 xor k_q0);
    tmp_fu_210_p2 <= std_logic_vector(unsigned(i_cast4_fu_194_p1) + unsigned(ap_const_lv11_58A));
    tmp_i_63_fu_285_p2 <= (tmp_i_fu_279_p2 and b_assign_1_reg_328);
    tmp_i_fu_279_p2 <= (rm_q0 xor k_q0);
    tmp_s_fu_216_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_210_p2),64));
end behav;
