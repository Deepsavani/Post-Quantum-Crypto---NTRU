...
if {[file isfile crypto_kem_dec.autotvin.dat]} {
	file delete -force crypto_kem_dec.autotvin.dat
}

if {[file isfile crypto_kem_dec.autotvout.dat]} {
	file delete -force crypto_kem_dec.autotvout.dat
}
