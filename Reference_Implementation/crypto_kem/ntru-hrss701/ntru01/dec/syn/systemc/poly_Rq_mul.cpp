...
poly_Rq_mul::poly_Rq_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_231_fu_180_p1 );
    sensitive << ( tmp_237_fu_223_p1 );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( tmp_233_fu_191_p1 );
    sensitive << ( tmp_238_fu_228_p1 );
    ...
    SC_METHOD(thread_i_15_fu_196_p2);
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_i_16_fu_212_p2);
    sensitive << ( i_1_reg_116 );
    ...
    sensitive << ( tmp_237_cast_fu_243_p1 );
    ...
    SC_METHOD(thread_tmp_229_fu_170_p2);
    sensitive << ( tmp_s_reg_285 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_230_fu_175_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_cast_fu_166_p1 );

    SC_METHOD(thread_tmp_231_fu_180_p1);
    sensitive << ( tmp_230_fu_175_p2 );

    SC_METHOD(thread_tmp_232_fu_185_p2);
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_233_fu_191_p1);
    sensitive << ( tmp_232_fu_185_p2 );

    SC_METHOD(thread_tmp_236_fu_218_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_1_cast_fu_202_p1 );

    SC_METHOD(thread_tmp_237_cast_fu_243_p1);
    sensitive << ( tmp_250_fu_239_p1 );

    SC_METHOD(thread_tmp_237_fu_223_p1);
    sensitive << ( tmp_236_fu_218_p2 );

    SC_METHOD(thread_tmp_238_fu_228_p1);
    sensitive << ( i_1_reg_116 );

    SC_METHOD(thread_tmp_250_fu_239_p1);
    ...
    sc_trace(mVcdFile, tmp_229_fu_170_p2, "tmp_229_fu_170_p2");
    sc_trace(mVcdFile, i_15_fu_196_p2, "i_15_fu_196_p2");
    sc_trace(mVcdFile, i_15_reg_303, "i_15_reg_303");
    sc_trace(mVcdFile, i_16_fu_212_p2, "i_16_fu_212_p2");
    sc_trace(mVcdFile, i_16_reg_311, "i_16_reg_311");
    ...
    sc_trace(mVcdFile, tmp_231_fu_180_p1, "tmp_231_fu_180_p1");
    sc_trace(mVcdFile, tmp_233_fu_191_p1, "tmp_233_fu_191_p1");
    sc_trace(mVcdFile, tmp_237_fu_223_p1, "tmp_237_fu_223_p1");
    sc_trace(mVcdFile, tmp_238_fu_228_p1, "tmp_238_fu_228_p1");
    sc_trace(mVcdFile, grp_fu_248_p3, "grp_fu_248_p3");
    sc_trace(mVcdFile, grp_fu_257_p3, "grp_fu_257_p3");
    sc_trace(mVcdFile, tmp_237_cast_fu_243_p1, "tmp_237_cast_fu_243_p1");
    sc_trace(mVcdFile, i_cast_fu_166_p1, "i_cast_fu_166_p1");
    sc_trace(mVcdFile, tmp_230_fu_175_p2, "tmp_230_fu_175_p2");
    sc_trace(mVcdFile, tmp_232_fu_185_p2, "tmp_232_fu_185_p2");
    sc_trace(mVcdFile, i_1_cast_fu_202_p1, "i_1_cast_fu_202_p1");
    sc_trace(mVcdFile, tmp_236_fu_218_p2, "tmp_236_fu_218_p2");
    sc_trace(mVcdFile, tmp_250_fu_239_p1, "tmp_250_fu_239_p1");
...
void poly_Rq_mul::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_229_fu_170_p2.read()))) {
        i_1_reg_116 = ap_const_lv10_0;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        i_1_reg_116 = i_16_reg_311.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_reg_105 = i_15_reg_303.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_229_fu_170_p2.read(), ap_const_lv1_1))) {
        i_15_reg_303 = i_15_fu_196_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        i_16_reg_311 = i_16_fu_212_p2.read();
    }
...
void poly_Rq_mul::thread_a_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        a_coeffs_address0 =  (sc_lv<10>) (tmp_237_fu_223_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        a_coeffs_address0 =  (sc_lv<10>) (tmp_231_fu_180_p1.read());
    } else {
...
void poly_Rq_mul::thread_b_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        b_coeffs_address0 =  (sc_lv<10>) (tmp_238_fu_228_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        b_coeffs_address0 =  (sc_lv<10>) (tmp_233_fu_191_p1.read());
    } else {
...
void poly_Rq_mul::thread_i_15_fu_196_p2() {
    i_15_fu_196_p2 = (!i_reg_105.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(i_reg_105.read()) + sc_biguint<10>(ap_const_lv10_1));
}

void poly_Rq_mul::thread_i_16_fu_212_p2() {
    i_16_fu_212_p2 = (!i_1_reg_116.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(i_1_reg_116.read()) + sc_biguint<10>(ap_const_lv10_1));
}
...
void poly_Rq_mul::thread_r_coeffs_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        r_coeffs_d0 = tmp_237_cast_fu_243_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
...
void poly_Rq_mul::thread_tmp_229_fu_170_p2() {
    tmp_229_fu_170_p2 = (!i_reg_105.read().is_01() || !tmp_s_reg_285.read().is_01())? sc_lv<1>(): (sc_biguint<10>(i_reg_105.read()) < sc_biguint<10>(tmp_s_reg_285.read()));
}

void poly_Rq_mul::thread_tmp_230_fu_175_p2() {
    tmp_230_fu_175_p2 = (!k_cast2_reg_266.read().is_01() || !i_cast_fu_166_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(k_cast2_reg_266.read()) + sc_biguint<11>(i_cast_fu_166_p1.read()));
}

void poly_Rq_mul::thread_tmp_231_fu_180_p1() {
    tmp_231_fu_180_p1 = esl_zext<64,11>(tmp_230_fu_175_p2.read());
}

void poly_Rq_mul::thread_tmp_232_fu_185_p2() {
    tmp_232_fu_185_p2 = (!ap_const_lv10_2BD.is_01() || !i_reg_105.read().is_01())? sc_lv<10>(): (sc_bigint<10>(ap_const_lv10_2BD) - sc_biguint<10>(i_reg_105.read()));
}

void poly_Rq_mul::thread_tmp_233_fu_191_p1() {
    tmp_233_fu_191_p1 = esl_zext<64,10>(tmp_232_fu_185_p2.read());
}

void poly_Rq_mul::thread_tmp_236_fu_218_p2() {
    tmp_236_fu_218_p2 = (!k_cast2_reg_266.read().is_01() || !i_1_cast_fu_202_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(k_cast2_reg_266.read()) - sc_biguint<11>(i_1_cast_fu_202_p1.read()));
}

void poly_Rq_mul::thread_tmp_237_cast_fu_243_p1() {
    tmp_237_cast_fu_243_p1 = esl_zext<16,13>(tmp_250_fu_239_p1.read());
}

void poly_Rq_mul::thread_tmp_237_fu_223_p1() {
    tmp_237_fu_223_p1 = esl_sext<64,11>(tmp_236_fu_218_p2.read());
}

void poly_Rq_mul::thread_tmp_238_fu_228_p1() {
    tmp_238_fu_228_p1 = esl_zext<64,10>(i_1_reg_116.read());
}

void poly_Rq_mul::thread_tmp_250_fu_239_p1() {
    tmp_250_fu_239_p1 = r_coeffs_q0.read().range(13-1, 0);
}
...
void poly_Rq_mul::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_229_fu_170_p2.read()))) {
