...
wire   [4:0] i_22_i_fu_169_p2;
reg   [4:0] i_22_i_reg_253;
...
wire   [10:0] grp_keccak_absorb_1_fu_146_m_address0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        s_address0 = tmp_279_i_fu_175_p1;
...
assign i_22_i_fu_169_p2 = (i_i_reg_103 + 5'd1);

assign i_2_fu_244_p2 = (i_reg_135 + 6'd1);

assign i_3_fu_194_p2 = (i_i_i_reg_124 + 4'd1);
...
assign tmp_279_i_fu_175_p1 = i_i_reg_103;

assign tmp_2_fu_229_p1 = u_assign_2_fu_219_p4;
