...
architecture behav of sha3_256 is 
    ...
    signal i_22_i_fu_169_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_22_i_reg_253 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_3_fu_194_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal tmp_2_fu_229_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal i_2_fu_244_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_2_reg_294 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal grp_keccak_absorb_1_fu_146_ap_start : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_ap_done : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_ap_idle : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_ap_ready : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_s_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_keccak_absorb_1_fu_146_s_ce0 : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_s_we0 : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_s_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_keccak_absorb_1_fu_146_s_address1 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_keccak_absorb_1_fu_146_s_ce1 : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_s_we1 : STD_LOGIC;
    signal grp_keccak_absorb_1_fu_146_s_d1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_keccak_absorb_1_fu_146_m_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_keccak_absorb_1_fu_146_m_ce0 : STD_LOGIC;
    ...
    signal grp_keccak_absorb_1_fu_146_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal grp_KeccakF1600_StatePer_fu_156_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_279_i_fu_175_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal u_assign_2_fu_219_p4 : STD_LOGIC_VECTOR (55 downto 0);
...
begin
    ...
    grp_keccak_absorb_1_fu_146 : component keccak_absorb_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_keccak_absorb_1_fu_146_ap_start,
        ap_done => grp_keccak_absorb_1_fu_146_ap_done,
        ap_idle => grp_keccak_absorb_1_fu_146_ap_idle,
        ap_ready => grp_keccak_absorb_1_fu_146_ap_ready,
        s_address0 => grp_keccak_absorb_1_fu_146_s_address0,
        s_ce0 => grp_keccak_absorb_1_fu_146_s_ce0,
        s_we0 => grp_keccak_absorb_1_fu_146_s_we0,
        s_d0 => grp_keccak_absorb_1_fu_146_s_d0,
        s_q0 => s_q0,
        s_address1 => grp_keccak_absorb_1_fu_146_s_address1,
        s_ce1 => grp_keccak_absorb_1_fu_146_s_ce1,
        s_we1 => grp_keccak_absorb_1_fu_146_s_we1,
        s_d1 => grp_keccak_absorb_1_fu_146_s_d1,
        s_q1 => s_q1,
        m_address0 => grp_keccak_absorb_1_fu_146_m_address0,
        m_ce0 => grp_keccak_absorb_1_fu_146_m_ce0,
        m_q0 => input_r_q0);
    ...
    grp_keccak_absorb_1_fu_146_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_keccak_absorb_1_fu_146_ap_ready = ap_const_logic_1)) then 
                    grp_keccak_absorb_1_fu_146_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_i_i_fu_188_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
                p_0_i_i_reg_115 <= tmp_2_fu_229_p1;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                i_22_i_reg_253 <= i_22_i_fu_169_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state5, exitcond_i_fu_163_p2, ap_CS_fsm_state7, tmp_i_i_fu_188_p2, ap_CS_fsm_state8, tmp_fu_238_p2, grp_keccak_absorb_1_fu_146_ap_done, grp_KeccakF1600_StatePer_fu_156_ap_done, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_keccak_absorb_1_fu_146_ap_done = ap_const_logic_1))) then
    ...
    grp_keccak_absorb_1_fu_146_ap_start <= grp_keccak_absorb_1_fu_146_ap_start_reg;
    ...
    i_22_i_fu_169_p2 <= std_logic_vector(unsigned(i_i_reg_103) + unsigned(ap_const_lv5_1));
    i_2_fu_244_p2 <= std_logic_vector(unsigned(i_reg_135) + unsigned(ap_const_lv6_1));
    i_3_fu_194_p2 <= std_logic_vector(unsigned(i_i_i_reg_124) + unsigned(ap_const_lv4_1));
    i_cast1_fu_233_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_135),64));
    input_r_address0 <= grp_keccak_absorb_1_fu_146_m_address0;
    input_r_ce0 <= grp_keccak_absorb_1_fu_146_m_ce0;
    output_r_address0 <= i_cast1_reg_286(9 - 1 downto 0);
    ...
    s_address0_assign_proc : process(ap_CS_fsm_state5, grp_keccak_absorb_1_fu_146_s_address0, grp_KeccakF1600_StatePer_fu_156_state_address0, ap_CS_fsm_state4, ap_CS_fsm_state2, tmp_279_i_fu_175_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            s_address0 <= tmp_279_i_fu_175_p1(5 - 1 downto 0);
    ...
    s_address1_assign_proc : process(grp_keccak_absorb_1_fu_146_s_address1, grp_KeccakF1600_StatePer_fu_156_state_address1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
    ...
    s_ce0_assign_proc : process(ap_CS_fsm_state5, grp_keccak_absorb_1_fu_146_s_ce0, grp_KeccakF1600_StatePer_fu_156_state_ce0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    s_ce1_assign_proc : process(grp_keccak_absorb_1_fu_146_s_ce1, grp_KeccakF1600_StatePer_fu_156_state_ce1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_d0_assign_proc : process(grp_keccak_absorb_1_fu_146_s_d0, grp_KeccakF1600_StatePer_fu_156_state_d0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_d1_assign_proc : process(grp_keccak_absorb_1_fu_146_s_d1, grp_KeccakF1600_StatePer_fu_156_state_d1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_we0_assign_proc : process(grp_keccak_absorb_1_fu_146_s_we0, grp_KeccakF1600_StatePer_fu_156_state_we0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_we1_assign_proc : process(grp_keccak_absorb_1_fu_146_s_we1, grp_KeccakF1600_StatePer_fu_156_state_we1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    tmp_279_i_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_reg_103),64));
    tmp_2_fu_229_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(u_assign_2_fu_219_p4),64));
    ...
    u_assign_2_fu_219_p4 <= p_0_i_i_reg_115(63 downto 8);
end behav;
