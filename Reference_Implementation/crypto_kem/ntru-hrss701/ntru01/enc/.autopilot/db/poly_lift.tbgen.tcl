...
set C_modelName {poly_lift}
set C_modelType { void 0 }
set C_modelArgList {
	{ r_coeffs int 16 regular {array 701 { 0 3 } 0 1 }  }
	{ a_coeffs int 16 regular {array 701 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ a_coeffs_address1 sc_out sc_lv 10 signal 1 } 
	{ a_coeffs_ce1 sc_out sc_logic 1 signal 1 } 
	{ a_coeffs_q1 sc_in sc_lv 16 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_enc_mac_muladd_16s_2ns_16ns_16_1_1_U57", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_enc_mac_muladd_16s_2ns_16ns_16_1_1_U58", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_enc_ama_addmuladd_2ns_3ns_16s_16ns_16_1_1_U59", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_enc_mac_muladd_2ns_16s_16ns_16_1_1_U60", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_kem_enc_mac_muladd_2ns_16s_16ns_16_1_1_U61", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10499", "Max" : "10499"}
...
set Spec2ImplPortList { 
	...
	a_coeffs { ap_memory {  { a_coeffs_address0 mem_address 1 10 }  { a_coeffs_ce0 mem_ce 1 1 }  { a_coeffs_q0 mem_dout 0 16 }  { a_coeffs_address1 MemPortADDR2 1 10 }  { a_coeffs_ce1 MemPortCE2 1 1 }  { a_coeffs_q1 MemPortDOUT2 0 16 } } }
}
