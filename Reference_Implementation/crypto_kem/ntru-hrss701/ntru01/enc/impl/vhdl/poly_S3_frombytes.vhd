...
architecture behav of poly_S3_frombytes is 
    ...
    signal tmp_233_fu_175_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_233_reg_357 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_210_fu_217_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_210_reg_375 : STD_LOGIC_VECTOR (9 downto 0);
    signal c_reg_384 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_reg_391 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_227_reg_396 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_217_reg_401 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_222_reg_406 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_268_cast_cast_fu_315_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_278_cast_fu_343_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_263_cast_fu_265_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_273_cast_cast_fu_319_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_cast_fu_204_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_211_fu_301_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_215_fu_310_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_220_fu_328_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_225_fu_338_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_230_fu_352_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_212_fu_227_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_223_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_212_fu_227_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_226_fu_243_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_226_fu_243_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_216_fu_269_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_216_fu_269_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_221_fu_285_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_221_fu_285_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_214_fu_305_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_219_fu_323_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_224_fu_333_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_229_fu_347_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_216_fu_269_p00 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_221_fu_285_p00 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                c_reg_384 <= msg_q0;
                tmp_227_reg_396 <= tmp_226_fu_243_p2(15 downto 14);
                tmp_reg_391 <= tmp_212_fu_227_p2(15 downto 9);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                tmp_217_reg_401 <= tmp_216_fu_269_p2(13 downto 9);
                tmp_222_reg_406 <= tmp_221_fu_285_p2(12 downto 9);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    grp_mod3_fu_153_a_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, c_reg_384, tmp_268_cast_cast_fu_315_p1, tmp_278_cast_fu_343_p1)
    begin
    ...
    grp_mod3_fu_158_a_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state5, tmp_263_cast_fu_265_p1, tmp_273_cast_cast_fu_319_p1)
    begin
    ...
    r_coeffs_address0_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state2, tmp_211_fu_301_p1, tmp_225_fu_338_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            r_coeffs_address0 <= tmp_225_fu_338_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            r_coeffs_address0 <= tmp_211_fu_301_p1(10 - 1 downto 0);
    ...
    r_coeffs_address1_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, tmp_215_fu_310_p1, tmp_220_fu_328_p1, tmp_230_fu_352_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            r_coeffs_address1 <= tmp_230_fu_352_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            r_coeffs_address1 <= tmp_220_fu_328_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            r_coeffs_address1 <= tmp_215_fu_310_p1(10 - 1 downto 0);
        else 
    ...
    sum_fu_199_p2 <= std_logic_vector(unsigned(tmp_cast_fu_195_p1) + unsigned(tmp_233_reg_357));
    tmp_210_fu_217_p2 <= std_logic_vector(unsigned(p_shl_fu_209_p3) + unsigned(i_cast3_fu_179_p1));
    tmp_211_fu_301_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_210_reg_375),64));
    tmp_212_fu_227_p0 <= tmp_s_fu_223_p1(8 - 1 downto 0);
    tmp_212_fu_227_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_212_fu_227_p0) * unsigned(ap_const_lv16_AB), 16));
    tmp_214_fu_305_p2 <= std_logic_vector(unsigned(tmp_210_reg_375) + unsigned(ap_const_lv10_1));
    tmp_215_fu_310_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_214_fu_305_p2),64));
    tmp_216_fu_269_p0 <= tmp_216_fu_269_p00(8 - 1 downto 0);
    tmp_216_fu_269_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(c_reg_384),14));
    tmp_216_fu_269_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_216_fu_269_p0) * unsigned(ap_const_lv14_39), 14));
    tmp_219_fu_323_p2 <= std_logic_vector(unsigned(tmp_210_reg_375) + unsigned(ap_const_lv10_2));
    tmp_220_fu_328_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_219_fu_323_p2),64));
    tmp_221_fu_285_p0 <= tmp_221_fu_285_p00(8 - 1 downto 0);
    tmp_221_fu_285_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(c_reg_384),13));
    tmp_221_fu_285_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_221_fu_285_p0) * unsigned(ap_const_lv13_13), 13));
    tmp_224_fu_333_p2 <= std_logic_vector(unsigned(tmp_210_reg_375) + unsigned(ap_const_lv10_3));
    tmp_225_fu_338_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_224_fu_333_p2),64));
    tmp_226_fu_243_p0 <= tmp_s_fu_223_p1(8 - 1 downto 0);
    tmp_226_fu_243_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_226_fu_243_p0) * unsigned(ap_const_lv16_CB), 16));
    tmp_229_fu_347_p2 <= std_logic_vector(unsigned(tmp_210_reg_375) + unsigned(ap_const_lv10_4));
    tmp_230_fu_352_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_229_fu_347_p2),64));
    tmp_233_fu_175_p1 <= msg_offset(9 - 1 downto 0);
    tmp_263_cast_fu_265_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_reg_391),8));
    tmp_268_cast_cast_fu_315_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_217_reg_401),8));
    tmp_273_cast_cast_fu_319_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_222_reg_406),8));
    tmp_278_cast_fu_343_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_227_reg_396),8));
