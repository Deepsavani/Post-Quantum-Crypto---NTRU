...
wire   [0:0] tmp_231_fu_170_p2;
wire   [9:0] i_11_fu_196_p2;
reg   [9:0] i_11_reg_303;
wire   [9:0] i_12_fu_212_p2;
reg   [9:0] i_12_reg_311;
...
wire   [63:0] tmp_233_fu_180_p1;
wire   [63:0] tmp_235_fu_191_p1;
wire  signed [63:0] tmp_240_fu_223_p1;
wire   [63:0] tmp_241_fu_228_p1;
wire  signed [15:0] grp_fu_248_p3;
wire  signed [15:0] grp_fu_257_p3;
wire   [15:0] tmp_289_cast_fu_243_p1;
wire   [10:0] i_cast_fu_166_p1;
wire   [10:0] tmp_232_fu_175_p2;
wire   [9:0] tmp_234_fu_185_p2;
wire   [10:0] i_1_cast_fu_202_p1;
wire   [10:0] tmp_239_fu_218_p2;
wire   [12:0] tmp_238_fu_239_p1;
reg   [8:0] ap_NS_fsm;
...
crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1 #(
    ...
    .din2_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51(
    .din0(reg_127),
    .din1(reg_131),
    .din2(reg_135),
    .dout(grp_fu_248_p3)
...
always @ (posedge ap_clk) begin
    if (((tmp_231_fu_170_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_116 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_231_fu_170_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        a_coeffs_address0 = tmp_240_fu_223_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        a_coeffs_address0 = tmp_233_fu_180_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        b_coeffs_address0 = tmp_241_fu_228_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        b_coeffs_address0 = tmp_235_fu_191_p1;
    end else begin
...
assign exitcond1_fu_143_p2 = ((indvars_iv_reg_82 == 10'd702) ? 1'b1 : 1'b0);

assign exitcond_fu_206_p2 = ((i_1_reg_116 == indvars_iv_reg_82) ? 1'b1 : 1'b0);

assign i_11_fu_196_p2 = (i_reg_105 + 10'd1);

assign i_12_fu_212_p2 = (i_1_reg_116 + 10'd1);
...
assign tmp_231_fu_170_p2 = ((i_reg_105 < tmp_s_reg_285) ? 1'b1 : 1'b0);

assign tmp_232_fu_175_p2 = (k_cast2_reg_266 + i_cast_fu_166_p1);

assign tmp_233_fu_180_p1 = tmp_232_fu_175_p2;

assign tmp_234_fu_185_p2 = ($signed(10'd701) - $signed(i_reg_105));

assign tmp_235_fu_191_p1 = tmp_234_fu_185_p2;

assign tmp_238_fu_239_p1 = r_coeffs_q0[12:0];

assign tmp_239_fu_218_p2 = (k_cast2_reg_266 - i_1_cast_fu_202_p1);

assign tmp_240_fu_223_p1 = $signed(tmp_239_fu_218_p2);

assign tmp_241_fu_228_p1 = i_1_reg_116;

assign tmp_289_cast_fu_243_p1 = tmp_238_fu_239_p1;

assign tmp_fu_155_p1 = k_reg_94;

assign tmp_s_fu_160_p2 = ($signed(10'd701) - $signed(k_reg_94));
