...
poly_Rq_mul::poly_Rq_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51 = new crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1<1,1,16,16,16,16>("crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51");
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51->din0(reg_127);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51->din1(reg_131);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51->din2(reg_135);
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51->dout(grp_fu_248_p3);
    ...
    crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U52->dout(grp_fu_257_p3);
    ...
    sensitive << ( tmp_233_fu_180_p1 );
    sensitive << ( tmp_240_fu_223_p1 );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( tmp_235_fu_191_p1 );
    sensitive << ( tmp_241_fu_228_p1 );
    ...
    sensitive << ( tmp_289_cast_fu_243_p1 );
    ...
    SC_METHOD(thread_tmp_231_fu_170_p2);
    sensitive << ( tmp_s_reg_285 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_232_fu_175_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_cast_fu_166_p1 );

    SC_METHOD(thread_tmp_233_fu_180_p1);
    sensitive << ( tmp_232_fu_175_p2 );

    SC_METHOD(thread_tmp_234_fu_185_p2);
    sensitive << ( i_reg_105 );

    SC_METHOD(thread_tmp_235_fu_191_p1);
    sensitive << ( tmp_234_fu_185_p2 );

    SC_METHOD(thread_tmp_238_fu_239_p1);
    sensitive << ( r_coeffs_q0 );

    SC_METHOD(thread_tmp_239_fu_218_p2);
    sensitive << ( k_cast2_reg_266 );
    sensitive << ( i_1_cast_fu_202_p1 );

    SC_METHOD(thread_tmp_240_fu_223_p1);
    sensitive << ( tmp_239_fu_218_p2 );

    SC_METHOD(thread_tmp_241_fu_228_p1);
    sensitive << ( i_1_reg_116 );

    SC_METHOD(thread_tmp_289_cast_fu_243_p1);
    sensitive << ( tmp_238_fu_239_p1 );
    ...
    sc_trace(mVcdFile, tmp_231_fu_170_p2, "tmp_231_fu_170_p2");
    ...
    sc_trace(mVcdFile, tmp_233_fu_180_p1, "tmp_233_fu_180_p1");
    sc_trace(mVcdFile, tmp_235_fu_191_p1, "tmp_235_fu_191_p1");
    sc_trace(mVcdFile, tmp_240_fu_223_p1, "tmp_240_fu_223_p1");
    sc_trace(mVcdFile, tmp_241_fu_228_p1, "tmp_241_fu_228_p1");
    sc_trace(mVcdFile, grp_fu_248_p3, "grp_fu_248_p3");
    sc_trace(mVcdFile, grp_fu_257_p3, "grp_fu_257_p3");
    sc_trace(mVcdFile, tmp_289_cast_fu_243_p1, "tmp_289_cast_fu_243_p1");
    sc_trace(mVcdFile, i_cast_fu_166_p1, "i_cast_fu_166_p1");
    sc_trace(mVcdFile, tmp_232_fu_175_p2, "tmp_232_fu_175_p2");
    sc_trace(mVcdFile, tmp_234_fu_185_p2, "tmp_234_fu_185_p2");
    sc_trace(mVcdFile, i_1_cast_fu_202_p1, "i_1_cast_fu_202_p1");
    sc_trace(mVcdFile, tmp_239_fu_218_p2, "tmp_239_fu_218_p2");
    sc_trace(mVcdFile, tmp_238_fu_239_p1, "tmp_238_fu_239_p1");
...
poly_Rq_mul::~poly_Rq_mul() {
    ...
    delete crypto_kem_enc_mac_muladd_16s_16s_16ns_16_1_1_U51;
...
void poly_Rq_mul::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_231_fu_170_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_231_fu_170_p2.read(), ap_const_lv1_1))) {
...
void poly_Rq_mul::thread_a_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        a_coeffs_address0 =  (sc_lv<10>) (tmp_240_fu_223_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        a_coeffs_address0 =  (sc_lv<10>) (tmp_233_fu_180_p1.read());
    } else {
...
void poly_Rq_mul::thread_b_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        b_coeffs_address0 =  (sc_lv<10>) (tmp_241_fu_228_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        b_coeffs_address0 =  (sc_lv<10>) (tmp_235_fu_191_p1.read());
    } else {
...
void poly_Rq_mul::thread_exitcond1_fu_143_p2() {
    exitcond1_fu_143_p2 = (!indvars_iv_reg_82.read().is_01() || !ap_const_lv10_2BE.is_01())? sc_lv<1>(): sc_lv<1>(indvars_iv_reg_82.read() == ap_const_lv10_2BE);
}
...
void poly_Rq_mul::thread_i_11_fu_196_p2() {
    i_11_fu_196_p2 = (!i_reg_105.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(i_reg_105.read()) + sc_biguint<10>(ap_const_lv10_1));
}

void poly_Rq_mul::thread_i_12_fu_212_p2() {
    i_12_fu_212_p2 = (!i_1_reg_116.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(i_1_reg_116.read()) + sc_biguint<10>(ap_const_lv10_1));
}
...
void poly_Rq_mul::thread_k_1_fu_149_p2() {
    k_1_fu_149_p2 = (!k_reg_94.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(k_reg_94.read()) + sc_biguint<10>(ap_const_lv10_1));
}
...
void poly_Rq_mul::thread_r_coeffs_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        r_coeffs_d0 = tmp_289_cast_fu_243_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
...
void poly_Rq_mul::thread_tmp_231_fu_170_p2() {
    tmp_231_fu_170_p2 = (!i_reg_105.read().is_01() || !tmp_s_reg_285.read().is_01())? sc_lv<1>(): (sc_biguint<10>(i_reg_105.read()) < sc_biguint<10>(tmp_s_reg_285.read()));
}

void poly_Rq_mul::thread_tmp_232_fu_175_p2() {
    tmp_232_fu_175_p2 = (!k_cast2_reg_266.read().is_01() || !i_cast_fu_166_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(k_cast2_reg_266.read()) + sc_biguint<11>(i_cast_fu_166_p1.read()));
}

void poly_Rq_mul::thread_tmp_233_fu_180_p1() {
    tmp_233_fu_180_p1 = esl_zext<64,11>(tmp_232_fu_175_p2.read());
}

void poly_Rq_mul::thread_tmp_234_fu_185_p2() {
    tmp_234_fu_185_p2 = (!ap_const_lv10_2BD.is_01() || !i_reg_105.read().is_01())? sc_lv<10>(): (sc_bigint<10>(ap_const_lv10_2BD) - sc_biguint<10>(i_reg_105.read()));
}

void poly_Rq_mul::thread_tmp_235_fu_191_p1() {
    tmp_235_fu_191_p1 = esl_zext<64,10>(tmp_234_fu_185_p2.read());
}

void poly_Rq_mul::thread_tmp_238_fu_239_p1() {
    tmp_238_fu_239_p1 = r_coeffs_q0.read().range(13-1, 0);
}

void poly_Rq_mul::thread_tmp_239_fu_218_p2() {
    tmp_239_fu_218_p2 = (!k_cast2_reg_266.read().is_01() || !i_1_cast_fu_202_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(k_cast2_reg_266.read()) - sc_biguint<11>(i_1_cast_fu_202_p1.read()));
}

void poly_Rq_mul::thread_tmp_240_fu_223_p1() {
    tmp_240_fu_223_p1 = esl_sext<64,11>(tmp_239_fu_218_p2.read());
}

void poly_Rq_mul::thread_tmp_241_fu_228_p1() {
    tmp_241_fu_228_p1 = esl_zext<64,10>(i_1_reg_116.read());
}

void poly_Rq_mul::thread_tmp_289_cast_fu_243_p1() {
    tmp_289_cast_fu_243_p1 = esl_zext<16,13>(tmp_238_fu_239_p1.read());
}
...
void poly_Rq_mul::thread_tmp_s_fu_160_p2() {
    tmp_s_fu_160_p2 = (!ap_const_lv10_2BD.is_01() || !k_reg_94.read().is_01())? sc_lv<10>(): (sc_bigint<10>(ap_const_lv10_2BD) - sc_biguint<10>(k_reg_94.read()));
}
...
void poly_Rq_mul::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_231_fu_170_p2.read()))) {
