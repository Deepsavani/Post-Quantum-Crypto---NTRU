...
sha3_256::sha3_256(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_17_i_fu_169_p2);
    sensitive << ( i_i_reg_103 );
    ...
    SC_METHOD(thread_tmp_364_i_fu_175_p1);
    sensitive << ( i_i_reg_103 );
    ...
    sc_trace(mVcdFile, i_17_i_fu_169_p2, "i_17_i_fu_169_p2");
    sc_trace(mVcdFile, i_17_i_reg_253, "i_17_i_reg_253");
    ...
    sc_trace(mVcdFile, tmp_364_i_fu_175_p1, "tmp_364_i_fu_175_p1");
...
void sha3_256::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read()) && 
        ...
        i_i_reg_103 = i_17_i_reg_253.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_17_i_reg_253 = i_17_i_fu_169_p2.read();
    }
...
void sha3_256::thread_i_17_i_fu_169_p2() {
    i_17_i_fu_169_p2 = (!i_i_reg_103.read().is_01() || !ap_const_lv5_1.is_01())? sc_lv<5>(): (sc_biguint<5>(i_i_reg_103.read()) + sc_biguint<5>(ap_const_lv5_1));
}
...
void sha3_256::thread_s_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        s_address0 =  (sc_lv<5>) (tmp_364_i_fu_175_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
...
void sha3_256::thread_tmp_364_i_fu_175_p1() {
    tmp_364_i_fu_175_p1 = esl_zext<64,5>(i_i_reg_103.read());
}
