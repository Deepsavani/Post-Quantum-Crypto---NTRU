...
{_ssdm_SpecArrayDimSize(pk, 1138);_ssdm_SpecArrayDimSize(sk, 1450);
...
{_ssdm_SpecArrayDimSize(c, 1138);_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(pk, 1138);
...
{_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(c, 1138);_ssdm_SpecArrayDimSize(sk, 1450);
  int i, fail;
  unsigned char rm[(2*(((701 -1)+4)/5))];
